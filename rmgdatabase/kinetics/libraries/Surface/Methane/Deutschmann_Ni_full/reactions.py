...
entry(
    ...
    shortDesc="""Default""",
    longDesc="""R14. Deutschmann actually uses vdW CH4 as product, but we skip it and this reaction as the reverse of our adsorption step""",
    metal="Ni",
)
...
entry(
    ...
    shortDesc="""Default""",
    longDesc="""R22. Deutschmann actually goes to vdW CH4, but we'll skip that. We input reverse direction""",
    metal="Ni",
)
...
entry(
    ...
    shortDesc="""Default""",
    longDesc="""R30. Deutschmann actually goes to vdW H2O, but we'll skip that. We input reverse direction""",
    metal="Ni",
)
...
entry(
    ...
    shortDesc="""Default""",
    longDesc="""R39 is used instead of R40 to avoid having CO2(s) as reactant""",
    metal="Ni",
)
...
entry(
    ...
    shortDesc="""Default""",
    longDesc="""R41. Deutschmann actually uses vdW CO2, but we skip it and use reverse reaction""",
    metal="Ni",
)
