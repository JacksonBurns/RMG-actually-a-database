...
entry(
    ...
    reference=Article(
        ...
        title="Reactions of 1-naphthyl radicals with ethylene. Single pulse shock tube experiments, quantum chemical, transition state theory, and multiwell calculations",
...
entry(
    ...
    reference=Article(
        ...
        title="Evaluated kinetic data for high temperature reactions. Volume 4 Homogeneous gas phase reactions of halogen- and cyanide- containing species",
...
entry(
    ...
    reference=Article(
        authors=["Mulenko, S.A."],
        title="The application of an intracavity laser spectroscopy method for elementary processes study in gas-phase reactions",
    ...
    referenceType="experiment",
    shortDesc="""Measured at 400 K, 82 Torr CH3I bath gas""",
    longDesc="""
Bath gas: CH3I
...
entry(
    ...
    reference=Article(
        ...
        title="Kinetics and product study of the self-reactions of allyl and allyl peroxy radicals at 296 K",
        journal="Rev. Roum. Phys.",
        volume="89",
        pages="""433-446""",
        year="1993",
    ...
    referenceType="experiment",
    shortDesc="""Measured at 296 K, 750 Torr N2 bath gas""",
    longDesc="""
Bath gas: N2
Excitation technique: Flash photolysis (laser or conventional)
Analytical technique: Vis-UV absorption
...
entry(
    ...
    reference=Article(
        ...
        title="Optoacoustic method of measuring reaction rates of the radicals CH3, CD3, C2H5 and CH2I with I and I2",
    ...
    referenceType="experiment",
    shortDesc="""Estimated from I + C2H5 -> C2H5I by Zach et al (Table S2)""",
    longDesc="""
