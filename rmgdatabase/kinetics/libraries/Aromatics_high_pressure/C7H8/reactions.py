...
shortDesc = "Toluene formation from phenyl+CH3 and benzyl+H"
longDesc = """
...
entry(
    ...
    degeneracy=1,
    kinetics=Arrhenius(
        A=(1.20e-10, "cm^3/(molecule*s)"), n=0.062, Ea=(-0.044, "kcal/mol"), T0=(1, "K")
    ),
)
...
entry(
    ...
    degeneracy=1,
    kinetics=Arrhenius(
        A=(8.28e-13, "cm^3/(molecule*s)"), n=0.611, Ea=(-0.436, "kcal/mol"), T0=(1, "K")
    ),
)
...
entry(
    ...
    degeneracy=1,
    kinetics=Arrhenius(
        A=(1.07e-11, "cm^3/(molecule*s)"), n=0.245, Ea=(-0.333, "kcal/mol"), T0=(1, "K")
    ),
)
