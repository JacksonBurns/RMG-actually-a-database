...
shortDesc = "Phenyl radical second acetylene addition, Bittner-Howard pathway"
longDesc = """
...
entry(
    ...
    degeneracy=1.0,
    kinetics=Arrhenius(
        A=(1.817e11, "s^-1"), n=0.838, Ea=(38.356, "kcal/mol"), T0=(1, "K")
    ),
    longDesc="""
...
entry(
    ...
    degeneracy=1.0,
    kinetics=Arrhenius(
        A=(5.581e10, "s^-1"), n=0.793, Ea=(14.523, "kcal/mol"), T0=(1, "K")
    ),
    longDesc="""
Originally from reaction library: Unclassified
""",
