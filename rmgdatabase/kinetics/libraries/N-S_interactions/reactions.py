...
entry(
    ...
    degeneracy=1,
    kinetics=Arrhenius(
        A=(1.55e13, "cm^3/(mol*s)"), n=-1.10, Ea=(0, "cal/mol"), T0=(295, "K")
    ),
    shortDesc="""[Pilling2002a]""",
    longDesc="""
