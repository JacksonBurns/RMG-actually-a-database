...
shortDesc = "Reactions for Butadiene Dimerization"
longDesc = """
...
entry(
    ...
    degeneracy=1,
    kinetics=Arrhenius(
        A=(4.33836e08, "s^-1"), n=0.725968, Ea=(102.12, "kJ/mol"), T0=(1, "K")
    ),
    shortDesc="""Level of theory: CBS-QB3 with 1D rotors in B3LYP/CBSB7""",
    longDesc="""
library value for butadiene dimerization reactions calculated by Duminda Ranasinghe and Hao-Wei Pang in March 2019
...
entry(
    ...
    degeneracy=1,
    kinetics=Arrhenius(
        A=(5.42238e12, "s^-1"), n=-0.0448663, Ea=(52.0893, "kJ/mol"), T0=(1, "K")
    ),
    shortDesc="""Level of theory: CBS-QB3 with 1D rotors in B3LYP/CBSB7""",
    longDesc="""
library value for butadiene dimerization reactions calculated by Duminda Ranasinghe and Hao-Wei Pang in March 2019
...
entry(
    ...
    degeneracy=1,
    kinetics=Arrhenius(
        A=(3.49424e11, "s^-1"), n=-0.0806221, Ea=(12.5388, "kJ/mol"), T0=(1, "K")
    ),
    shortDesc="""Level of theory: CBS-QB3 with 1D rotors in B3LYP/CBSB7""",
    longDesc="""
library value for butadiene dimerization reactions calculated by Duminda Ranasinghe and Hao-Wei Pang in March 2019
...
entry(
    ...
    degeneracy=1,
    kinetics=Arrhenius(
        A=(1.56665e11, "s^-1"), n=-0.0961041, Ea=(25.7391, "kJ/mol"), T0=(1, "K")
    ),
    shortDesc="""Level of theory: CBS-QB3 with 1D rotors in B3LYP/CBSB7""",
    longDesc="""
library value for butadiene dimerization reactions calculated by Duminda Ranasinghe and Hao-Wei Pang in March 2019
...
entry(
    ...
    degeneracy=1,
    kinetics=Arrhenius(
        A=(1.3971e12, "s^-1"), n=-0.104026, Ea=(16.1686, "kJ/mol"), T0=(1, "K")
    ),
    shortDesc="""Level of theory: CBS-QB3 with 1D rotors in B3LYP/CBSB7""",
    longDesc="""
library value for butadiene dimerization reactions calculated by Duminda Ranasinghe and Hao-Wei Pang in March 2019
