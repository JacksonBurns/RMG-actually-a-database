...
entry(
    ...
    kinetics=ThirdBody(
        arrheniusLow=Arrhenius(
            A=(2.5e14, "cm^3/(mol*s)"), n=0, Ea=(61400, "cal/mol"), T0=(1, "K")
        ),
        efficiencies={},
    ),
    longDesc="""
...
entry(
    ...
    kinetics=ThirdBody(
        arrheniusLow=Arrhenius(
            A=(5.6e20, "cm^6/(mol^2*s)"), n=-2.6, Ea=(0, "cal/mol"), T0=(1, "K")
        ),
        efficiencies={},
    ),
    longDesc="""
...
entry(
    ...
    kinetics=Lindemann(
        arrheniusHigh=Arrhenius(
            A=(2e14, "cm^3/(mol*s)"), n=-0.26, Ea=(298, "cal/mol"), T0=(1, "K")
        ),
        arrheniusLow=Arrhenius(
            A=(3.3e14, "cm^6/(mol^2*s)"),
            n=-0.201,
            Ea=(20, "cal/mol"),
            T0=(1, "K"),
        ),
...
entry(
    ...
    kinetics=Lindemann(
        arrheniusHigh=Arrhenius(
            A=(1.6e12, "cm^3/(mol*s)"), n=0.5, Ea=(-400, "cal/mol"), T0=(1, "K")
        ),
        arrheniusLow=Arrhenius(
            A=(9.5e27, "cm^6/(mol^2*s)"),
            n=-3.48,
            Ea=(970, "cal/mol"),
            T0=(1, "K"),
        ),
...
entry(
    ...
    kinetics=ThirdBody(
        arrheniusLow=Arrhenius(
            A=(5.8e11, "cm^3/(mol*s)"), n=0, Ea=(32720, "cal/mol"), T0=(1, "K")
        ),
        efficiencies={"N#N": 0},
    ),
    longDesc="""
...
entry(
    ...
    kinetics=ThirdBody(
        arrheniusLow=Arrhenius(
            A=(4.8e13, "cm^3/(mol*s)"), n=0, Ea=(77000, "cal/mol"), T0=(1, "K")
        ),
        efficiencies={},
    ),
    longDesc="""
...
entry(
    ...
    kinetics=ThirdBody(
        arrheniusLow=Arrhenius(
            A=(6.9e14, "cm^3/(mol*s)"), n=1, Ea=(57030, "cal/mol"), T0=(1, "K")
        ),
        efficiencies={},
    ),
    longDesc="""
