...
shortDesc = "Calculated T,P-dependent rates for significant pathways on the OH + acetylene surface of 2005 Senosiain"
longDesc = """
    ...
    kinetics=PDepArrhenius(
        ...
        arrhenius=[
            MultiArrhenius(
                arrhenius=[
                    Arrhenius(
                        A=(4.77e40, "cm^3/(molecule*s)"),
                        n=-18.57,
                        Ea=(41880, "J/mol"),
                        T0=(1, "K"),
                    ),
                    Arrhenius(
                        A=(4.38e09, "cm^3/(molecule*s)"),
                        n=-7.36,
                        Ea=(26747.7, "J/mol"),
                        T0=(1, "K"),
                    ),
            ...
            MultiArrhenius(
                arrhenius=[
                    Arrhenius(
                        A=(7.79e35, "cm^3/(molecule*s)"),
                        n=-16.87,
                        Ea=(38022.1, "J/mol"),
                        T0=(1, "K"),
                    ),
                    Arrhenius(
                        A=(7.27e08, "cm^3/(molecule*s)"),
                        n=-7.02,
                        Ea=(24827, "J/mol"),
                        T0=(1, "K"),
                    ),
            ...
            MultiArrhenius(
                arrhenius=[
                    Arrhenius(
                        A=(3.16e20, "cm^3/(molecule*s)"),
                        n=-11.38,
                        Ea=(26356.9, "J/mol"),
                        T0=(1, "K"),
                    ),
                    Arrhenius(
                        A=(5.79e07, "cm^3/(molecule*s)"),
                        n=-6.2,
                        Ea=(27762, "J/mol"),
                        T0=(1, "K"),
                    ),
