...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        uncertainty=RateUncertainty(
            mu=0.14582612901420383,
            var=13.966892144572673,
            Tref=1000.0,
            N=4,
            data_mean=0.0,
            correlation="Root",
...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        Tmax=(1500, "K"),
        uncertainty=RateUncertainty(
            mu=0.1154245615347588,
            var=1.7024423165047282,
            Tref=1000.0,
            N=3,
            data_mean=0.0,
            correlation="Root_Sp-3R!H-2R!H",
        ),
        comment="""BM rule fitted to 3 training reactions at node Root_Sp-3R!H-2R!H
...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        uncertainty=RateUncertainty(
            ...
            N=1,
            data_mean=0.0,
            correlation="Root_N-Sp-3R!H-2R!H",
        ),
        comment="""BM rule fitted to 1 training reactions at node Root_N-Sp-3R!H-2R!H
...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        uncertainty=RateUncertainty(
            ...
            N=1,
            data_mean=0.0,
            correlation="Root_Sp-3R!H-2R!H_Ext-3R!H-R",
        ),
        comment="""BM rule fitted to 1 training reactions at node Root_Sp-3R!H-2R!H_Ext-3R!H-R
    Total Standard Deviation in ln(k): 11.540182761524994""",
    ),
    rank=11,
...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        uncertainty=RateUncertainty(
            ...
            N=1,
            data_mean=0.0,
            correlation="Root_Sp-3R!H-2R!H_2R!H->C",
        ),
        comment="""BM rule fitted to 1 training reactions at node Root_Sp-3R!H-2R!H_2R!H->C
    Total Standard Deviation in ln(k): 11.540182761524994""",
    ),
    rank=11,
...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        uncertainty=RateUncertainty(
            ...
            N=1,
            data_mean=0.0,
            correlation="Root_Sp-3R!H-2R!H_N-2R!H->C",
        ),
        comment="""BM rule fitted to 1 training reactions at node Root_Sp-3R!H-2R!H_N-2R!H->C
    Total Standard Deviation in ln(k): 11.540182761524994""",
    ),
    rank=11,
