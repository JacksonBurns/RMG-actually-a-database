...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        uncertainty=RateUncertainty(
            mu=0.4651452533243257,
            var=30.086343983587437,
            Tref=1000.0,
            N=7,
            data_mean=0.0,
            correlation="Root",
        ),
        comment="""BM rule fitted to 7 training reactions at node Root
...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        Tmax=(1500, "K"),
        uncertainty=RateUncertainty(
            mu=-1.1301603542391048,
            var=34.258277475947885,
            Tref=1000.0,
            N=3,
            data_mean=0.0,
            correlation="Root_Ext-1CbCbf-R",
        ),
        comment="""BM rule fitted to 3 training reactions at node Root_Ext-1CbCbf-R
...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        uncertainty=RateUncertainty(
            ...
            N=1,
            data_mean=0.0,
            correlation="Root_5Ct-inRing",
        ),
        comment="""BM rule fitted to 1 training reactions at node Root_5Ct-inRing
...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        Tmax=(1500, "K"),
        uncertainty=RateUncertainty(
            mu=0.9442310184100462,
            var=74.4878913684149,
            Tref=1000.0,
            N=3,
            data_mean=0.0,
            correlation="Root_N-5Ct-inRing",
        ),
        comment="""BM rule fitted to 3 training reactions at node Root_N-5Ct-inRing
...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        uncertainty=RateUncertainty(
            ...
            N=1,
            data_mean=0.0,
            correlation="Root_Ext-1CbCbf-R_1CbCbf->Cb",
        ),
        comment="""BM rule fitted to 1 training reactions at node Root_Ext-1CbCbf-R_1CbCbf->Cb
    Total Standard Deviation in ln(k): 11.540182761524994""",
    ),
    rank=11,
...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        Tmax=(1500, "K"),
        uncertainty=RateUncertainty(
            mu=0.3469736613209595,
            var=0.6454898770400953,
            Tref=1000.0,
            N=2,
            data_mean=0.0,
            correlation="Root_Ext-1CbCbf-R_N-1CbCbf->Cb",
        ),
        comment="""BM rule fitted to 2 training reactions at node Root_Ext-1CbCbf-R_N-1CbCbf->Cb
...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        Tmax=(1500, "K"),
        uncertainty=RateUncertainty(
            mu=4.243605515613325,
            var=342.40568138978,
            Tref=1000.0,
            N=2,
            data_mean=0.0,
            correlation="Root_N-5Ct-inRing_Ext-4CbCbf-R_Ext-7R!H-R_Ext-7R!H-R_Ext-4CbCbf-R",
        ),
        comment="""BM rule fitted to 2 training reactions at node Root_N-5Ct-inRing_Ext-4CbCbf-R_Ext-7R!H-R_Ext-7R!H-R_Ext-4CbCbf-R
...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        uncertainty=RateUncertainty(
            ...
            N=1,
            data_mean=0.0,
            correlation="Root_Ext-1CbCbf-R_N-1CbCbf->Cb_2CbCbf->Cb",
        ),
        comment="""BM rule fitted to 1 training reactions at node Root_Ext-1CbCbf-R_N-1CbCbf->Cb_2CbCbf->Cb
    Total Standard Deviation in ln(k): 11.540182761524994""",
    ),
    rank=11,
...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        uncertainty=RateUncertainty(
            ...
            N=1,
            data_mean=0.0,
            correlation="Root_Ext-1CbCbf-R_N-1CbCbf->Cb_N-2CbCbf->Cb",
        ),
        comment="""BM rule fitted to 1 training reactions at node Root_Ext-1CbCbf-R_N-1CbCbf->Cb_N-2CbCbf->Cb
    Total Standard Deviation in ln(k): 11.540182761524994""",
    ),
    rank=11,
