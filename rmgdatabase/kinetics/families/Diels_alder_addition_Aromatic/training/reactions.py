...
entry(
    ...
    degeneracy=6.0,
    kinetics=Arrhenius(
        A=(5809, "cm^3/(mol*s)"), n=2.526, Ea=(5.92, "kcal/mol"), T0=(1, "K")
    ),
    reference=Article(
...
entry(
    ...
    degeneracy=1.0,
    kinetics=Arrhenius(
        A=(7.458e14, "s^-1"), n=0.0956, Ea=(54.82, "kcal/mol"), T0=(1, "K")
    ),
    reference=Article(
        authors=["Comandini, A.", "Brezinsky, K."],
        title="Theoretical Study of the Formation of Naphthalene from the Radical/pi-Bond Addition between Single-Ring Aromatic Hydrocarbons",
...
entry(
    ...
    degeneracy=2.0,
    kinetics=Arrhenius(
        A=(16.92, "cm^3/(mol*s)"), n=2.6, Ea=(42.193, "kcal/mol"), T0=(1, "K")
    ),
    rank=8,
    longDesc="""
...
entry(
    ...
    degeneracy=2.0,
    kinetics=Arrhenius(
        A=(43.24, "cm^3/(mol*s)"), n=2.58, Ea=(41.945, "kcal/mol"), T0=(1, "K")
    ),
    rank=8,
    longDesc="""
V. V. Kislov, N. I. Islamova, A. M. Kolker, S. H. Lin, and A. M. Mebel;
