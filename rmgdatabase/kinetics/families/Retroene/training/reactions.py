...
entry(
    ...
    kinetics=Arrhenius(
        ...
        Tmin=(300, "K"),
        Tmax=(2000, "K"),
        comment="""Fitted to 200 data points; dA = *|/ 1.90869, dn = +|- 0.0858988, dEa = +|- 0.439996 kJ/mol""",
    ),
    rank=5,
...
entry(
    ...
    kinetics=Arrhenius(
        ...
        Tmin=(300, "K"),
        Tmax=(2000, "K"),
        comment="""Fitted to 200 data points; dA = *|/ 1.39386, dn = +|- 0.0441278, dEa = +|- 0.226034 kJ/mol""",
    ),
    rank=5,
    shortDesc="""Calculated at CBS-QB3 by Xiaorui Dong.""",
)
...
entry(
    ...
    kinetics=Arrhenius(
        ...
        Tmin=(300, "K"),
        Tmax=(2000, "K"),
        comment="""Fitted to 200 data points; dA = *|/ 1.44153, dn = +|- 0.0485968, dEa = +|- 0.248926 kJ/mol""",
    ),
    rank=5,
    shortDesc="""Calculated at CBS-QB3 by Xiaorui Dong.""",
)
...
entry(
    ...
    kinetics=Arrhenius(
        ...
        Tmin=(300, "K"),
        Tmax=(2000, "K"),
        comment="""Fitted to 200 data points; dA = *|/ 1.13961, dn = +|- 0.0173664, dEa = +|- 0.0889553 kJ/mol""",
    ),
    rank=5,
    shortDesc="""Calculated at CBS-QB3 by Xiaorui Dong.""",
)
...
entry(
    ...
    kinetics=Arrhenius(
        ...
        Tmin=(300, "K"),
        Tmax=(2000, "K"),
        comment="""Fitted to Multiple Arrhenius kinetics over range 300.0-2000.0 K. """,
    ),
    rank=5,
    shortDesc="""Calculated at CBS-QB3 by Xiaorui Dong.""",
    longDesc="""
...
entry(
    ...
    kinetics=Arrhenius(
        ...
        Tmin=(300, "K"),
        Tmax=(2000, "K"),
        comment="""Fitted to 200 data points; dA = *|/ 1.52331, dn = +|- 0.0559292, dEa = +|- 0.286484 kJ/mol""",
    ),
    rank=5,
...
entry(
    ...
    kinetics=Arrhenius(
        ...
        Tmin=(300, "K"),
        Tmax=(2000, "K"),
        comment="""Fitted to 200 data points; dA = *|/ 1.47481, dn = +|- 0.0516299, dEa = +|- 0.264462 kJ/mol""",
    ),
    rank=5,
    shortDesc="""Calculated at CBS-QB3 using TST + 1DSHR approximation by Jeffrey Herron, Xiaorui Dong, and Duminda Ranasinghe.""",
    longDesc="""
...
entry(
    ...
    kinetics=Arrhenius(
        ...
        Tmin=(300, "K"),
        Tmax=(2000, "K"),
        comment="""Fitted to 200 data points; dA = *|/ 1.52121, dn = +|- 0.0557459, dEa = +|- 0.285545 kJ/mol""",
    ),
    rank=5,
    shortDesc="""Calculated at CBS-QB3 using TST + 1DSHR approximation by Jeffrey Herron, Xiaorui Dong, and Duminda Ranasinghe.""",
    longDesc="""
...
entry(
    ...
    kinetics=Arrhenius(
        ...
        Tmin=(300, "K"),
        Tmax=(2000, "K"),
        comment="""Fitted to 200 data points; dA = *|/ 1.70197, dn = +|- 0.0706665, dEa = +|- 0.361972 kJ/mol""",
    ),
    rank=5,
    shortDesc="""Calculated at CBS-QB3 using TST + 1DSHR approximation by Jeffrey Herron, Xiaorui Dong, and Duminda Ranasinghe.""",
    longDesc="""
...
entry(
    ...
    kinetics=Arrhenius(
        ...
        Tmin=(300, "K"),
        Tmax=(2000, "K"),
        comment="""Fitted to 200 data points; dA = *|/ 1.46775, dn = +|- 0.050992, dEa = +|- 0.261195 kJ/mol""",
    ),
    rank=5,
    shortDesc="""Calculated at CBS-QB3 using TST + 1DSHR approximation by Jeffrey Herron, Xiaorui Dong, and Duminda Ranasinghe.""",
    longDesc="""
...
entry(
    ...
    kinetics=Arrhenius(
        ...
        Tmin=(300, "K"),
        Tmax=(2000, "K"),
        comment="""Fitted to 200 data points; dA = *|/ 1.43309, dn = +|- 0.0478167, dEa = +|- 0.24493 kJ/mol""",
    ),
    rank=5,
    shortDesc="""Calculated at CBS-QB3 using TST + 1DSHR approximation by Jeffrey Herron, Xiaorui Dong, and Duminda Ranasinghe.""",
    longDesc="""
...
entry(
    ...
    kinetics=Arrhenius(
        ...
        Tmin=(300, "K"),
        Tmax=(2000, "K"),
        comment="""Fitted to 200 data points; dA = *|/ 1.35527, dn = +|- 0.0403969, dEa = +|- 0.206924 kJ/mol""",
    ),
    rank=5,
    shortDesc="""Calculated at CBS-QB3 using TST + 1DSHR approximation by Jeffrey Herron, Xiaorui Dong, and Duminda Ranasinghe.""",
    longDesc="""
...
entry(
    ...
    kinetics=Arrhenius(
        ...
        Tmin=(300, "K"),
        Tmax=(2000, "K"),
        comment="""Fitted to 200 data points; dA = *|/ 1.33575, dn = +|- 0.0384693, dEa = +|- 0.19705 kJ/mol""",
    ),
    rank=5,
    shortDesc="""Calculated at CBS-QB3 using TST + 1DSHR approximation by Jeffrey Herron, Xiaorui Dong, and Duminda Ranasinghe.""",
    longDesc="""
...
entry(
    ...
    kinetics=Arrhenius(
        ...
        Tmin=(300, "K"),
        Tmax=(2000, "K"),
        comment="""Fitted to 200 data points; dA = *|/ 1.44504, dn = +|- 0.0489194, dEa = +|- 0.250578 kJ/mol""",
    ),
    rank=5,
    shortDesc="""Calculated at CBS-QB3 using TST + 1DSHR approximation by Jeffrey Herron, Xiaorui Dong, and Duminda Ranasinghe.""",
    longDesc="""
...
entry(
    ...
    kinetics=Arrhenius(
        ...
        Tmin=(300, "K"),
        Tmax=(2000, "K"),
        comment="""Fitted to 200 data points; dA = *|/ 1.52174, dn = +|- 0.0557923, dEa = +|- 0.285783 kJ/mol""",
    ),
    rank=5,
    shortDesc="""Calculated at CBS-QB3 using TST + 1DSHR approximation by Jeffrey Herron, Xiaorui Dong, and Duminda Ranasinghe.""",
    longDesc="""
...
entry(
    ...
    kinetics=Arrhenius(
        ...
        Tmin=(300, "K"),
        Tmax=(2000, "K"),
        comment="""Fitted to 200 data points; dA = *|/ 1.60655, dn = +|- 0.0629992, dEa = +|- 0.322699 kJ/mol""",
    ),
    rank=5,
    shortDesc="""Calculated at CBS-QB3 using TST + 1DSHR approximation by Jeffrey Herron, Xiaorui Dong, and Duminda Ranasinghe.""",
    longDesc="""
...
entry(
    ...
    kinetics=Arrhenius(
        ...
        Tmin=(300, "K"),
        Tmax=(2000, "K"),
        comment="""Fitted to 200 data points; dA = *|/ 1.45449, dn = +|- 0.049786, dEa = +|- 0.255017 kJ/mol""",
    ),
    rank=5,
    shortDesc="""Calculated at CBS-QB3 using TST + 1DSHR approximation by Jeffrey Herron, Xiaorui Dong, and Duminda Ranasinghe.""",
    longDesc="""
...
entry(
    ...
    kinetics=Arrhenius(
        ...
        Tmin=(300, "K"),
        Tmax=(2000, "K"),
        comment="""Fitted to 200 data points; dA = *|/ 1.14422, dn = +|- 0.0179031, dEa = +|- 0.0917044 kJ/mol""",
    ),
    rank=5,
    shortDesc="""Calculated at CBS-QB3 using TST + 1DSHR approximation by Jeffrey Herron, Xiaorui Dong, and Duminda Ranasinghe.""",
    longDesc="""
...
entry(
    ...
    kinetics=Arrhenius(
        ...
        Tmin=(300, "K"),
        Tmax=(2000, "K"),
        comment="""Fitted to 200 data points; dA = *|/ 1.22917, dn = +|- 0.0274189, dEa = +|- 0.140447 kJ/mol""",
    ),
    rank=5,
    shortDesc="""Calculated at CBS-QB3 using TST + 1DSHR approximation by Jeffrey Herron, Xiaorui Dong, and Duminda Ranasinghe.""",
    longDesc="""
...
entry(
    ...
    kinetics=Arrhenius(
        ...
        Tmin=(300, "K"),
        Tmax=(2000, "K"),
        comment="""Fitted to 200 data points; dA = *|/ 1.50331, dn = +|- 0.0541732, dEa = +|- 0.277489 kJ/mol""",
    ),
    rank=5,
    shortDesc="""Calculated at CBS-QB3 using TST + 1DSHR approximation by Jeffrey Herron, Xiaorui Dong, and Duminda Ranasinghe.""",
    longDesc="""
...
entry(
    ...
    kinetics=Arrhenius(
        ...
        Tmin=(300, "K"),
        Tmax=(2000, "K"),
        comment="""Fitted to 200 data points; dA = *|/ 1.44929, dn = +|- 0.04931, dEa = +|- 0.252579 kJ/mol""",
    ),
    rank=5,
    shortDesc="""Calculated at CBS-QB3 using TST + 1DSHR approximation by Jeffrey Herron, Xiaorui Dong, and Duminda Ranasinghe.""",
    longDesc="""
...
entry(
    ...
    kinetics=Arrhenius(
        ...
        Tmin=(300, "K"),
        Tmax=(2000, "K"),
        comment="""Fitted to 200 data points; dA = *|/ 1.26289, dn = +|- 0.0310154, dEa = +|- 0.158869 kJ/mol""",
    ),
    rank=5,
    shortDesc="""Calculated at CBS-QB3 using TST + 1DSHR approximation by Jeffrey Herron, Xiaorui Dong, and Duminda Ranasinghe.""",
    longDesc="""
...
entry(
    ...
    kinetics=Arrhenius(
        ...
        Tmin=(300, "K"),
        Tmax=(2000, "K"),
        comment="""Fitted to 200 data points; dA = *|/ 1.28482, dn = +|- 0.0333034, dEa = +|- 0.170589 kJ/mol""",
    ),
    rank=5,
    shortDesc="""Calculated at CBS-QB3 using TST + 1DSHR approximation by Jeffrey Herron, Xiaorui Dong, and Duminda Ranasinghe.""",
    longDesc="""
...
entry(
    ...
    kinetics=Arrhenius(
        ...
        Tmin=(300, "K"),
        Tmax=(2000, "K"),
        comment="""Fitted to 200 data points; dA = *|/ 1.17678, dn = +|- 0.0216307, dEa = +|- 0.110798 kJ/mol""",
    ),
    rank=5,
    shortDesc="""Calculated at CBS-QB3 using TST + 1DSHR approximation by Jeffrey Herron, Xiaorui Dong, and Duminda Ranasinghe.""",
    longDesc="""
...
entry(
    ...
    kinetics=Arrhenius(
        ...
        Tmin=(300, "K"),
        Tmax=(2000, "K"),
        comment="""Fitted to 200 data points; dA = *|/ 1.87631, dn = +|- 0.083625, dEa = +|- 0.428349 kJ/mol""",
    ),
    rank=5,
    shortDesc="""Calculated at CBS-QB3 using TST + 1DSHR approximation by Jeffrey Herron, Xiaorui Dong, and Duminda Ranasinghe.""",
    longDesc="""
...
entry(
    ...
    kinetics=Arrhenius(
        ...
        Tmin=(300, "K"),
        Tmax=(2000, "K"),
        comment="""Fitted to 50 data points; dA = *|/ 3.23831, dn = +|- 0.155918, dEa = +|- 0.803992 kJ/mol""",
    ),
    rank=4,
...
entry(
    ...
    kinetics=Arrhenius(
        ...
        Tmin=(300, "K"),
        Tmax=(2000, "K"),
        comment="""Fitted to 50 data points; dA = *|/ 1.298, dn = +|- 0.034609, dEa = +|- 0.178462 kJ/mol""",
    ),
    rank=4,
    shortDesc="""CCSD(T)-F12a/cc-pVDZ-F12//wB97X-D3/def2-TZVP""",
    longDesc="""
