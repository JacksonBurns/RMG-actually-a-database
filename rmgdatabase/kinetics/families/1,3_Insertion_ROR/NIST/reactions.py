...
entry(
    ...
    reference=Article(
        ...
        title="High-temperature kinetics of thermal decomposition of acetic acid and its products",
        journal="Int. J. Chem. Kinet.",
        volume="16",
        pages="""525""",
        year="1984",
...
entry(
    ...
    reference=Article(
        ...
        title="High- and low-temperature mechanisms in the thermal decomposition of acetic acid",
...
entry(
    ...
    reference=Article(
        ...
        title="608. The thermal decomposition of acetic acid",
        journal="J. Chem. Soc.",
        pages="""2877-2882""",
        year="1949",
...
entry(
    ...
    reference=Article(
        ...
        title="Theoretical investigation of competing mechanisms in the thermal unimolecular decomposition of acetic acid and the hydration reaction of ketene",
...
entry(
    ...
    reference=Article(
        ...
        title="Kinetics and mechanisms of the pyrolysis of diethyl ether. II. The reaction inhibited by nitric oxide",
...
entry(
    ...
    reference=Article(
        ...
        title="Gas Phase Thermal Decomposition of tert-Butyl Alcohol",
        journal="J. Am. Chem. Soc.",
        volume="96",
        pages="""4398""",
        year="1974",
...
entry(
    ...
    reference=Article(
        ...
        title="Determinacion de la Cinetica de Descomposicion Termica de Alcoholes e Hidrocarburos Mediante un Reactor Pulso",
...
entry(
    ...
    reference=Article(
        ...
        title="Shock Tube Isomerization of Cyclopropane",
        journal="J. Phys. Chem.",
        volume="75",
        pages="""2526""",
        year="1971",
...
entry(
    ...
    reference=Article(
        authors=["Tsang, W."],
        title="Thermal decomposition of some tert-butyl compounds at elevated temperatures",
        journal="J. Chem. Phys.",
        volume="40",
        pages="""1498-1505""",
        year="1964",
...
entry(
    ...
    reference=Article(
        authors=["Barnard, J.A."],
        title="The pyrolysis of tert-butanol",
...
entry(
    ...
    reference=Article(
        ...
        title="The retro-aldol mechanism in the pyrolysis kinetics of primary, secondary, and tertiary \u03b2-hydroxy ketones in the gas phase",
        journal="Int. J. Chem. Kinet.",
        volume="24",
        pages="""909-915""",
        year="1992",
...
entry(
    ...
    reference=Article(
        ...
        title="Effets de parois dans la pyrolyse du methyl tert-butyl ether (MTBE)",
...
entry(
    ...
    reference=Article(
        authors=["Brocard, J.C.", "Baronnet, F."],
        title="Pyrolysis of methyl tert-butyl ether",
        journal="Oxid. Commun.",
        volume="1",
        pages="""321""",
        year="1980",
...
entry(
    ...
    reference=Article(
        ...
        title="Very Low-Pressure Pyrolysis (VLPP) of t-Butylmethyl Ether",
        journal="Int. J. Chem. Kinet.",
        volume="6",
        pages="""631""",
        year="1974",
...
entry(
    ...
    reference=Article(
        ...
        title="The thermal decomposition of t-butyl methyl ether",
        journal="Aust. J. Chem.",
        volume="21",
        pages="""2711-2716""",
        year="1968",
...
entry(
    ...
    reference=Article(
        ...
        title="The thermal decomposition of diisopropyl ether",
        journal="Aust. J. Chem.",
        volume="19",
        pages="""239-250""",
        year="1966",
...
entry(
    ...
    reference=Article(
        ...
        title="Kinetic and modeling studies on ETBE pyrolysis behind reflected shock waves",
...
entry(
    ...
    reference=Article(
        authors=["Daly, N.J.", "Wentrup, C."],
        title="The thermal decomposition of t-butyl ethyl ether",
        journal="Aust. J. Chem.",
        volume="21",
        pages="""1535""",
        year="1968",
...
entry(
    ...
    reference=Article(
        ...
        title="The thermal decomposition of t-butyl isopropyl ether",
        journal="Aust. J. Chem.",
        volume="23",
        pages="""541""",
        year="1970",
...
entry(
    ...
    reference=Article(
        ...
        title="Elimination kinetics and mechanisms for several 2-alkoxyacetic acids in the gas phase",
...
entry(
    ...
    reference=Article(
        authors=["Chuchani, G.", "Rotinov, A.", "Dominguez, R.M."],
        title="The kinetics and mechanisms of gas phase elimination of primary, secondary, and tertiary 2-hydroxyalkylbenzenes",
        journal="Int. J. Chem. Kinet.",
        volume="31",
        pages="""401-407""",
        year="1999",
