...
entry(
    ...
    rank=10,
    shortDesc="""Herbinet et al.(2006) reference Ea and Warth et al.(1998) prefactor with deltan_int=-1, increase barrier and decreased A""",
)
...
entry(
    ...
    rank=10,
    shortDesc="""A.G. Vandeputte estimate""",
    longDesc="""
