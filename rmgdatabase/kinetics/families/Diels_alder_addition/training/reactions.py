...
entry(
    ...
    degeneracy=2.0,
    kinetics=Arrhenius(
        A=(1.65683, "cm^3/(mol*s)"),
        n=2.97009,
        Ea=(92.4235, "kJ/mol"),
        T0=(1, "K"),
        Tmin=(300, "K"),
        Tmax=(2000, "K"),
        comment="""Fitted to 50 data points; dA = *|/ 1.06288, dn = +|- 0.00809226, dEa = +|- 0.0417279 kJ/mol""",
    ),
    rank=4,
...
entry(
    ...
    degeneracy=2.0,
    kinetics=Arrhenius(
        A=(1.036612, "cm^3/(mol*s)"),
        n=3.00269,
        Ea=(93.9106, "kJ/mol"),
        T0=(1, "K"),
        Tmin=(300, "K"),
        Tmax=(2000, "K"),
        comment="""Fitted to 50 data points; dA = *|/ 1.04507, dn = +|- 0.00585007, dEa = +|- 0.030166 kJ/mol""",
    ),
    rank=4,
    shortDesc="""CCSD(T)-F12a/cc-pVDZ-F12//wB97X-D3/def2-TZVP""",
    longDesc="""
...
entry(
    ...
    degeneracy=2.0,
    kinetics=Arrhenius(
        A=(0.0549546, "cm^3/(mol*s)"),
        n=3.0576,
        Ea=(111.534, "kJ/mol"),
        T0=(1, "K"),
        Tmin=(300, "K"),
        Tmax=(2000, "K"),
        comment="""Fitted to 50 data points; dA = *|/ 1.15407, dn = +|- 0.0190136, dEa = +|- 0.0980442 kJ/mol""",
    ),
    rank=4,
    shortDesc="""CCSD(T)-F12a/cc-pVDZ-F12//wB97X-D3/def2-TZVP""",
    longDesc="""
...
entry(
    ...
    degeneracy=1.0,
    kinetics=Arrhenius(
        A=(17635, "cm^3/(mol*s)"), n=1.8055, Ea=(81.8512, "kJ/mol"), T0=(1, "K")
    ),
    rank=5,
