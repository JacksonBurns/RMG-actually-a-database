...
entry(
    ...
    reference=Article(
        ...
        title="On the Isomerisation of the Methoxy Radical: Relevance to Atmospheric Chemistry and Combustion",
...
entry(
    ...
    reference=Article(
        ...
        title="Zu moglichen umlagerungen zwischen isomeren C3H5-radikalen",
...
entry(
    ...
    reference=Article(
        authors=["Watkins, K.W."],
        title="Photolysis of n-Pentylazomethane Vapor. Reactions of the n-Pentyl Radical",
...
entry(
    ...
    reference=Article(
        ...
        title="The isomerization of n-pentyl and 4-oxo-1-pentyl radicals in the gas phase",
        journal="J. Phys. Chem.",
        volume="70",
        pages="""4081""",
        year="1966",
...
entry(
    ...
    reference=Article(
        ...
        title="Thermal decomposition and isomerization processes of alkyl radicals",
...
entry(
    ...
    reference=Article(
        authors=["Watkins, K.W."],
        title="On the rate constant for n-pentyl radical isomerization",
        journal="Can. J. Chem.",
        volume="50",
        pages="""3738""",
        year="1972",
...
entry(
    ...
    reference=Article(
        ...
        title="Isomerization reactions of alkoxy radicals: theoretical study and structure-activity relationships",
...
entry(
    ...
    reference=Article(
        ...
        title="The 1,5-H-shift in 1-butoxy: A case study in the rigorous implementation of transition state theory for a multirotamer system",
        journal="J. Chem. Phys.",
        volume="119",
        pages="""5159-5170""",
        year="2003",
...
entry(
    ...
    reference=Article(
        ...
        title="The decomposition of normal hexyl radicals",
    ...
    referenceType="experiment",
    shortDesc="""Relative value normalized by a reference value""",
    longDesc="""
...
entry(
    ...
    reference=Article(
        ...
        title="Isomerization of n-hexyl and s-octyl radicals by 1,5 and 1,4 intramolecular hydrogen atom transfer reactions",
        journal="Int. J. Chem. Kinet.",
        volume="19",
        pages="""895""",
        year="1987",
...
entry(
    ...
    reference=Article(
        ...
        title="Isomerization of n-hexyl radicals in the gas phase",
        journal="J. Phys. Chem.",
        volume="73",
        pages="""2080""",
        year="1969",
...
entry(
    ...
    reference=Article(
        ...
        title="Direct measurements of the neopentyl peroxy-hydroperoxy radical isomerisation over the temperature range 660-750 K",
...
entry(
    ...
    degeneracy=1,
    kinetics=Arrhenius(
        A=(8.7e11, "s^-1", "*|/", 5), n=0, Ea=(20.92, "kJ/mol"), T0=(1, "K")
    ),
    reference=Article(
        authors=["Mereau, R.", "Rayez, M.T.", "Caralp, F.", "Rayez, J.C."],
        title="Isomerization reactions of alkoxy radicals: theoretical study and structure-activity relationships",
...
entry(
    ...
    reference=Article(
        authors=["Handford-Styring, S.M.", "Walker, R.W."],
        title="Arrhenius Parameters for the Reaction HO2 + Cyclohexane Between 673 and 773 K, and for H Atom Transfer in Cyclohexylperoxy Radicals",
        journal="Phys. Chem. Chem. Phys.",
        volume="3",
        pages="""2043-2052""",
        year="2001",
