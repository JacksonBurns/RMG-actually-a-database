...
entry(
    ...
    degeneracy=1.0,
    kinetics=Arrhenius(
        A=(2.1e13, "cm^3/(mol*s)"), n=-0.207, Ea=(0, "cal/mol"), T0=(1, "K")
    ),
    rank=3,
...
entry(
    ...
    degeneracy=1.0,
    kinetics=Arrhenius(
        A=(2.75e06, "cm^3/(mol*s)"), n=-0.32, Ea=(7696, "cal/mol"), T0=(1, "K")
    ),
    rank=3,
...
entry(
    ...
    label="C2F5 <=> CF3 + CF2",
    degeneracy=1.0,
    kinetics=Arrhenius(A=(4.27e15, "s^-1"), n=0, Ea=(56240, "cal/mol"), T0=(1, "K")),
    rank=3,
    shortDesc="""The chemkin file reaction is CF3-CF2 <=> CF2 + CF3""",
    longDesc="""
Training reaction from kinetics library: CF2BrCl
...
entry(
    ...
    degeneracy=1.0,
    kinetics=Arrhenius(
        A=(1.58e13, "cm^3/(mol*s)"), n=0, Ea=(0, "cal/mol"), T0=(1, "K")
    ),
    rank=3,
...
entry(
    ...
    degeneracy=1.0,
    kinetics=Arrhenius(A=(3e15, "s^-1"), n=0, Ea=(79000, "cal/mol"), T0=(1, "K")),
    rank=3,
