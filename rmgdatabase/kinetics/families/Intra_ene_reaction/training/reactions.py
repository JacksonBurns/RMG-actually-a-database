...
entry(
    ...
    degeneracy=2.0,
    kinetics=Arrhenius(
        A=(3.201e11, "s^-1"), n=0.6, Ea=(23.767, "kcal/mol"), T0=(1, "K")
    ),
    reference=Article(
        authors=[
            "Krasnoukhov, V. S.",
...
entry(
    ...
    degeneracy=2.0,
    kinetics=Arrhenius(
        A=(4.432e11, "s^-1"), n=0.625, Ea=(26.957, "kcal/mol"), T0=(1, "K")
    ),
    reference=Article(
        authors=[
            "Krasnoukhov, V. S.",
...
entry(
    ...
    degeneracy=2.0,
    kinetics=Arrhenius(
        A=(2.27e10, "s^-1"), n=0.581, Ea=(16.586, "kcal/mol"), T0=(1, "K")
    ),
    reference=Article(
        authors=[
            "Krasnoukhov, V. S.",
...
entry(
    ...
    label="C10H9 <=> C10H9-2",
    degeneracy=1.0,
    kinetics=Arrhenius(A=(2.46e08, "s^-1"), n=1.46, Ea=(16.7, "kcal/mol"), T0=(1, "K")),
    rank=5,
...
entry(
    ...
    degeneracy=1.0,
    kinetics=Arrhenius(A=(5.46e06, "s^-1"), n=2.01, Ea=(27.5, "kcal/mol"), T0=(1, "K")),
    rank=5,
    shortDesc="""Training reaction from kinetics library: naphthalene_H""",
    longDesc="""
...
entry(
    ...
    degeneracy=2.0,
    kinetics=Arrhenius(
        A=(1.01e10, "s^-1"), n=0.97, Ea=(19.17, "kcal/mol"), T0=(1, "K")
    ),
    reference=Article(
...
entry(
    ...
    degeneracy=2.0,
    kinetics=Arrhenius(
        A=(6.21e08, "s^-1"), n=1.38, Ea=(15.29, "kcal/mol"), T0=(1, "K")
    ),
    reference=Article(
        authors=["da Silva, G.", "Cole, J. A.", "Bozzelli, J. W."],
        title="Kinetics of the Cyclopentadienyl + Acetylene, Fulvenallene + H, and 1-Ethynylcyclopentadiene + H Reactions",
...
entry(
    ...
    label="C7H7-5 <=> C7H7-6",
    degeneracy=14.0,
    kinetics=Arrhenius(A=(5.5e08, "s^-1"), n=1.56, Ea=(62.12, "kcal/mol"), T0=(1, "K")),
    reference=Article(
        authors=["da Silva, G.", "Cole, J. A.", "Bozzelli, J. W."],
        title="Kinetics of the Cyclopentadienyl + Acetylene, Fulvenallene + H, and 1-Ethynylcyclopentadiene + H Reactions",
        journal="The Journal of Physical Chemistry A",
...
entry(
    ...
    degeneracy=1.0,
    kinetics=Arrhenius(
        A=(2.125e09, "s^-1"), n=0.991, Ea=(10.983, "kcal/mol"), T0=(1, "K")
    ),
    reference=Article(
        authors=[
            "I. V. Tokmakov",
...
entry(
    ...
    degeneracy=2.0,
    kinetics=Arrhenius(
        A=(9.66e08, "s^-1"), n=1.162, Ea=(44.283, "kcal/mol"), T0=(1, "K")
    ),
    reference=Article(
        authors=[
            "I. V. Tokmakov",
...
entry(
    ...
    degeneracy=1.0,
    kinetics=Arrhenius(
        A=(2.63e09, "s^-1"), n=1.089, Ea=(23.05, "kcal/mol"), T0=(1, "K")
    ),
    rank=3,
    longDesc="""
