...
shortDesc = "Intramolecular ring-closure by concerted addition of two alkene end groups in  a 1_3_hexadien_5_yne backbone (C=C-C=C-C#C) with simultaneous 1,2-H shift over an unsaturated bond to form an unsaturated singlet carbene cyclohexane product"
longDesc = """
...
template(
    reactants=["1_3_hexadien_5_yne"],
    products=["unsaturated_singlet_carbene_cyclohexane"],
    ownReverse=False,
)

reverse = (
    "Concerted_Retro_Intra_Diels_alder_monocyclic_singlet_carbene_disproportionation"
)
