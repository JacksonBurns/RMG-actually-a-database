...
entry(
    ...
    reference=Article(
        ...
        title="Weak collision effects in the reaction C2H5 = C2H4 + H",
        journal="J. Phys. Chem.",
        volume="97",
        pages="""871-880""",
        year="1993",
...
entry(
    ...
    reference=Article(
        ...
        title="Etude experimentale et modelisation theorique de la decomposition du radical ethyle",
        journal="Can. J. Chem.",
        volume="66",
        pages="""2142""",
        year="1988",
...
entry(
    ...
    reference=Article(
        ...
        title="The pyrolysis of ethane. A study of the dissociation reaction C2H5 \u2192\x92 C2H4 + H",
...
entry(
    ...
    reference=Article(
        ...
        title="Observation of equilibration in the system H + C2H4 = C2H5. The determination of the heat of formation of C2H5",
        journal="J. Phys. Chem.",
        volume="90",
        pages="""445-450""",
        year="1986",
...
entry(
    ...
    reference=Article(
        ...
        title="Studies of the pyrolysis of diethylzinc by the toluene carrier method and of the reaction of ethyl radicals with toluene",
        journal="Can. J. Chem.",
        volume="54",
        pages="""482-487""",
        year="1976",
...
entry(
    ...
    reference=Article(
        ...
        title="Thermal decomposition of the ethyl radical",
        journal="Can. J. Chem.",
        volume="45",
        pages="""2795-2803""",
        year="1967",
...
entry(
    ...
    reference=Article(
        ...
        title="The reactions of alkyl radicals. Part V. Ethyl radicals from propionaldehyde",
        journal="J. Chem. Soc.",
        pages="""1611""",
        year="1960",
...
entry(
    ...
    reference=Article(
        ...
        title="The principles governing high-temperature ethane cracking",
        journal="J. Chem. Soc.",
        pages="""4443""",
        year="1960",
...
entry(
    ...
    reference=Article(
        ...
        title="Rate constants for D+C2H4 -&gt; C2H3D+H at high temperature: implications to the high pressure rate constant for H+C2H4 -&gt; C2H5",
...
entry(
    ...
    reference=Article(
        ...
        title="Temperature and pressure dependence of the rate constant for the addition of H to C2H4",
        journal="J. Phys. Chem.",
        volume="91",
        pages="""3373-3379""",
        year="1987",
...
entry(
    ...
    reference=Article(
        ...
        title="Temperature Dependence of the Rate Constants of H and D-Atom Additions to C2H4, C2H3D, C2D4, C2H2, and C2D2",
...
entry(
    ...
    reference=Article(
        authors=["Sugawara, K.", "Okazaki, K.", "Sato, S."],
        title="Kinetic Isotope Effects in the Reaction H + C2H4 \u2192\x92 C2H5",
...
entry(
    ...
    reference=Article(
        ...
        title="Influence de l'Ethylene sur la Pyrolyse de l'Ethane vers 540oC",
        journal="J. Chim. Phys.",
        volume="77",
        pages="""357""",
        year="1980",
...
entry(
    ...
    reference=Article(
        ...
        title="Absolute Rate of the Reaction of Atomic Hydrogen with Ethylene from 198 to 320 K at High Pressure",
        journal="J. Chem. Phys.",
        volume="68",
        pages="""1817""",
        year="1978",
...
entry(
    ...
    reference=Article(
        ...
        title="Mass-spectroscopic determination of rate constants for elementary reactions. III. The rections H + C2H4, H + C3H6, and H + n-C4H8",
        journal="Kinet. Catal.",
        volume="10",
        pages="""14""",
        year="1969",
...
entry(
    ...
    reference=Article(
        authors=["Yang, K."],
        title="Free radical reactions initiated by ionizing radiations. I. Arrhenius parameters for the reactions of hydrogen atoms with propane, ethylene and propylene",
...
entry(
    ...
    reference=Article(
        ...
        title="A Detailed Experimental and Theoretical Study on the Decomposition of Methoxy Radicals",
...
entry(
    ...
    reference=Article(
        ...
        title="Reactions of CH3O radicals in shock waves",
        journal="Kinet. Catal.",
        volume="29",
        pages="""244""",
        year="1988",
...
entry(
    ...
    reference=Article(
        ...
        title="Theoretical prediction of CH3O and CH2OH gas phase decomposition rate coefficients",
        journal="Aust. J. Chem.",
        volume="39",
        pages="""1929""",
        year="1986",
...
entry(
    ...
    reference=Article(
        authors=["Batt, L."],
        title="The Gas-Phase Decomposition of Alkoxy Radicals",
        journal="Int. J. Chem. Kinet.",
        volume="11",
        pages="""977""",
        year="1979",
...
entry(
    ...
    reference=Article(
        authors=["Bowman, C.T."],
        title="A Shock-Tube Investigation of the High-Temperature Oxidation of Methanol",
...
entry(
    ...
    reference=Article(
        ...
        title="Experimental and theoretical study of the C2H3 = H + C2H2 reaction. Tunneling and the shape of falloff curves",
        journal="J. Phys. Chem.",
        volume="100",
        pages="""16899-16911""",
        year="1996",
...
entry(
    ...
    reference=Article(
        ...
        title="Reactions of vinyl radicals at high temperatures: Pyrolysis of vinyl bromide and vinyl iodide and the reaction H + C2D2 \u2192\x92 D + C2HD",
        journal="J. Phys. Chem.",
        volume="92",
        pages="""6313""",
        year="1988",
...
entry(
    ...
    reference=Article(
        ...
        title="Gas-phase hydrogenolysis of chloroethene: Rates, products, and computer modelling",
...
entry(
    ...
    reference=Article(
        ...
        title="Pyrolysis of methyl chloride, a pathway in the chlorine-catalyzed polymerization of methane",
        journal="Int. J. Chem. Kinet.",
        volume="16",
        pages="""307-333""",
        year="1984",
...
entry(
    ...
    reference=Article(
        ...
        title="Arrhenius parameters for the system (CH3)3Si + D2 = (CH3)3SiD + D. The (CH3)3Si-D bond dissociation energy",
...
entry(
    ...
    reference=Article(
        ...
        title="Absolute Rate Constant for the Reaction of Atomic Hydrogen with Acetylene over an Extended Pressure and Temperature Range",
        journal="J. Chem. Phys.",
        volume="64",
        pages="""1150""",
        year="1976",
...
entry(
    ...
    reference=Article(
        ...
        title="Die geschwindigkeit der reaktion von atomarem Wasserstoff mit azetylen",
        journal="Ber. Bunsenges. Phys. Chem.",
        volume="72",
        pages="""1004""",
        year="1968",
...
entry(
    ...
    label="CH3O <=> CH2O + H",
    degeneracy=3,
    kinetics=Arrhenius(A=(5.5e13, "s^-1"), n=0, Ea=(101.1, "kJ/mol"), T0=(1, "K")),
    reference=Article(
...
entry(
    ...
    reference=Article(
        ...
        title="Kinetics of Gas-Phase Addition Reactions of Methyl Radicals. I. Addition to Ethylene, Acetylene, and Benzene",
        journal="Int. J. Chem. Kinet.",
        volume="9",
        pages="""185""",
        year="1977",
...
entry(
    ...
    reference=Article(
        ...
        title="Arrhenius Parameters for the Unimolecular Decompositions of Azomethane and n-Propyl and Isopropyl Radicals and for Methyl Radical Attack on Propane",
        journal="J. Chem. Soc. Faraday Trans. 1",
        volume="71",
        pages="""1491""",
        year="1975",
...
entry(
    ...
    reference=Article(
        ...
        title="Addition of methyl radicals to vinyl chloride and catalysis of di-t-butyl peroxide decomposition by chlorinated compounds",
        journal="J. Am. Chem. Soc.",
        volume="86",
        pages="""4558-4562""",
        year="1964",
...
entry(
    ...
    reference=Article(
        ...
        title="Kinetics of the thermal decomposition of the n-propyl radical",
...
entry(
    ...
    reference=Article(
        authors=["Tsang, W."],
        title="The stability of alkyl radicals",
        journal="J. Am. Chem. Soc.",
        volume="107",
        pages="""2872-2880""",
        year="1985",
...
entry(
    ...
    reference=Article(
        ...
        title="Kinetics of radical reactions in sodium diffusion flames",
        journal="Can. J. Chem.",
        volume="56",
        pages="""941""",
        year="1978",
...
entry(
    ...
    reference=Article(
        ...
        title="Kinetics of the Mercury-Photosensitized Decomposition of Propane. Part II. Reactions of the Propyl Radicals",
        journal="Can. J. Chem.",
        volume="49",
        pages="""549""",
        year="1971",
...
entry(
    ...
    reference=Article(
        ...
        title="Kinetics of the decompositions of ethane and propane sensitized by azomethane. The decomposition of the normal propyl radical",
        journal="Can. J. Chem.",
        volume="44",
        pages="""2927-2940""",
        year="1966",
...
entry(
    ...
    reference=Article(
        ...
        title="The photolysis of azo-n-propane; the decomposition of the n-propyl radical",
        journal="J. Am. Chem. Soc.",
        volume="83",
        pages="""3391""",
        year="1961",
...
entry(
    ...
    reference=Article(
        authors=["Kerr, J.A.", "Trotman-Dickenson, A.F."],
        title="The reactions of alkyl radicals. Part 1.-n-Propyl radicals from the photolysis of n-butyraldehyde",
...
entry(
    ...
    reference=Article(
        ...
        title="A kinetic study of the n-propyl radical decomposition reaction",
        journal="J. Am. Chem. Soc.",
        volume="81",
        pages="""1544-1546""",
        year="1959",
...
entry(
    ...
    reference=Article(
        ...
        title="Kinetic modeling of the propyl radical beta-scission reaction: An application of composite energy methods",
...
entry(
    ...
    reference=Article(
        ...
        title="Photolysis of acetone-d6 in the presence of propane-2,2-d2. Decomposition of the n-propyl radical",
        journal="J. Am. Chem. Soc.",
        volume="83",
        pages="""4891""",
        year="1961",
...
entry(
    ...
    reference=Article(
        ...
        title="Reaktionen von Wasserstoffatomen mit ungesaettigten C3-Kohlenwasserstoffen. III. Die Reaktion von H-Atomen mit Allen",
        journal="Ber. Bunsenges. Phys. Chem.",
        volume="76",
        pages="""667""",
        year="1972",
...
entry(
    ...
    reference=Article(
        ...
        title="Shock wave study on the thermal unimolecular decomposition of allyl radicals",
...
entry(
    ...
    reference=Article(
        ...
        title="Kinetics of the unimolecular decomposition of iso-C3H7: weak collision effects in helium, argon, and nitrogen",
        journal="J. Phys. Chem.",
        volume="97",
        pages="""4450-4458""",
        year="1993",
...
entry(
    ...
    reference=Article(
        ...
        title="Propyl radical isomerization and heterogeneous effects in the pyrolysis of propane below 500\xb0C",
        journal="Proc. R. Soc. London A",
        volume="306",
        pages="""553""",
        year="1968",
...
entry(
    ...
    reference=Article(
        authors=["Kerr, J.A.", "Trotman-Dickenson, A.F."],
        title="The reactions of alkyl radicals. Part 2. s-Propyl radicals from the photolysis of isobutyraldehyde",
        journal="Trans. Faraday Soc.",
        volume="55",
        pages="""921""",
        year="1959",
...
entry(
    ...
    reference=Article(
        authors=["Tsang, W."],
        title="Chemical kinetic data base for hydrocarbon pyrolysis",
...
entry(
    ...
    reference=Article(
        authors=["Wagner, H.Gg.", "Zellner, R."],
        title="Reaktionen von Wasserstoffatomen mit ungesaettigten C3-Kohlenwasserstoffen. I. Die Reaktion von H-Atomen mit Propylen",
        journal="Ber. Bunsenges. Phys. Chem.",
        volume="76",
        pages="""440""",
        year="1972",
...
entry(
    ...
    reference=Article(
        ...
        title="Temperature and Pressure Effects in the Addition of H Atoms to Propylene",
        journal="J. Chem. Phys.",
        volume="54",
        pages="""4662""",
        year="1971",
...
entry(
    ...
    reference=Article(
        ...
        title="Reactions of C2H5 Radicals with O, O3, and NO3: Decomposition Pathways of the Intermediate C2H5O Radical",
        journal="J. Phys. Chem. A",
        volume="103",
        pages="""5692-5698""",
        year="1999",
...
entry(
    ...
    reference=Article(
        ...
        title="The Thermal Unimolecular Decomposition Rate Constants of Ethoxy Radicals",
        journal="Phys. Chem. Chem. Phys.",
        volume="1",
        pages="""2935-2944""",
        year="1999",
...
entry(
    ...
    reference=Article(
        ...
        title="The Gas-Phase Pyrolysis of Alkyl Nitrites. IV. Ethyl Nitrite",
        journal="Int. J. Chem. Kinet.",
        volume="9",
        pages="""549""",
        year="1977",
...
entry(
    ...
    reference=Article(
        ...
        title="Detailed rate coefficients and the enthalpy change of the equilibrium reaction OH+C2H4(+M) = HOC2H4(+M) over the temperature range 544-673 K",
        journal="J. Chem. Phys.",
        volume="96",
        pages="""377-386""",
        year="1992",
...
entry(
    ...
    reference=Article(
        ...
        title="Determination of the temperature and pressure dependence of the reaction OH + C2H4 from 200-400 K using experimental and master equation analyses",
        journal="Phys. Chem. Chem. Phys.",
        volume="8",
        pages="""5633-5642""",
        year="2006",
...
entry(
    ...
    reference=Article(
        ...
        title="Kinetic and Thermodynamic Analysis on OH Addition to Ethylene: Adduct Formation, Isomerization, and Isomer Dissociations",
        journal="J. Phys. Chem. A",
        volume="103",
        pages="""7646-7655""",
        year="1999",
...
entry(
    ...
    reference=Article(
        ...
        title="The gas-phase reactions of hydroxyl radicals with several unsaturated hydrocarbons at atmosphere pressure",
...
entry(
    ...
    reference=Article(
        ...
        title="Kinetic isotope effects in the gas-phase reaction of hydroxyl radicals with ethylene in the temperature range 343-1173 K and at 1-atm pressure",
        journal="J. Phys. Chem.",
        volume="92",
        pages="""3828""",
        year="1988",
...
entry(
    ...
    reference=Article(
        ...
        title="Pulse radiolysis study of the reaction of OH radicals with C2H4 over the temperature range 343-1173 K",
        journal="Int. J. Chem. Kinet.",
        volume="19",
        pages="""25""",
        year="1987",
...
entry(
    ...
    reference=Article(
        ...
        title="Ab initio kinetic study on the low-energy paths of the HO+C2H4 reaction",
        journal="Chem. Phys. Lett.",
        volume="408",
        pages="""25-30""",
        year="2005",
...
entry(
    ...
    reference=Article(
        authors=["Loucks, L.F.", "Laidler, K.J."],
        title="Mercury-photosensitized decomposition of dimethyl ether. Part II. The thermal decomposition of the methoxymethyl radical",
        journal="Can. J. Chem.",
        volume="45",
        pages="""2767-2773""",
        year="1967",
...
entry(
    ...
    reference=Article(
        ...
        title="The enthalpy change and the detailed rate coefficients of the equilibrium reaction OH+C2H2 + M = HOC2H2 + M over the temperature range 627-713K",
        journal="J. Chem. Phys.",
        volume="97",
        pages="""3092-3099""",
        year="1992",
...
entry(
    ...
    reference=Article(
        ...
        title="Experimental and master equation study of the kinetics of OH+C2H2: Temperature dependence of the limiting high pressure and pressure dependent rate coefficients",
        journal="J. Phys. Chem. A",
        volume="111",
        pages="""4043-4055""",
        year="2007",
...
entry(
    ...
    reference=Article(
        authors=["Liu, A.", "Mulac, W.A.", "Jonah, C.D."],
        title="Temperature dependence of the rate constants of the reactions of OH radicals with C2H2 and C2D2 at 1 atm in Ar and from 333 to 1273 K",
        journal="J. Phys. Chem.",
        volume="92",
        pages="""5942""",
        year="1988",
...
entry(
    ...
    reference=Article(
        ...
        title="The high pressure range of the addition of OH to C2H2 and C2H4",
        journal="Ber. Bunsenges. Phys. Chem.",
        volume="101",
        pages="""1433-1442""",
        year="1997",
...
entry(
    ...
    reference=Article(
        ...
        title="Addition of OH to acetylene and consecutive reactions of the adduct with O2",
...
entry(
    ...
    reference=Article(
        ...
        title="A theoretical analysis of the reaction between hydroxyl and acetylene",
        journal="Symp. Int. Combust. Proc.",
        volume="22",
        pages="""1031-1039""",
        year="1989",
...
entry(
    ...
    reference=Article(
        authors=["Wagner, H.Gg.", "Zellner, R."],
        title="Reaktionen von Wasserstoffatomen mit ungesaettigten C3-Kohlenwasserstoffen. II. Die Reaktion von H-Atomen mit Methylacetylen",
        journal="Ber. Bunsenges. Phys. Chem.",
        volume="76",
        pages="""518""",
        year="1972",
...
entry(
    ...
    reference=Article(
        ...
        title="Photochemical smog. Rate parameter estimates and computer simulations",
        journal="J. Phys. Chem.",
        volume="81",
        pages="""2483""",
        year="1977",
...
entry(
    ...
    label="C2H5O <=> CH2O + CH3",
    degeneracy=1,
    kinetics=Arrhenius(A=(3.98e13, "s^-1"), n=0, Ea=(70.4, "kJ/mol"), T0=(1, "K")),
    reference=Article(
        authors=["Rauk, A.", "Boyd, R.J.", "Boyd, S.L.", "Henry, D.J.", "Radom, L."],
        title="Alkoxy radicals in the gaseous phase: beta-scission reactions and formation by radical addition to carbonyl compounds",
        journal="Can. J. Chem.",
...
entry(
    ...
    label="C2H5O-2 <=> C2H4O + H",
    degeneracy=2,
    kinetics=Arrhenius(A=(2.46e13, "s^-1"), n=0, Ea=(87.6, "kJ/mol"), T0=(1, "K")),
    reference=Article(
        authors=["Rauk, A.", "Boyd, R.J.", "Boyd, S.L.", "Henry, D.J.", "Radom, L."],
        title="Alkoxy radicals in the gaseous phase: beta-scission reactions and formation by radical addition to carbonyl compounds",
        journal="Can. J. Chem.",
...
entry(
    ...
    reference=Article(
        ...
        title="A theoretical study of the CH3 + C2H2 reaction",
        journal="J. Chem. Phys.",
        volume="101",
        pages="""3923-3927""",
        year="1994",
...
entry(
    ...
    reference=Article(
        authors=["Diau, E.W.", "Lin, M.C."],
        title="Kinetic modeling of the CH3 + C2H2 reaction data with sensitivity analyses",
        journal="Int. J. Chem. Kinet.",
        volume="27",
        pages="""855-866""",
        year="1995",
...
entry(
    ...
    reference=Article(
        ...
        title="Decomposition of ethoxyl radicals",
...
entry(
    ...
    reference=Article(
        ...
        title="Pressure and temperature dependence of reactions proceeding via a bound complex. An approach for combustion and atmospheric chemistry modelers. Application to HO + CO \u2192\x92 [HOCO] \u2192\x92 H + CO2",
        journal="Int. J. Chem. Kinet.",
        volume="20",
        pages="""27""",
        year="1988",
...
entry(
    ...
    reference=Article(
        ...
        title="Unimolecular decomposition of t-C4H9 radical",
        journal="J. Phys. Chem.",
        volume="98",
        pages="""5279-5289""",
        year="1994",
...
entry(
    ...
    reference=Article(
        ...
        title="The Rate Constant for t-C4H9 \u2192\x92 H + i-C4H8 and the Thermodynamic Parameters of t-C4H9",
        journal="Int. J. Chem. Kinet.",
        volume="13",
        pages="""303""",
        year="1981",
...
entry(
    ...
    reference=Article(
        ...
        title="The reactions of alkyl radicals. Part VII. t-butyl radicals from the photolysis of pivalaldehyde",
        journal="J. Chem. Soc.",
        pages="""4218""",
        year="1960",
...
entry(
    ...
    reference=Article(
        ...
        title="Kinetics of Reactions of H Atoms with Methane and Chlorinated Methanes",
        journal="J. Phys. Chem. A",
        volume="105",
        pages="""3107-3122""",
        year="2001",
...
entry(
    ...
    reference=Article(
        ...
        title="Arrhenius parameters for the reactions of hydrogen and deuterium atoms with four butenes",
        journal="Bull. Chem. Soc. Jpn.",
        volume="56",
        pages="""19-21""",
        year="1983",
...
entry(
    ...
    reference=Article(
        ...
        title="The Rate Constant for H + i-C4H8 \u2192\x92 t-C4H9 in the Range of 298-563 K",
        journal="Int. J. Chem. Kinet.",
        volume="13",
        pages="""295""",
        year="1981",
...
entry(
    ...
    reference=Article(
        ...
        title="The reactions of hydrogen atoms with isobutane and isobutene",
...
entry(
    ...
    reference=Article(
        authors=["Lin, M.C.", "Laidler, K.J."],
        title="Thermal decomposition of the sec-butl radical",
        journal="Can. J. Chem.",
        volume="45",
        pages="""1315""",
        year="1967",
...
entry(
    ...
    reference=Article(
        ...
        title="Asymmetric internal rotation: application to the 2-C4H9=CH3 + C3H6 reaction",
...
entry(
    ...
    reference=Article(
        authors=["Knyazev, V.D.", "Dubinsky, I.A.", "Slagle, I.R.", "Gutman, D."],
        title="Experimental and theoretical study of the sec-C4H9 = CH3 + C3H6 reaction",
        journal="J. Phys. Chem.",
        volume="98",
        pages="""11099-11108""",
        year="1994",
...
entry(
    ...
    reference=Article(
        ...
        title="Isomerization of chemically activated secondary butyl radical",
...
entry(
    ...
    reference=Article(
        ...
        title="The rate constant for the intramolecular isomerization of pentyl radicals",
        journal="Int. J. Chem. Kinet.",
        volume="22",
        pages="""935-950""",
        year="1990",
...
entry(
    ...
    reference=Article(
        ...
        title="Rate constants for the addition of methyl radicals to propene",
        journal="J. Chem. Soc. Faraday Trans. 2",
        volume="83",
        pages="""759""",
        year="1987",
...
entry(
    ...
    reference=Article(
        ...
        title="Free Radical Addition to Olefins Part 9. Addition of Methyl Radicals to Fluoro-ethylenes",
        journal="J. Chem. Soc. Faraday Trans. 1",
        volume="68",
        pages="""1866""",
        year="1972",
...
entry(
    ...
    reference=Article(
        authors=["Knyazev, V.D.", "Slagle, I.R."],
        title="Unimolecular decomposition of n-C4H9 and iso-C4H9 radicals",
        journal="J. Phys. Chem.",
        volume="100",
        pages="""5318-5328""",
        year="1996",
...
entry(
    ...
    reference=Article(
        ...
        title="The photolysis of 1,1'-azo-n-butane vapor. The reactions of the n-butyl free radical",
        journal="J. Am. Chem. Soc.",
        volume="88",
        pages="""5387""",
        year="1966",
...
entry(
    ...
    reference=Article(
        authors=["Kerr, J.A.", "Trotman-Dickenson, A.F."],
        title="The reactions of alkyl radicals. Part III. n-Butyl radicals from the photolysis of n-Valeraldehyde",
        journal="J. Chem. Soc.",
        pages="""1602""",
        year="1960",
...
entry(
    ...
    reference=Article(
        authors=["Zheng, X.B.", "Blowers, P."],
        title="The application of composite energy methods to n-butyl radical beta-scission reaction kinetic estimations",
...
entry(
    ...
    reference=Article(
        ...
        title="Kinetics of the addition of ethyl, isopropyl, n-butyl, and isopentyl radicals to ethylene",
        journal="J. Phys. Chem.",
        volume="73",
        pages="""4094-4102""",
        year="1969",
...
entry(
    ...
    reference=Article(
        ...
        title="Radical addition, decomposition, and isomerization reactions in the pyrolysis of ethane and ethylene",
        journal="Can. J. Chem.",
        volume="62",
        pages="""1325""",
        year="1984",
...
entry(
    ...
    reference=Article(
        ...
        title="Thermochemical and Kinetic Studies of Alkyl Nitrites (RONO)-D(RO-NO), The Reactions between RO. and NO, and the Decomposition RO.",
...
entry(
    ...
    reference=Article(
        ...
        title="The pressure dependence of the decomposition of the isopropoxyl radical",
        journal="J. Phys. Chem.",
        volume="72",
        pages="""2824""",
        year="1968",
...
entry(
    ...
    reference=Article(
        ...
        title="Reactions of the isopropoxyl radical. Part II. Pressure dependence and kinetics of pyrolysis at 160-200\xb0 in the gas phase",
...
entry(
    ...
    reference=Article(
        ...
        title="Reactions of the isopropoxyl radical. Part I. Pyrolysis of isopropyl nitrite in a static system at 175-200\xb0",
        journal="J. Chem. Soc.",
        pages="""4416""",
        year="1965",
...
entry(
    ...
    reference=Article(
        ...
        title="Etude cinetique et modelisation de la reaction thermique de l'isobutene vers 800 K. II. Isobutene en presence d'hydrogene",
        journal="J. Chim. Phys.",
        volume="91",
        pages="""1628-1647""",
        year="1994",
...
entry(
    ...
    reference=Article(
        ...
        title="The photolysis of 1,1'-azoisobutane vapor at 3660 A. The reactions of the isobutyl free radical",
        journal="J. Am. Chem. Soc.",
        volume="90",
        pages="""268-273""",
        year="1968",
...
entry(
    ...
    reference=Article(
        ...
        title="The reactions of alkyl radicals. Part VIII. Isobutyl radicals from the photolysis of isovaleraldehyde",
        journal="J. Chem. Soc.",
        pages="""5072-5077""",
        year="1960",
...
entry(
    ...
    reference=Article(
        ...
        title="Catalytic dehydration of alcohols by OH. 2-propanol: an intermediate case",
        journal="J. Phys. Chem.",
        volume="97",
        pages="""6457-6464""",
        year="1993",
...
entry(
    ...
    reference=Article(
        ...
        title="Thermochemical and kinetic analyses on oxidation of isobutenyl radical and 2-hydroperoxymethyl-2-propenyl radical",
        journal="J. Phys. Chem. A",
        volume="109",
        pages="""9044-9053""",
        year="2005",
...
entry(
    ...
    reference=Article(
        ...
        title="Addition of atomic hydrogen to acetylene. Chain reactions of the vinyl radical",
        journal="Chem. Phys. Lett.",
        volume="105",
        pages="""119""",
        year="1984",
...
entry(
    ...
    reference=Article(
        authors=["Benson, S.W."],
        title="The mechanism of the reversible reaction: 2C2H2 = vinyl acetylene and the pyrolysis of butadiene",
        journal="Int. J. Chem. Kinet.",
        volume="21",
        pages="""233-243""",
        year="1989",
...
entry(
    ...
    reference=Article(
        ...
        title="Rate parameters for the reactions of C2H3 and C4H5 with H2 and C2H2",
        journal="J. Phys. Chem.",
        volume="92",
        pages="""4080""",
        year="1988",
...
entry(
    ...
    reference=Article(
        ...
        title="The reactions of alkyl radicals. Part XII. The additions of methyl, ethyl, and isopropyl radicals to allene",
        journal="J. Chem. Soc. A",
        pages="""979-982""",
        year="1967",
...
entry(
    ...
    reference=Article(
        ...
        title="The vapor phase photolysis of 2-methylbutanal at wave length 3130 A",
        journal="J. Am. Chem. Soc.",
        volume="78",
        pages="""5208""",
        year="1956",
...
entry(
    ...
    reference=Article(
        ...
        title="Absolute Rate Constants and Temperature Dependences for the Gas Phase Reactions of H Atoms with Propene and the Butenes in the Temperature Range 298 to 445 K",
        journal="J. Chem. Phys.",
        volume="77",
        pages="""3994""",
        year="1982",
...
entry(
    ...
    reference=Article(
        authors=["Back, M.H."],
        title="Mechanism of the pyrolysis of acetylene",
        journal="Can. J. Chem.",
        volume="49",
        pages="""2199""",
        year="1971",
...
entry(
    ...
    reference=Article(
        ...
        title="A shock tube study on the thermal decomposition of toluene and of the phenyl radical at high temperatures",
        journal="Symp. Int. Combust. Proc.",
        volume="22",
        pages="""1053-1061""",
        year="1989",
...
entry(
    ...
    label="C3H7O <=> C3H6O + H",
    degeneracy=1,
    kinetics=Arrhenius(A=(1.58e13, "s^-1"), n=0, Ea=(76.6, "kJ/mol"), T0=(1, "K")),
    reference=Article(
        authors=["Rauk, A.", "Boyd, R.J.", "Boyd, S.L.", "Henry, D.J.", "Radom, L."],
        title="Alkoxy radicals in the gaseous phase: beta-scission reactions and formation by radical addition to carbonyl compounds",
        journal="Can. J. Chem.",
...
entry(
    ...
    label="C3H7O-2 <=> C2H4O + CH3",
    degeneracy=2,
    kinetics=Arrhenius(A=(9.12e13, "s^-1"), n=0, Ea=(60.1, "kJ/mol"), T0=(1, "K")),
    reference=Article(
        authors=["Rauk, A.", "Boyd, R.J.", "Boyd, S.L.", "Henry, D.J.", "Radom, L."],
        title="Alkoxy radicals in the gaseous phase: beta-scission reactions and formation by radical addition to carbonyl compounds",
        journal="Can. J. Chem.",
...
entry(
    ...
    reference=Article(
        ...
        title="Kinetische untersuchungen der reaktionen von methylradikalen mit allen",
...
entry(
    ...
    label="C3H7O-5 <=> C3H6O-2 + H",
    degeneracy=2,
    kinetics=Arrhenius(A=(1.7e13, "s^-1"), n=0, Ea=(85.8, "kJ/mol"), T0=(1, "K")),
    reference=Article(
        authors=["Rauk, A.", "Boyd, R.J.", "Boyd, S.L.", "Henry, D.J.", "Radom, L."],
        title="Alkoxy radicals in the gaseous phase: beta-scission reactions and formation by radical addition to carbonyl compounds",
        journal="Can. J. Chem.",
...
entry(
    ...
    degeneracy=1,
    kinetics=Arrhenius(A=(3.39e14, "s^-1"), n=0, Ea=(94.8, "kJ/mol"), T0=(1, "K")),
    reference=Article(
        authors=["Rauk, A.", "Boyd, R.J.", "Boyd, S.L.", "Henry, D.J.", "Radom, L."],
        title="Alkoxy radicals in the gaseous phase: beta-scission reactions and formation by radical addition to carbonyl compounds",
        journal="Can. J. Chem.",
...
entry(
    ...
    degeneracy=2,
    kinetics=Arrhenius(A=(1.1e13, "s^-1"), n=0, Ea=(77.2, "kJ/mol"), T0=(1, "K")),
    reference=Article(
        authors=["Rauk, A.", "Boyd, R.J.", "Boyd, S.L.", "Henry, D.J.", "Radom, L."],
        title="Alkoxy radicals in the gaseous phase: beta-scission reactions and formation by radical addition to carbonyl compounds",
        journal="Can. J. Chem.",
...
entry(
    ...
    reference=Article(
        authors=["Getty, R.R.", "Kerr, J.A.", "Trotman-Dickenson, A.F."],
        title="The reactions of alkyl radicals. Part XIII. The additions of methyl, isopropyl, and t-butyl radicals to propyne and the isomerisation of alkenyl radicals",
        journal="J. Chem. Soc. A",
        pages="""1360""",
        year="1967",
...
entry(
    ...
    reference=Article(
        ...
        title="The pyrolysis of acetylene initiated by acetone",
        journal="Combust. Flame",
        volume="75",
        pages="""343-366""",
        year="1989",
...
entry(
    ...
    reference=Article(
        ...
        title="Free Radical Additions to the C=O Bond of Formaldehyde",
        journal="React. Kinet. Catal. Lett.",
        volume="15",
        pages="""481""",
        year="1980",
...
entry(
    ...
    reference=Article(
        authors=["Somnitz, H."],
        title="The contribution of tunnelling to the 1,5 H-shift isomerisation reaction of alkoxyl radicals",
        journal="Phys. Chem. Chem. Phys.",
        volume="10",
        pages="""965-973""",
        year="2008",
...
entry(
    ...
    reference=Article(
        ...
        title="Alkoxy Radical Reactions: The Isomerization of n-Butoxy Radicals Generated from the Pyrolysis of n-Butyl Nitrite",
        journal="Chem. Phys. Lett.",
        volume="60",
        pages="""108""",
        year="1978",
...
entry(
    ...
    reference=Article(
        ...
        title="Isomerization of Chemically Activated n-Pentyl Radicals",
        journal="J. Phys. Chem.",
        volume="75",
        pages="""1632""",
        year="1971",
...
entry(
    ...
    reference=Article(
        ...
        title="Unimolecular Decomposition of the n-C3H7 Radical.  Direct Dynamics Calculation of the Thermal Rate Constant",
        journal="Phys. Chem. Chem. Phys.",
        volume="3",
        pages="""2459-2466""",
        year="2001",
...
entry(
    ...
    reference=Article(
        ...
        title="The beta C-C bond scission in alkoxy radicals: thermal unimolecular decomposition of t-butoxy radicals",
        journal="Phys. Chem. Chem. Phys.",
        volume="2",
        pages="""1677-1683""",
        year="2000",
...
entry(
    ...
    reference=Article(
        ...
        title="Decomposition of the t-butoxy radical: II. Studies over the temperature range 303-393 K",
        journal="Int. J. Chem. Kinet.",
        volume="21",
        pages="""535-546""",
        year="1989",
...
entry(
    ...
    reference=Article(
        authors=["Batt, L.", "Robinson, G.N."],
        title="Arrhenius Parameters for the Decomposition of the t-Butoxy Radical",
        journal="Int. J. Chem. Kinet.",
        volume="14",
        pages="""1053""",
        year="1982",
...
entry(
    ...
    reference=Article(
        authors=["Batt, L.", "Milne, R.T."],
        title="The Gas Phase Pyrolysis of Alkyl Nitrites. I. t-Butyl Nitrite",
        journal="Int. J. Chem. Kinet.",
        volume="8",
        pages="""59""",
        year="1976",
...
entry(
    ...
    reference=Article(
        authors=["Yee Quee, M.J.", "Thynne, J.C.J."],
        title="Pressure-dependence of decomposition of tert-butoxyl radical",
        journal="Trans. Faraday Soc.",
        volume="63",
        pages="""2970-2974""",
        year="1967",
...
entry(
    ...
    reference=Article(
        ...
        title="Photolysis of di-t-butyl peroxide-azomethane and ei-t-butyl peroxide-isobutane mixtures",
        journal="J. Am. Chem. Soc.",
        volume="82",
        pages="""2422""",
        year="1960",
...
entry(
    ...
    reference=Article(
        ...
        title="On the Gas-Phase Free Radical Displacement Reaction CH3 + CD3COCD3 \u2192\x92 CD3 + CH3COCD3",
        journal="Int. J. Chem. Kinet.",
        volume="12",
        pages="""623""",
        year="1980",
...
entry(
    ...
    reference=Article(
        ...
        title="Unimolecular decomposition of the neopentyl radical",
        journal="J. Phys. Chem.",
        volume="95",
        pages="""7732-7739""",
        year="1991",
...
entry(
    ...
    reference=Article(
        ...
        title="Arrhenius parameters of elementary reactions involved in the oxidation of neopentane",
        journal="J. Chem. Soc. Faraday Trans. 1",
        volume="78",
        pages="""1615""",
        year="1982",
...
entry(
    ...
    reference=Article(
        ...
        title="Kinetics of the Decomposition of Neopentane Sensitized by Azoisopropane",
...
entry(
    ...
    reference=Article(
        ...
        title="Influences of ClH and BrH on the Pyrolyses of Neopentane and Ethane at Small Extents of Reaction",
        journal="Int. J. Chem. Kinet.",
        volume="9",
        pages="""425""",
        year="1977",
...
entry(
    ...
    reference=Article(
        authors=["Szirovicza, L.", "Marta, F."],
        title="Kinetics of the Decomposition of neo-Pentane Sensitized by Azoisopropane",
        journal="React. Kinet. Catal. Lett.",
        volume="3",
        pages="""9""",
        year="1975",
...
entry(
    ...
    reference=Article(
        ...
        title="Kinetics of the Mercury- Photosensitized Decomposition of Neopentane. Part II. Reactions of the Methyl and Neopentyl Radicals",
        journal="Can. J. Chem.",
        volume="50",
        pages="""1123""",
        year="1972",
...
entry(
    ...
    degeneracy=1,
    kinetics=Arrhenius(A=(1.74e14, "s^-1"), n=0, Ea=(85.6, "kJ/mol"), T0=(1, "K")),
    reference=Article(
        authors=["Rauk, A.", "Boyd, R.J.", "Boyd, S.L.", "Henry, D.J.", "Radom, L."],
        title="Alkoxy radicals in the gaseous phase: beta-scission reactions and formation by radical addition to carbonyl compounds",
        journal="Can. J. Chem.",
...
entry(
    ...
    degeneracy=1,
    kinetics=Arrhenius(A=(9.77e12, "s^-1"), n=0, Ea=(72.2, "kJ/mol"), T0=(1, "K")),
    reference=Article(
        authors=["Rauk, A.", "Boyd, R.J.", "Boyd, S.L.", "Henry, D.J.", "Radom, L."],
        title="Alkoxy radicals in the gaseous phase: beta-scission reactions and formation by radical addition to carbonyl compounds",
        journal="Can. J. Chem.",
...
entry(
    ...
    degeneracy=1,
    kinetics=Arrhenius(A=(2.69e13, "s^-1"), n=0, Ea=(50.7, "kJ/mol"), T0=(1, "K")),
    reference=Article(
        authors=["Rauk, A.", "Boyd, R.J.", "Boyd, S.L.", "Henry, D.J.", "Radom, L."],
        title="Alkoxy radicals in the gaseous phase: beta-scission reactions and formation by radical addition to carbonyl compounds",
        journal="Can. J. Chem.",
...
entry(
    ...
    reference=Article(
        ...
        title="H2S-promoted thermal isomerization of Cis-2-pentene to 1-pentene and trans-2-pentene around 800 K",
        journal="Int. J. Chem. Kinet.",
        volume="20",
        pages="""621""",
        year="1988",
...
entry(
    ...
    reference=Article(
        ...
        title="Radiation-sensitized pyrolysis of diethyl ether. Free-radical reaction rate parameters",
        journal="J. Am. Chem. Soc.",
        volume="92",
        pages="""6118""",
        year="1970",
...
entry(
    ...
    label="C4H9O-3 <=> C3H6O + CH3",
    degeneracy=3,
    kinetics=Arrhenius(A=(1.15e14, "s^-1"), n=0, Ea=(56.9, "kJ/mol"), T0=(1, "K")),
    reference=Article(
        authors=["Rauk, A.", "Boyd, R.J.", "Boyd, S.L.", "Henry, D.J.", "Radom, L."],
        title="Alkoxy radicals in the gaseous phase: beta-scission reactions and formation by radical addition to carbonyl compounds",
        journal="Can. J. Chem.",
...
entry(
    ...
    reference=Article(
        authors=["Gierczak, T.", "Gawlowski, J.", "Niedzielski, J."],
        title="Mutual isomerization of cyclopentyl and 1-penten-5-yl radicals",
        journal="Int. J. Chem. Kinet.",
        volume="18",
        pages="""623-637""",
        year="1986",
...
entry(
    ...
    reference=Article(
        ...
        title="Reaction of methyl radicals with cis-butene-2",
        journal="Can. J. Chem.",
        volume="47",
        pages="""2987""",
        year="1969",
...
entry(
    ...
    reference=Article(
        ...
        title="Pressure-dependence of the gas-phase pyrolysis of the s-butoxyl radical at 150-190\xb0",
        journal="J. Chem. Soc. A",
        pages="""1939""",
        year="1967",
...
entry(
    ...
    reference=Article(
        ...
        title="The Gas-Phase Pyrolysis of Alkyl Nitrites. II. s-Butyl Nitrite",
        journal="Int. J. Chem. Kinet.",
        volume="8",
        pages="""911""",
        year="1976",
...
entry(
    ...
    reference=Article(
        ...
        title="Reactions of primary and secondary butoxy radicals in oxygen at atmospheric pressure",
        journal="Int. J. Chem. Kinet.",
        volume="23",
        pages="""607-622""",
        year="1991",
...
entry(
    ...
    label="C4H9O-6 <=> C2H4O + C2H5-2",
    degeneracy=1,
    kinetics=Arrhenius(A=(5.25e13, "s^-1"), n=0, Ea=(48.9, "kJ/mol"), T0=(1, "K")),
    reference=Article(
        authors=["Rauk, A.", "Boyd, R.J.", "Boyd, S.L.", "Henry, D.J.", "Radom, L."],
        title="Alkoxy radicals in the gaseous phase: beta-scission reactions and formation by radical addition to carbonyl compounds",
        journal="Can. J. Chem.",
...
entry(
    ...
    degeneracy=1,
    kinetics=Arrhenius(A=(1.51e13, "s^-1"), n=0, Ea=(75.6, "kJ/mol"), T0=(1, "K")),
    reference=Article(
        authors=["Rauk, A.", "Boyd, R.J.", "Boyd, S.L.", "Henry, D.J.", "Radom, L."],
        title="Alkoxy radicals in the gaseous phase: beta-scission reactions and formation by radical addition to carbonyl compounds",
        journal="Can. J. Chem.",
...
entry(
    ...
    label="C4H9O-8 <=> C3H6O-2 + CH3",
    degeneracy=1,
    kinetics=Arrhenius(A=(1.78e13, "s^-1"), n=0, Ea=(62.3, "kJ/mol"), T0=(1, "K")),
    reference=Article(
        authors=["Rauk, A.", "Boyd, R.J.", "Boyd, S.L.", "Henry, D.J.", "Radom, L."],
        title="Alkoxy radicals in the gaseous phase: beta-scission reactions and formation by radical addition to carbonyl compounds",
        journal="Can. J. Chem.",
...
entry(
    ...
    reference=Article(
        ...
        title="A kinetic study of the metathetical and addition reactions characteristic of allyl polymerization",
        journal="Can. J. Chem.",
        volume="40",
        pages="""796-803""",
        year="1962",
...
entry(
    ...
    reference=Article(
        ...
        title="Die reaktionen von atomarem wasserstoff mit cyclohexen, cyclohexadien-1,3 und benzol",
        journal="Ber. Bunsenges. Phys. Chem.",
        volume="79",
        pages="""156""",
        year="1975",
...
entry(
    ...
    reference=Article(
        ...
        title="The mechanism and rate parameters for the pyrolysis of n-hexane in the range 723-823 K",
        journal="Int. J. Chem. Kinet.",
        volume="19",
        pages="""81""",
        year="1987",
...
entry(
    ...
    reference=Article(
        authors=["Quinn, C.P."],
        title="Isomerization of primary n-alkyl radicals in the pyrolysis of ethane",
        journal="J. Chem. Soc. Faraday Trans. 2",
        volume="59",
        pages="""2543""",
        year="1963",
...
entry(
    ...
    reference=Article(
        ...
        title="Addition of cyclopentane to slowly reacting mixtures of H2 + O2 between 673 and 783 K: reactions of H and OH with cyclopentane and of cyclopentyl radicals",
        journal="J. Chem. Soc. Faraday Trans.",
        volume="91",
        pages="""1431-1438""",
        year="1995",
...
entry(
    ...
    reference=Article(
        ...
        title="Decomposition of 2,3-dimethylbutane in the presence of oxygen. Part 2.-Elementary reactions involved in the formation of products",
        journal="J. Chem. Soc. Faraday Trans. 1",
        volume="80",
        pages="""3195""",
        year="1984",
...
entry(
    ...
    reference=Article(
        ...
        title="Elementary Reactions in the Oxidation of Alkenes",
        journal="Symp. Int. Combust. Proc.",
        volume="18",
        pages="""819""",
        year="1981",
...
entry(
    ...
    reference=Article(
        ...
        title="Theoretical study of the initial reaction between OH and isoprene in tropospheric conditions",
        journal="Phys. Chem. Chem. Phys.",
        volume="5",
        pages="""1392-1399""",
        year="2003",
...
entry(
    ...
    reference=Article(
        ...
        title="The Gas-Phase Pyrolysis of Alkyl Nitrites. VI. t-Amyl Nitrite",
        journal="Int. J. Chem. Kinet.",
        volume="10",
        pages="""931""",
        year="1978",
...
entry(
    ...
    reference=Article(
        ...
        title="Gas phase decomposition and isomerization reactions of 2-pentoxy radicals",
        journal="Int. J. Chem. Kinet.",
        volume="18",
        pages="""329""",
        year="1986",
...
entry(
    ...
    reference=Article(
        ...
        title="Addition of 2,2,3-Trimethylbutane to Slowly Reacting Mixtures of Hydrogen and Oxygen at 480oC",
        journal="J. Chem. Soc. Faraday Trans. 1",
        volume="77",
        pages="""2157""",
        year="1981",
...
entry(
    ...
    reference=Article(
        ...
        title="Thermal reaction of azoisopropane in the presence of (E)-CH3CH = CHCH3: reactions of the radical 2-C3H7",
        journal="J. Chem. Soc. Faraday Trans.",
        volume="91",
        pages="""1303-1312""",
        year="1995",
...
entry(
    ...
    reference=Article(
        ...
        title="Reactions of the ethyl radical. II. Addition to unsaturated hydrocarbons",
        journal="Proc. R. Soc. London A",
        volume="244",
        pages="""297-311""",
        year="1958",
