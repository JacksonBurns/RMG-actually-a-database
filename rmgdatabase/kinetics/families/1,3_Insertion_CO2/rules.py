...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        uncertainty=RateUncertainty(
            mu=0.1623246572352582,
            var=27.089230696923906,
            Tref=1000.0,
            N=8,
            data_mean=0.0,
            correlation="Root",
        ),
        comment="""BM rule fitted to 8 training reactions at node Root
...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        Tmax=(2000, "K"),
        uncertainty=RateUncertainty(
            mu=-12.41552760724517,
            var=320.71014689362426,
            Tref=1000.0,
            N=2,
            data_mean=0.0,
            correlation="Root_5CbCdCsHN->Cs",
        ),
        comment="""BM rule fitted to 2 training reactions at node Root_5CbCdCsHN->Cs
...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        Tmax=(2000, "K"),
        uncertainty=RateUncertainty(
            mu=0.0852817481199456,
            var=16.704684453181038,
            Tref=1000.0,
            N=6,
            data_mean=0.0,
            correlation="Root_N-5CbCdCsHN->Cs",
        ),
        comment="""BM rule fitted to 6 training reactions at node Root_N-5CbCdCsHN->Cs
...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        uncertainty=RateUncertainty(
            ...
            N=1,
            data_mean=0.0,
            correlation="Root_5CbCdCsHN->Cs_4CbCdCsHN->Cs",
        ),
        comment="""BM rule fitted to 1 training reactions at node Root_5CbCdCsHN->Cs_4CbCdCsHN->Cs
...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        uncertainty=RateUncertainty(
            ...
            N=1,
            data_mean=0.0,
            correlation="Root_5CbCdCsHN->Cs_N-4CbCdCsHN->Cs",
        ),
        comment="""BM rule fitted to 1 training reactions at node Root_5CbCdCsHN->Cs_N-4CbCdCsHN->Cs
    Total Standard Deviation in ln(k): 11.540182761524994""",
    ),
    rank=11,
...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        Tmax=(2000, "K"),
        uncertainty=RateUncertainty(
            mu=0.26419894212477385,
            var=45.86391189281504,
            Tref=1000.0,
            N=3,
            data_mean=0.0,
            correlation="Root_N-5CbCdCsHN->Cs_4CbCdCsHN->H",
        ),
        comment="""BM rule fitted to 3 training reactions at node Root_N-5CbCdCsHN->Cs_4CbCdCsHN->H
...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        Tmax=(2000, "K"),
        uncertainty=RateUncertainty(
            mu=-0.009489328295250576,
            var=1.1130688182633763,
            Tref=1000.0,
            N=3,
            data_mean=0.0,
            correlation="Root_N-5CbCdCsHN->Cs_N-4CbCdCsHN->H",
        ),
        comment="""BM rule fitted to 3 training reactions at node Root_N-5CbCdCsHN->Cs_N-4CbCdCsHN->H
...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        Tmax=(2000, "K"),
        uncertainty=RateUncertainty(
            mu=0.0004649474097141082,
            var=84.16755128353569,
            Tref=1000.0,
            N=2,
            data_mean=0.0,
            correlation="Root_N-5CbCdCsHN->Cs_4CbCdCsHN->H_5CbCdHN->Cd",
        ),
        comment="""BM rule fitted to 2 training reactions at node Root_N-5CbCdCsHN->Cs_4CbCdCsHN->H_5CbCdHN->Cd
...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        uncertainty=RateUncertainty(
            ...
            N=1,
            data_mean=0.0,
            correlation="Root_N-5CbCdCsHN->Cs_4CbCdCsHN->H_N-5CbCdHN->Cd",
        ),
        comment="""BM rule fitted to 1 training reactions at node Root_N-5CbCdCsHN->Cs_4CbCdCsHN->H_N-5CbCdHN->Cd
    Total Standard Deviation in ln(k): 11.540182761524994""",
    ),
    rank=11,
...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        Tmax=(2000, "K"),
        uncertainty=RateUncertainty(
            mu=5.3453611489250746e-05,
            var=2.530939774000289,
            Tref=1000.0,
            N=2,
            data_mean=0.0,
            correlation="Root_N-5CbCdCsHN->Cs_N-4CbCdCsHN->H_Ext-4CsN-R",
        ),
        comment="""BM rule fitted to 2 training reactions at node Root_N-5CbCdCsHN->Cs_N-4CbCdCsHN->H_Ext-4CsN-R
...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        uncertainty=RateUncertainty(
            ...
            N=1,
            data_mean=0.0,
            correlation="Root_N-5CbCdCsHN->Cs_4CbCdCsHN->H_5CbCdHN->Cd_Ext-5Cd-R_Ext-6R!H-R",
        ),
        comment="""BM rule fitted to 1 training reactions at node Root_N-5CbCdCsHN->Cs_4CbCdCsHN->H_5CbCdHN->Cd_Ext-5Cd-R_Ext-6R!H-R
    Total Standard Deviation in ln(k): 11.540182761524994""",
    ),
    rank=11,
...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        uncertainty=RateUncertainty(
            ...
            N=1,
            data_mean=0.0,
            correlation="Root_N-5CbCdCsHN->Cs_N-4CbCdCsHN->H_Ext-4CsN-R_Ext-4CsN-R",
        ),
        comment="""BM rule fitted to 1 training reactions at node Root_N-5CbCdCsHN->Cs_N-4CbCdCsHN->H_Ext-4CsN-R_Ext-4CsN-R
    Total Standard Deviation in ln(k): 11.540182761524994""",
    ),
    rank=11,
