...
entry(
    ...
    degeneracy=4.0,
    kinetics=Arrhenius(
        A=(2.04107e-05, "cm^3/(mol*s)"),
        n=5.03741,
        Ea=(330.096, "kJ/mol"),
        T0=(1, "K"),
        Tmin=(300, "K"),
        Tmax=(2000, "K"),
        comment="""Fitted to 50 data points; dA = *|/ 1.75369, dn = +|- 0.0745346, dEa = +|- 0.384339 kJ/mol""",
    ),
    rank=4,
...
entry(
    ...
    degeneracy=4.0,
    kinetics=Arrhenius(
        A=(0.00462404, "cm^3/(mol*s)"),
        n=4.43694,
        Ea=(287.389, "kJ/mol"),
        T0=(1, "K"),
        Tmin=(300, "K"),
        Tmax=(2000, "K"),
        comment="""Fitted to 50 data points; dA = *|/ 1.15053, dn = +|- 0.0186065, dEa = +|- 0.0959448 kJ/mol""",
    ),
    rank=4,
    shortDesc="""CCSD(T)-F12a/cc-pVDZ-F12//wB97X-D3/def2-TZVP""",
    longDesc="""
...
entry(
    ...
    degeneracy=2.0,
    kinetics=Arrhenius(
        A=(0.0798156, "cm^3/(mol*s)"),
        n=3.39053,
        Ea=(304.609, "kJ/mol"),
        T0=(1, "K"),
        Tmin=(300, "K"),
        Tmax=(2000, "K"),
        comment="""Fitted to 50 data points; dA = *|/ 1.33054, dn = +|- 0.0378939, dEa = +|- 0.195401 kJ/mol""",
    ),
    rank=4,
    shortDesc="""CCSD(T)-F12a/cc-pVDZ-F12//wB97X-D3/def2-TZVP""",
    longDesc="""
