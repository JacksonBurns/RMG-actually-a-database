...
entry(
    ...
    reference=Article(
        ...
        title="Dehydration Mechanisms in the Thermal Decomposition of Gaseous Formic Acid",
...
entry(
    ...
    reference=Article(
        ...
        title="The homogeneous decomposition reactions of gaseous formic acid",
...
entry(
    ...
    reference=Article(
        authors=["Blake, P.G.", "Jackson, G.E."],
        title="The thermal decomposition of acetic acid",
        journal="J. Chem. Soc. B",
        pages="""1153-1155""",
        year="1968",
...
entry(
    ...
    reference=Article(
        ...
        title="The thermal decomposition of propionic acid",
        journal="J. Chem. Soc. B",
        pages="""577-579""",
        year="1966",
...
entry(
    ...
    reference=Article(
        ...
        title="Studies in Decarboxylation. Part 14. The Gas-phase Decarboxylation of But-3-enoic Acid and the Intermediacy of Isocrotonic (cis-But-2-enoic) Acid in its Isomerization to Crotonic (trans-But-2-enoic) Acid",
...
entry(
    ...
    reference=Article(
        ...
        title="Studies in Decarboxylation. Part 10. Effect of \u03b2-Substituents on the Rate of Gas-phase Decarboxylation of \u03b2\u03b2\u03b2\u03b2\u03c0\u03b2-Unsaturated Acids",
        journal="J. Chem. Soc. Perkin Trans. 2",
        pages="""745""",
        year="1977",
...
entry(
    ...
    reference=Article(
        ...
        title="Decarboxylation. I. Kinetic study of the vapor phase thermal decarboxylation of 3-butenoic acid",
        journal="J. Phys. Chem.",
        volume="68",
        pages="""1231-1234""",
        year="1964",
...
entry(
    ...
    reference=Article(
        ...
        title="The thermolysis and photolysis of malonic acid in the gas phase",
        journal="Can. J. Chem.",
        volume="64",
        pages="""967""",
        year="1986",
...
entry(
    ...
    reference=Article(
        ...
        title="Studies in Decarboxylation. Part VIII. The Gas-phase Pyrolysis of \u03b2\u03c0-Acetylenic Acids",
        journal="J. Chem. Soc. Perkin Trans. 2",
        pages="""592""",
        year="1976",
...
entry(
    ...
    reference=Article(
        ...
        title="Studies in Decarboxylation. Par t 15. The Effects of 3-Substitution on the Rate of Decarboxylation of \u03b2\u03b2\u03c0\u03b2-Unsaturated Acids",
        journal="J. Chem. Soc. Perkin Trans. 2",
        pages="""15""",
        year="1982",
...
entry(
    ...
    reference=Article(
        ...
        title="Studies in decarboxylation. Part IV. The effect of alkyl substituents on the rate of gas-phase decarboxylation of some \u03b2\u03b3-unsaturated acids",
        journal="J. Chem. Soc. B",
        pages="""557-559""",
        year="1967",
...
entry(
    ...
    reference=Article(
        ...
        title="Very low pressure pyrolysis of phenylacetic acid",
