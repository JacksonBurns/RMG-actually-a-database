...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        uncertainty=RateUncertainty(
            mu=0.07426102205682039,
            var=5.843756410023497,
            Tref=1000.0,
            N=5,
            correlation="Root",
        ),
        comment="""BM rule fitted to 5 training reactions at node Root
...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        Tmax=(1500, "K"),
        uncertainty=RateUncertainty(
            mu=-0.03637485531705508,
            var=0.9131482536096801,
            Tref=1000.0,
            N=4,
            correlation="Root_1R!H->C",
        ),
        comment="""BM rule fitted to 4 training reactions at node Root_1R!H->C
...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        comment="""BM rule fitted to 1 training reactions at node Root_N-1R!H->C
...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        uncertainty=RateUncertainty(
            ...
            Tref=1000.0,
            N=1,
            correlation="Root_1R!H->C_Ext-2R!H-R_Ext-2R!H-R",
        ),
        comment="""BM rule fitted to 1 training reactions at node Root_1R!H->C_Ext-2R!H-R_Ext-2R!H-R
    Total Standard Deviation in ln(k): 11.540182761524994""",
    ),
    rank=11,
...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        Tmax=(1500, "K"),
        uncertainty=RateUncertainty(
            mu=0.9611482244452804,
            var=0.025199359283703242,
            Tref=1000.0,
            N=2,
            correlation="Root_1R!H->C_Ext-2R!H-R_Ext-3R!H-R_Ext-3R!H-R_Ext-2R!H-R",
        ),
        comment="""BM rule fitted to 2 training reactions at node Root_1R!H->C_Ext-2R!H-R_Ext-3R!H-R_Ext-3R!H-R_Ext-2R!H-R
...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        uncertainty=RateUncertainty(
            ...
            Tref=1000.0,
            N=1,
            correlation="Root_1R!H->C_Ext-2R!H-R_Ext-3R!H-R_Ext-3R!H-R_Ext-2R!H-R_Ext-4R!H-R",
        ),
        comment="""BM rule fitted to 1 training reactions at node Root_1R!H->C_Ext-2R!H-R_Ext-3R!H-R_Ext-3R!H-R_Ext-2R!H-R_Ext-4R!H-R
    Total Standard Deviation in ln(k): 11.540182761524994""",
    ),
    rank=11,
