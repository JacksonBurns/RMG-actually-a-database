...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        uncertainty=RateUncertainty(
            mu=0.05596479637465522,
            var=12.199334969367145,
            Tref=1000.0,
            N=4,
            data_mean=0.0,
            correlation="Root",
        ),
        comment="""BM rule fitted to 4 training reactions at node Root
...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        uncertainty=RateUncertainty(
            ...
            N=1,
            data_mean=0.0,
            correlation="Root_5R-inRing",
        ),
        comment="""BM rule fitted to 1 training reactions at node Root_5R-inRing
...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        Tmax=(1500, "K"),
        uncertainty=RateUncertainty(
            mu=0.07273255958472015,
            var=8.341559373079228,
            Tref=1000.0,
            N=3,
            data_mean=0.0,
            correlation="Root_N-5R-inRing",
        ),
        comment="""BM rule fitted to 3 training reactions at node Root_N-5R-inRing
...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        Tmax=(1500, "K"),
        uncertainty=RateUncertainty(
            mu=-1.0677542868543719e-14,
            var=2.0856100788436827,
            Tref=1000.0,
            N=2,
            data_mean=0.0,
            correlation="Root_N-5R-inRing_5R->C",
        ),
        comment="""BM rule fitted to 2 training reactions at node Root_N-5R-inRing_5R->C
...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        uncertainty=RateUncertainty(
            ...
            N=1,
            data_mean=0.0,
            correlation="Root_N-5R-inRing_N-5R->C",
        ),
        comment="""BM rule fitted to 1 training reactions at node Root_N-5R-inRing_N-5R->C
    Total Standard Deviation in ln(k): 11.540182761524994""",
    ),
    rank=11,
...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        uncertainty=RateUncertainty(
            ...
            N=1,
            data_mean=0.0,
            correlation="Root_N-5R-inRing_5R->C_Ext-7R-R_Ext-9R!H-R",
        ),
        comment="""BM rule fitted to 1 training reactions at node Root_N-5R-inRing_5R->C_Ext-7R-R_Ext-9R!H-R
    Total Standard Deviation in ln(k): 11.540182761524994""",
    ),
    rank=11,
