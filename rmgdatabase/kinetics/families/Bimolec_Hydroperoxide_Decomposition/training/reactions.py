...
entry(
    ...
    degeneracy=4.0,
    kinetics=Arrhenius(
        A=(6.918e6, "m^3/(mol*s)"), n=0.0, Ea=(121.7, "kJ/mol"), T0=(1, "K")
    ),
    rank=6,
    shortDesc="""Experimental rate at 393-413 K in cyclohexanol solvent""",
    longDesc="""
...
entry(
    ...
    degeneracy=1.0,
    kinetics=Arrhenius(
        A=(1.096e5, "m^3/(mol*s)"), n=0.0, Ea=(96.1, "kJ/mol"), T0=(1, "K")
    ),
    rank=6,
    shortDesc="""Experimental rate at 333-363 K in heptane solvent""",
    longDesc="""
...
entry(
    ...
    degeneracy=1.0,
    kinetics=Arrhenius(
        A=(6.31e4, "m^3/(mol*s)"), n=0.0, Ea=(100.0, "kJ/mol"), T0=(1, "K")
    ),
    rank=6,
    shortDesc="""Experimental rate at 333-363 K in 2-methylbutane solvent""",
    longDesc="""
...
entry(
    ...
    degeneracy=1.0,
    kinetics=Arrhenius(
        A=(2.512e8, "m^3/(mol*s)"), n=0.0, Ea=(120, "kJ/mol"), T0=(1, "K")
    ),
    rank=6,
    shortDesc="""Experimental rate at 333-353 K in benzene solvent""",
    longDesc="""
