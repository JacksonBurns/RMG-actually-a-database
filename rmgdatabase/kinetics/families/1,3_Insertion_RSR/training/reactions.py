...
entry(
    ...
    rank=5,
    shortDesc="""CBS-QB3 calculations from CAC, energy from F12a""",
    longDesc="""
...
entry(
    ...
    rank=5,
    shortDesc="""CBS-QB3 by CAC with 1d-hr, F12a energies""",
    longDesc="""
