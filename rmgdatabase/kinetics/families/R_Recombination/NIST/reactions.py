...
entry(
    ...
    reference=Article(
        ...
        title="Kinetics of the reaction of atomic hydrogen with acetylene",
        journal="J. Chem. Phys.",
        volume="18",
        pages="""1632-1637""",
        year="1950",
...
entry(
    ...
    reference=Article(
        authors=["Forst, W."],
        title="Microcanonical variational theory of radical recombination by inversion of interpolated partition function, with examples: CH3 + H, CH3 + CH3",
        journal="J. Phys. Chem.",
        volume="95",
        pages="""3612-3620""",
        year="1991",
...
entry(
    ...
    reference=Article(
        ...
        title="Kinetics of the Reactions of Hydrogen Atoms with Ethylene and Vinyl Fluoride",
...
entry(
    ...
    reference=Article(
        ...
        title="Thermal rate constants for SiH4=SiH3+H and CH4=CH3+H by Canonical Variational Transition State Theory",
...
entry(
    ...
    reference=Article(
        ...
        title="Thermal rate constant for H + CH3 \u2192\x92 CH4 recombination. 3. Comparison of experiment and canonical variational transition state theory",
...
entry(
    ...
    reference=Article(
        ...
        title="Theory of thermal unimolecular reactions at high pressures. II. Analysis of experimental results",
        journal="J. Chem. Phys.",
        volume="83",
        pages="""1010-1015""",
        year="1985",
...
entry(
    ...
    reference=Article(
        ...
        title="Rate Constants for H + CH4, CH3 + H2, and CH4 Dissociation at High Temperature",
...
entry(
    ...
    reference=Article(
        ...
        title="Shock tube studies on the pyrolysis and oxidation of methane",
        journal="J. Phys. Chem.",
        volume="63",
        pages="""1736""",
        year="1959",
...
entry(
    ...
    reference=Article(
        ...
        title="The activation energy for the pyrolysis of methane",
        journal="J. Phys. Chem.",
        volume="67",
        pages="""709""",
        year="1963",
...
entry(
    ...
    reference=Article(
        ...
        title="Determination of the rate constant for thermal cracking of methane by means of adiabatic compression and expansion",
...
entry(
    ...
    reference=Article(
        ...
        title="Some comparisons of the classical RRK and the RRKM theoretical rate formulations",
        journal="J. Chem. Phys.",
        volume="43",
        pages="""4071-4080""",
        year="1965",
...
entry(
    ...
    referenceType="theory",
    shortDesc="""Estimated: thermochemical, kinetic, or other""",
    longDesc="""
PrIMe Reaction: r00010887
...
entry(
    ...
    reference=Article(
        ...
        title="Thermal Decomposition of Methane Behind Reflected Shock Waves",
        journal="Symp. Int. Combust. Proc.",
        volume="13",
        pages="""147""",
        year="1971",
...
entry(
    ...
    reference=Article(
        ...
        title="The Thermal Decomposition of Methane. I.Kinetics of the Promary Decomposition to C2H6 + H2; Rate Constant for the Homogeneous Unimolecular Dissociation of Methane and its Pressure Dependence",
        journal="Can. J. Chem.",
        volume="53",
        pages="""3580""",
        year="1975",
...
entry(
    ...
    referenceType="review",
    shortDesc="""Extensive literature review""",
    longDesc="""
PrIMe Reaction: r00010887
...
entry(
    ...
    reference=Article(
        authors=["Dean, A.M."],
        title="Predictions of pressure and temperature effects upon radical addition and recombination reactions",
        journal="J. Phys. Chem.",
        volume="89",
        pages="""4600-4608""",
        year="1985",
...
entry(
    ...
    reference=Article(
        ...
        title="Pressure dependence of methane dissociation",
...
entry(
    ...
    reference=Article(
        authors=["Cobos, C.J.", "Troe, J."],
        title="The dissociation-recombination system CH4 + M = CH3 + H + M: reevaluated experiments from 300 to 3000 K",
...
entry(
    ...
    reference=Article(
        ...
        title="Pyrolysis of methane under static conditions at 1100-1400 K",
        journal="Kinet. Catal.",
        volume="32",
        pages="""234-240""",
        year="1991",
...
entry(
    ...
    reference=Article(
        ...
        title="Communication: revised values for the rate coefficients of ethane and methane decomposition",
        journal="Int. J. Chem. Kinet.",
        volume="27",
        pages="""305-308""",
        year="1995",
...
entry(
    ...
    reference=Article(
        ...
        title="Thermal Decomposition of Methanol behind Shock Waves",
...
entry(
    ...
    reference=Article(
        ...
        title="Bimolecular QRRK analyss of methyl radical reactions",
        journal="Int. J. Chem. Kinet.",
        volume="19",
        pages="""207""",
        year="1987",
...
entry(
    ...
    reference=Article(
        ...
        title="Pressure and temperature dependence of reactions proceeding via a bound complex. 2. Application to 2CH3 \u2192\x92 C2H5 + H",
...
entry(
    ...
    reference=Article(
        ...
        title="Investigation of the High Temperature Pyrolysis of Acetylene",
        journal="Kinet. Catal.",
        volume="15",
        pages="""835""",
        year="1974",
...
entry(
    ...
    reference=Article(
        ...
        title="High-Temperature Pyrolysis of Dimethyl Ether",
        journal="Int. J. Chem. Kinet.",
        volume="9",
        pages="""471""",
        year="1977",
...
entry(
    ...
    reference=Article(
        ...
        title="Kinetics of the pyrolysis of methanol",
        journal="J. Phys. Chem.",
        volume="81",
        pages="""2555""",
        year="1977",
...
entry(
    ...
    reference=Article(
        ...
        title="Zum thermischen unimolekularen Zerfall von Methanol",
...
entry(
    ...
    reference=Article(
        authors=["Tsang, W."],
        title="Chemical kinetic data base for combustion chemistry. Part 2. Methanol",
        journal="J. Phys. Chem. Ref. Data",
        volume="16",
        pages="""471""",
        year="1987",
...
entry(
    ...
    reference=Article(
        ...
        title="The kinetics of the oxidation of ethane by nitrous oxide",
        journal="J. Chem. Soc.",
        pages="""660-666""",
        year="1958",
...
entry(
    ...
    reference=Article(
        ...
        title="Shock tube experiments on the pyrolysis of ethane",
        journal="J. Phys. Chem.",
        volume="64",
        pages="""1025""",
        year="1960",
...
entry(
    ...
    reference=Article(
        ...
        title="Kinetics and mechanisms of the thermal decomposition of ethane. I. The uninhibited reaction",
...
entry(
    ...
    reference=Article(
        ...
        title="Kinetic data from nonisothermal experiments: thermal decomposition of ethane, ethylene, and acetylene",
        journal="AIChE J.",
        volume="7",
        pages="""693-698""",
        year="1961",
...
entry(
    ...
    reference=Article(
        ...
        title="Single-pulse shock tube studies on the kinetics of the thermal decomposition of methane",
        journal="Combust. Flame",
        volume="6",
        pages="""253""",
        year="1962",
...
entry(
    ...
    reference=Article(
        authors=["Quinn, C.P."],
        title="The thermal dissociation and pyrolysis of ethane",
...
entry(
    ...
    reference=Article(
        ...
        title="The dissociation of ethane",
        journal="J. Chem. Soc.",
        pages="""392""",
        year="1964",
...
entry(
    ...
    reference=Article(
        ...
        title="the thermal decomposition of ethane. Part II. The unimolecular decomposition of the ethane molecule and the ethyl radical",
        journal="Can. J. Chem.",
        volume="44",
        pages="""2357""",
        year="1966",
...
entry(
    ...
    reference=Article(
        authors=["Lin, M.C.", "Back, M.H."],
        title="The thermal decomposition of ethane. Part I. Initiation and termination steps",
        journal="Can. J. Chem.",
        volume="44",
        pages="""505-514""",
        year="1966",
...
entry(
    ...
    reference=Article(
        ...
        title="Dissociation and kinetics of thermal decomposition of ethane",
...
entry(
    ...
    reference=Article(
        ...
        title="Some aspects of theory and experiment in the ethane-methyl radical system",
        journal="Int. J. Chem. Kinet.",
        volume="3",
        pages="""105-125""",
        year="1971",
...
entry(
    ...
    reference=Article(
        ...
        title="Arrhenius Parameters of the Reaction CH3. + C2H6 \u2192\x92 CH4 + C2H5.",
        journal="J. Chem. Soc. Faraday Trans. 1",
        volume="68",
        pages="""1462""",
        year="1972",
...
entry(
    ...
    reference=Article(
        ...
        title="High Temperature Decomposition of Ethane",
        journal="Int. J. Chem. Kinet.",
        volume="5",
        pages="""345""",
        year="1973",
...
entry(
    ...
    reference=Article(
        ...
        title="Kinetic Isotope Effect in the Thermal Dissociation of Ethane",
        journal="J. Chem. Soc. Faraday Trans. 1",
        volume="72",
        pages="""706""",
        year="1976",
...
entry(
    ...
    reference=Article(
        ...
        title="Thermal Dissociation Rate of Ethane at the High Pressure Limit from 250 to 2500 K",
        journal="J. Phys. Chem.",
        volume="83",
        pages="""922""",
        year="1979",
...
entry(
    ...
    reference=Article(
        ...
        title="Wall-less Reactor Studies. Part 1. - Ethane Pyrolysis",
        journal="J. Chem. Soc. Faraday Trans. 1",
        volume="75",
        pages="""1089""",
        year="1979",
...
entry(
    ...
    reference=Article(
        ...
        title="Measurements of Some Elementary Hydrocarbon Reactions at High Temperatures",
...
entry(
    ...
    reference=Article(
        authors=["Trenwith, A.B."],
        title="Re-examination of the Thermal Dissociation of Ethane",
        journal="J. Chem. Soc. Faraday Trans. 1",
        volume="75",
        pages="""614""",
        year="1979",
...
entry(
    ...
    reference=Article(
        ...
        title="Ethane Decomposition and the Reference Rate Constant for Methyl Radical Recombination",
        journal="Combust. Flame",
        volume="37",
        pages="""313""",
        year="1980",
...
entry(
    ...
    reference=Article(
        ...
        title="High Temperature Methyl Radical Reactions with Atomic and Molecular Oxygen",
...
entry(
    ...
    reference=Article(
        ...
        title="Resonance Absorption Measurements of Atom Concentrations in Reacting Gas Mixtures. 7. Pyrolysis of C2H6 and C2D6 behind Shock Waves",
        journal="J. Phys. Chem.",
        volume="85",
        pages="""3126""",
        year="1981",
...
entry(
    ...
    reference=Article(
        ...
        title="Consistency of theory and experiment in the ethane-methyl radical system",
        journal="Int. J. Chem. Kinet.",
        volume="13",
        pages="""481""",
        year="1981",
...
entry(
    ...
    reference=Article(
        ...
        title="Induced heterogeneity, a novel technique for the study of gas-phase reactions. 2. Direct study of C-C bond scission in ethane",
        journal="Int. J. Chem. Kinet.",
        volume="15",
        pages="""845""",
        year="1983",
...
entry(
    ...
    reference=Article(
        ...
        title="Thermal decomposition of ethane in shock waves",
        journal="Int. J. Chem. Kinet.",
        volume="17",
        pages="""441""",
        year="1985",
...
entry(
    ...
    reference=Article(
        authors=["Tsang, W."],
        title="Rate constants for the decomposition and formation of simple alkanes over extended temperature and pressure ranges",
        journal="Combust. Flame",
        volume="78",
        pages="""71-86""",
        year="1989",
...
entry(
    ...
    reference=Article(
        ...
        title="A study of ethane decomposition in a shock tube using laser absorption of CH3",
        journal="Int. J. Chem. Kinet.",
        volume="25",
        pages="""969-982""",
        year="1993",
...
entry(
    ...
    reference=Article(
        ...
        title="Free radicals by mass spectrometry. IV. The rate of combination of methyl radicals",
        journal="J. Chem. Phys.",
        volume="21",
        pages="""1135-1144""",
        year="1953",
...
entry(
    ...
    reference=Article(
        authors=["Ingold, K.U.", "Lossing, F.P."],
        title="The rate of combination of methyl radicals",
        journal="J. Chem. Phys.",
        volume="21",
        pages="""368""",
        year="1953",
...
entry(
    ...
    reference=Article(
        ...
        title="The pressure and temperature dependence of the rate constant for methyl radical recombination over the temperature range 296-577 K",
...
entry(
    ...
    reference=Article(
        authors=["Macpherson, M.T.", "Pilling, M.J.", "Smith, M.J.C."],
        title="Determination of the absorption cross section for CH3 at 216.36 nm and the absolute rate constant for methyl radical recombination over the temperature range 296-577 K",
        journal="J. Phys. Chem.",
        volume="89",
        pages="""2268-2274""",
        year="1985",
...
entry(
    ...
    reference=Article(
        ...
        title="High temperature reactions of CH3. 1. The reactions CH3 + H2 \u2192\x92 CH4 + H",
        journal="Ber. Bunsenges. Phys. Chem.",
        volume="90",
        pages="""854""",
        year="1986",
...
entry(
    ...
    reference=Article(
        ...
        title="Study of the recombination reaction CH3 + CH3 \u2192\x92 C2H6. 2. Theory",
        journal="J. Phys. Chem.",
        volume="92",
        pages="""2462-2471""",
        year="1988",
...
entry(
    ...
    reference=Article(
        ...
        title="Recombination of CH3 radicals at elevated pressures and temperatures",
        journal="Symp. Int. Combust. Proc.",
        volume="23",
        pages="""99-105""",
        year="1991",
...
entry(
    ...
    reference=Article(
        ...
        title="Experimental and theoretical study of the recombination reaction CH3 + CH3 \u2192\x92 C2H6",
        journal="Symp. Int. Combust. Proc.",
        volume="23",
        pages="""107-114""",
        year="1991",
...
entry(
    ...
    reference=Article(
        ...
        title="Fitting of pressure-dependent kinetic rate data by master equation/inverse laplace transform analysis",
        journal="J. Phys. Chem.",
        volume="99",
        pages="""13452-13460""",
        year="1995",
...
entry(
    ...
    reference=Article(
        ...
        title="Recombination of methyl radicals. 1. New data between 1175 and 1750 K in the falloff region",
        journal="J. Phys. Chem.",
        volume="100",
        pages="""974-983""",
        year="1996",
...
entry(
    ...
    reference=Article(
        ...
        title="Application of the canonical flexible transition state theory to CH3, CF3, and CCl3",
        journal="J. Phys. Chem. A",
        volume="102",
        pages="""8526-8536""",
        year="1998",
...
entry(
    ...
    reference=Article(
        ...
        title="Interpretation of the slow reaction and second limit of hydrogen oxygen mixtures by computer methods",
...
entry(
    ...
    reference=Article(
        ...
        title="Conventional transition state theory/Rice-Ramsperger-Kassel-Marcus theory calculations of thermal termolecular rate coefficients for H(D)+O2+M",
        journal="J. Chem. Phys.",
        volume="105",
        pages="""10367-10379""",
        year="1996",
...
entry(
    ...
    reference=Article(
        authors=["McLane, C.K."],
        title="Hydrogen peroxide in the thermal hydrogen oxygen reaction. I. Thermal decomposition of hydrogen peroxide",
        journal="J. Chem. Phys.",
        volume="17",
        pages="""379-385""",
        year="1949",
...
entry(
    ...
    reference=Article(
        ...
        title="Specific rate constants k(E,J) and product state distributions in simple bond fission reactions. II. Application to HOOH \u2192\x92 OH + OH",
        journal="J. Chem. Phys.",
        volume="86",
        pages="""6171""",
        year="1987",
...
entry(
    ...
    reference=Article(
        authors=["Tsang, W."],
        title="Chemical kinetic data base for combustion chemistry. Part 3. Propane",
        journal="J. Phys. Chem. Ref. Data",
        volume="17",
        pages="""887""",
        year="1988",
...
entry(
    ...
    reference=Article(
        authors=["Chiang, C.-C.", "Skinner, G.B."],
        title="Resonance Absorption Measurements of Atom Concentrations in Reacting Gas Mixtures 5. Pyrolysis of C3H8 and C3D8 Behind Shock Waves",
        journal="Symp. Int. Combust. Proc.",
        volume="18",
        pages="""915""",
        year="1981",
...
entry(
    ...
    reference=Article(
        ...
        title="High-temperature ethane and propane decomposition",
...
entry(
    ...
    reference=Article(
        ...
        title="Temperature Dependence of Chain Initiation in Pyrolysis of Propane Studied by Direct Mass-Spectrometric Detection of Methyl Radicals",
...
entry(
    ...
    reference=Article(
        ...
        title="Etude cinetique de l'ethane forme dans la pyrolyse homogene du propane et mesure de la constante de vitesse d'amorcage",
        journal="J. Chim. Phys.",
        volume="91",
        pages="""313-328""",
        year="1994",
...
entry(
    ...
    reference=Article(
        ...
        title="Thermal decomposition of propane in shock waves",
        journal="Int. J. Chem. Kinet.",
        volume="21",
        pages="""689-701""",
        year="1989",
...
entry(
    ...
    reference=Article(
        ...
        title="Effects of olefins on the thermal decomposition of propane. Part III. Some remarks on the kinetics of decomposition",
        journal="Int. J. Chem. Kinet.",
        volume="18",
        pages="""255""",
        year="1986",
...
entry(
    ...
    reference=Article(
        ...
        title="Induced heterogeneity, a novel technique for the study of gas-phase reactions. Part I. Determination of the Arrhenius parameters for C-C bond scission in propane",
        journal="Int. J. Chem. Kinet.",
        volume="15",
        pages="""63""",
        year="1983",
...
entry(
    ...
    reference=Article(
        ...
        title="Shock-tube study of propane pyrolysis. Rate of initial dissociation from 1400 to 2300 K",
        journal="J. Phys. Chem.",
        volume="87",
        pages="""499""",
        year="1983",
...
entry(
    ...
    reference=Article(
        ...
        title="Minor Products and Initiation Rate in the Chain Pyrolysis of Propane",
        journal="Int. J. Chem. Kinet.",
        volume="13",
        pages="""855""",
        year="1981",
...
entry(
    ...
    reference=Article(
        ...
        title="Resonance absorption measurements of atom concentrations in reacting gas mixtures. 5. Pyrolysis of propane and propane-D8 behind shock waves",
...
entry(
    ...
    reference=Article(
        ...
        title="Modelisation de la pyrolyse du propane",
        journal="J. Chim. Phys.",
        volume="75",
        pages="""991-993""",
        year="1978",
...
entry(
    ...
    reference=Article(
        authors=["Kao, W.", "Yeh, C."],
        title="The role of the termination reaction H + CH3 \u2192\x92 CH4 in the pyrolysis of propane in the temperature range 1100-1300 K",
        journal="J. Chem. Phys.",
        volume="81",
        pages="""2304-2306""",
        year="1977",
...
entry(
    ...
    reference=Article(
        ...
        title="Derivation of rate constants for steps in the free-radical chain decomposition of paraffins",
        journal="Proc. R. Soc. London A",
        volume="268",
        pages="""36""",
        year="1962",
...
entry(
    ...
    referenceType="experiment",
    shortDesc="""Derived from detailed balance/reverse rate""",
    longDesc="""
PrIMe Reaction: r00002700
Bath gas: C3H8
""",
...
entry(
    ...
    reference=Article(
        ...
        title="Propylene photolysis at 6.7 eV: Calculation of the quantum yields for the secondary processes",
        journal="J. Photochem.",
        volume="32",
        pages="""281""",
        year="1986",
...
entry(
    ...
    reference=Article(
        authors=["Szwarc, M."],
        title="The kinetics of the thermal decomposition of propylene",
        journal="J. Chem. Phys.",
        volume="17",
        pages="""284-291""",
        year="1949",
...
entry(
    ...
    reference=Article(
        ...
        title="Shock tube and modeling study of propene pyrolysis",
        journal="Int. J. Chem. Kinet.",
        volume="24",
        pages="""761-780""",
        year="1992",
...
entry(
    ...
    reference=Article(
        ...
        title="The Pyrolysis of Dimethyl Ether and Formaldehyde",
        journal="Symp. Int. Combust. Proc.",
        volume="19",
        pages="""81""",
        year="1982",
...
entry(
    ...
    reference=Article(
        authors=["Pacey, P.D."],
        title="The Initial Stages of the Pyrolysis of Dimethyl Ether",
        journal="Can. J. Chem.",
        volume="53",
        pages="""2742""",
        year="1975",
...
entry(
    ...
    reference=Article(
        ...
        title="Further studies of the pyrolysis of dimethyl ether",
        journal="J. Chem. Phys.",
        volume="31",
        pages="""1008""",
        year="1959",
...
entry(
    ...
    reference=Article(
        authors=["Benson, S.W."],
        title="Pyrolysis of dimethyl ether",
        journal="J. Chem. Phys.",
        volume="25",
        pages="""27-31""",
        year="1956",
...
entry(
    ...
    reference=Article(
        authors=["Tsang, W."],
        title="Thermal Stability of Alcohols",
        journal="Int. J. Chem. Kinet.",
        volume="8",
        pages="""173""",
        year="1976",
...
entry(
    ...
    reference=Article(
        ...
        title="Shock-tube and modeling study of acetaldehyde pyrolysis and oxidation",
        journal="Int. J. Chem. Kinet.",
        volume="40",
        pages="""73-102""",
        year="2008",
...
entry(
    ...
    reference=Article(
        ...
        title="Shock-tube study of the thermal decomposition of CH3CHO and CH3CHO+H reaction",
        journal="J. Phys. Chem. A",
        volume="112",
        pages="""6120-6124""",
        year="2008",
...
entry(
    ...
    reference=Article(
        ...
        title="Untersuchungen zum Thermischen Zerfall von Acetaldehyd und Aceton",
        journal="Ber. Bunsenges. Phys. Chem.",
        volume="80",
        pages="""645""",
        year="1976",
...
entry(
    ...
    reference=Article(
        ...
        title="High-Temperature Pyrolysis of Acetaldehyde",
        journal="Int. J. Chem. Kinet.",
        volume="7",
        pages="""223""",
        year="1975",
...
entry(
    ...
    reference=Article(
        ...
        title="Investigation of the Thermal Decomposition of Acetaldehyde",
...
entry(
    ...
    reference=Article(
        ...
        title="Elementary processes in the acetaldehyde pyrolysis",
        journal="Can. J. Chem.",
        volume="46",
        pages="""479""",
        year="1968",
...
entry(
    ...
    reference=Article(
        authors=["Burcat, A."],
        title="Cracking of Propylene in a Shock Tube",
        journal="Fuel",
        volume="54",
        pages="""87""",
        year="1975",
...
entry(
    ...
    reference=Article(
        ...
        title="A shock tube study of the pyrolysis of propylene. Kinetics of the vinyl-methyl bond rupture",
        journal="J. Phys. Chem.",
        volume="72",
        pages="""4672-4675""",
        year="1968",
...
entry(
    ...
    reference=Article(
        ...
        title="The initiation of propylene pyrolysis",
        journal="Can. J. Chem.",
        volume="44",
        pages="""2778-2780""",
        year="1966",
...
entry(
    ...
    reference=Article(
        ...
        title="Flash photolysis study of the CH3O2 + CH3O2 and CH3O2 + HO2 reactions between 600 and 719 K: unimolecular decomposition of methylhydroperoxide",
        journal="J. Chem. Soc. Faraday Trans.",
        volume="87",
        pages="""3213-3220""",
        year="1991",
...
entry(
    ...
    reference=Article(
        authors=["Kirk, A.D."],
        title="The thermal decomposition of methyl hydroperoxide",
        journal="Can. J. Chem.",
        volume="43",
        pages="""2236-2242""",
        year="1965",
...
entry(
    ...
    reference=Article(
        ...
        title="A global technique for analysing multiple decay curves. Application to the CH3 + O2 system",
        journal="J. Chem. Soc. Faraday Trans. 2",
        volume="84",
        pages="""505""",
        year="1988",
...
entry(
    ...
    reference=Article(
        ...
        title="Thermal isomerization and decomposition of 2-butyne in shock waves",
        journal="J. Phys. Chem.",
        volume="97",
        pages="""10977-10983""",
        year="1993",
...
entry(
    ...
    reference=Article(
        authors=[
            "Belmekki, N. Glaude, P.A.",
            "Da Costa, I.",
            "Fournet, R.",
            "Battin-Leclerc, F.",
        ],
        title="Experimental and Modeling Study of the Oxidation of 1-Butyne and 2-Butyne",
        journal="Int J. Chem. Kinet.",
        volume="34",
        pages="""172-183""",
        year="2002",
...
entry(
    ...
    reference=Article(
        ...
        title="A Shock Tube, Laser-Schlieren Study of the Pyrolysis of Isobutene: Relaxation, Incubation, and Dissociation Rates",
        journal="Int. J",
        volume="35",
        pages="""381-390""",
        year="2003",
...
entry(
    ...
    reference=Article(
        ...
        title="Etude cinetique et modelisaiton de la reaction thermique de l'isobutene vers 800 K. I. Isobutene pur",
        journal="J. Chim. Phys.",
        volume="91",
        pages="""1597-1627""",
        year="1994",
...
entry(
    ...
    reference=Article(
        authors=["Szwarc, M."],
        title="The kinetics of the thermal decomposition of isobutene",
        journal="J. Chem. Phys.",
        volume="17",
        pages="""292-295""",
        year="1949",
...
entry(
    ...
    reference=Article(
        ...
        title="High Temperature Thermal Decomposition of Acetylene and Diacetylene at Low Relative Concentrations",
        journal="Combust. Flame",
        volume="38",
        pages="""231""",
        year="1980",
...
entry(
    ...
    reference=Article(
        authors=["Trenwith, A.B."],
        title="Dissociation of 1-butene, 3-methyl-1-butene, and of 3,3-dimethyl-1-butene and the resonance energy of the allyl, methyl allyl and dimethyl allyl radicals",
        journal="Trans. Faraday Soc.",
        volume="66",
        pages="""2805-2811""",
        year="1970",
...
entry(
    ...
    reference=Article(
        ...
        title="The pyrolysis of but-1-ene, and the resonance energy of the allyl radical",
        journal="J. Chem. Soc.",
        pages="""6652-6654""",
        year="1965",
...
entry(
    ...
    reference=Article(
        ...
        title="The CH2:CH2-CH3 bond dissociation energy and the heat of formation of the allyl radical",
        journal="Proc. R. Soc. London A",
        volume="202",
        pages="""263-276""",
        year="1950",
...
entry(
    ...
    reference=Article(
        ...
        title="Initiation of isobutane pyrolysis",
        journal="Trans. Faraday Soc.",
        volume="64",
        pages="""405-413""",
        year="1968",
...
entry(
    ...
    reference=Article(
        authors=["Tsang, W."],
        title="Evidence for Strongly Temperature-Dependent A Factors in Alkane Decomposition and High Heats of Formation for Alkyl Radicals",
        journal="Int. J. Chem. Kinet.",
        volume="10",
        pages="""821""",
        year="1978",
...
entry(
    ...
    reference=Article(
        ...
        title="Rate Constants for the Initiation of n-Butane Pyrolysis and for the Recombination of Ethyl Radicals",
        journal="J. Chem. Soc. Faraday Trans. 1",
        volume="70",
        pages="""594""",
        year="1974",
...
entry(
    ...
    reference=Article(
        ...
        title="Very Low-Pressure Pyrolysis (VLPP) of Alkanes: n-Butane, 2,3-Dimethylbutane, 2,2',3,3'-Tetramethylbutane, and Isobutane",
        journal="Int. J. Chem. Kinet.",
        volume="6",
        pages="""359""",
        year="1974",
...
entry(
    ...
    reference=Article(
        authors=["Lin, M.C.", "Back, M.H."],
        title="The thermal decomposition of ethane. Part III. Secondary reactions",
        journal="Can. J. Chem.",
        volume="44",
        pages="""2369""",
        year="1966",
...
entry(
    ...
    reference=Article(
        authors=["Forst, W."],
        title="Temperature-dependent A factor in thermal unimolecular reactions",
        journal="J. Phys. Chem.",
        volume="83",
        pages="""100-108""",
        year="1979",
...
entry(
    ...
    reference=Article(
        ...
        title="The pyrolysis of n-butane",
        journal="Proc. R. Soc. London A",
        volume="270",
        pages="""267""",
        year="1962",
...
entry(
    ...
    reference=Article(
        ...
        title="UV Absorption Studies of the Pyrolysis of Butane in Shock Waves",
        journal="Bull. Chem. Soc. Jpn.",
        volume="54",
        pages="""2439""",
        year="1981",
...
entry(
    ...
    reference=Article(
        ...
        title="The Reaction of Methoxy Radicals with Nitric Oxide and Nitrogen Dioxide",
        journal="Int. J. Chem. Kinet.",
        volume="11",
        pages="""1183""",
        year="1979",
...
entry(
    ...
    reference=Article(
        ...
        title="The Decomposition of Dimethyl Peroxide and the Rate Constant for CH3O + O2 \u2192\x92 CH2O +HO2",
        journal="Int. J. Chem. Kinet.",
        volume="9",
        pages="""31""",
        year="1977",
...
entry(
    ...
    reference=Article(
        ...
        title="Pyrolysis of Dimethyl Peroxide",
        journal="Int. J. Chem. Kinet.",
        volume="8",
        pages="""491""",
        year="1976",
...
entry(
    ...
    reference=Article(
        ...
        title="The thermal decomposition of dimethyl peroxide: the oxygen-oxygen bond strength of dialkyl peroxides",
        journal="J. Phys. Chem.",
        volume="63",
        pages="""104-106""",
        year="1959",
...
entry(
    ...
    reference=Article(
        ...
        title="Decomposition of methanol induced by methoxy radicals",
        journal="J. Chem. Phys.",
        volume="22",
        pages="""1527""",
        year="1954",
...
entry(
    ...
    reference=Article(
        ...
        title="Pyrolysis of But-1-yne and the Resonance Energy of the Propargyl and 3-Methylpropargyl Radicals",
        journal="J. Chem. Soc. Faraday Trans. 1",
        volume="78",
        pages="""2337""",
        year="1982",
...
entry(
    ...
    reference=Article(
        authors=["King, K.D."],
        title="Very Low-Pressure Pyrolysis (VLPP) of But-1-yne. The Heat of Formation and Stabilization Energy of the Propargyl Radical",
        journal="Int. J. Chem. Kinet.",
        volume="10",
        pages="""545""",
        year="1978",
...
entry(
    ...
    reference=Article(
        ...
        title="Thermal decomposition of 1-butyne in shock waves",
        journal="Int. J. Chem. Kinet.",
        volume="27",
        pages="""321-330""",
        year="1995",
...
entry(
    ...
    reference=Article(
        ...
        title="Initiation and abstraction reactions in the pyrolysis of acetone",
        journal="J. Phys. Chem.",
        volume="100",
        pages="""3573-3579""",
        year="1996",
...
entry(
    ...
    reference=Article(
        ...
        title="Arrhenius parameters of some reactions involving multiplicity changes",
...
entry(
    ...
    reference=Article(
        ...
        title="Pyrolysis of acetone and the heat of formation of acetyl radicals",
        journal="J. Chem. Phys.",
        volume="23",
        pages="""2310-2314""",
        year="1955",
...
entry(
    ...
    reference=Article(
        ...
        title="The pyrolysis of alkyl hydroperoxides in the gas phase",
        journal="Trans. Faraday Soc.",
        volume="56",
        pages="""1296-1303""",
        year="1960",
...
entry(
    ...
    reference=Article(
        ...
        title="Experimental and theoretical studies of the C2H5 + O2 reaction kinetics",
        journal="J. Phys. Chem.",
        volume="94",
        pages="""1853-1868""",
        year="1990",
...
entry(
    ...
    reference=Article(
        ...
        title="Chemical activation analysis of the reaction of C2H5 with O2",
        journal="J. Phys. Chem.",
        volume="94",
        pages="""3313-3317""",
        year="1990",
...
entry(
    ...
    reference=Article(
        ...
        title="Spectrokinetic studies of ethyl and ethylperoxy radicals",
        journal="J. Phys. Chem.",
        volume="90",
        pages="""2752""",
        year="1986",
...
entry(
    ...
    reference=Article(
        authors=["Jolley, J.E."],
        title="The photooxidation of diethyl ketone",
        journal="J. Am. Chem. Soc.",
        volume="79",
        pages="""1537""",
        year="1957",
...
entry(
    ...
    reference=Article(
        ...
        title="Detailed Kinetics and Thermochemistry of C2H5 + O2:  Reaction Kinetics of the Chemically-Activated and Stabilized CH3CH2OO. Adduct",
        journal="J. Phys. Chem. A",
        volume="106",
        pages="""7276-7293""",
        year="2002",
...
entry(
    ...
    reference=Article(
        ...
        title="Kinetics and thermochemistry of the equilibrium 2 (acetylene) = vinylacetylene. Direct evidence against a chain mechanism",
        journal="J. Phys. Chem.",
        volume="92",
        pages="""5839""",
        year="1988",
...
entry(
    ...
    reference=Article(
        ...
        title="Thermal decomposition of vinylacetylene in shock waves. Rate constant of initiation reaction",
        journal="Chem. Phys. Lett.",
        volume="130",
        pages="""195""",
        year="1986",
...
entry(
    ...
    reference=Article(
        ...
        title="Thermal decomposition of vinylacetylene in shock waves",
        journal="Int. J. Chem. Kinet.",
        volume="24",
        pages="""871-885""",
        year="1992",
...
entry(
    ...
    reference=Article(
        authors=["Brooks, C.T."],
        title="Gas-phase high-pressure decomposition of isobutane in the presence of hydrogen",
        journal="Trans. Faraday Soc.",
        volume="62",
        pages="""935-944""",
        year="1966",
...
entry(
    ...
    reference=Article(
        authors=["Bradley, J.N."],
        title="A general mechanism for the high-temperature pyrolysis of alkanes. The pyrolysis of isobutane",
        journal="Proc. R. Soc. London A",
        volume="337",
        pages="""199""",
        year="1974",
...
entry(
    ...
    reference=Article(
        ...
        title="Wall-less Reactor Studies. Part 4. - Isobutane Pyrolysis",
        journal="J. Chem. Soc. Faraday Trans. 1",
        volume="76",
        pages="""1694""",
        year="1980",
...
entry(
    ...
    reference=Article(
        ...
        title="Comparative Study of the Pyrolysis of n-Butane and Isobutane",
...
entry(
    ...
    reference=Article(
        authors=["Koike, T.", "Morinaga, K."],
        title="UV Absorption Studies of the Pyrolysis of Isobutane in Shock Waves",
        journal="Bull. Chem. Soc. Jpn.",
        volume="55",
        pages="""690""",
        year="1982",
...
entry(
    ...
    reference=Article(
        ...
        title="Thermal decomposition of isobutane in shock waves. Rate constant of initiation reaction",
        journal="Chem. Phys. Lett.",
        volume="144",
        pages="""570""",
        year="1988",
...
entry(
    ...
    reference=Article(
        authors=["Tsang, W."],
        title="Chemical kinetic data base for combustion chemistry. Part 4. Isobutane",
        journal="J. Phys. Chem. Ref. Data",
        volume="19",
        pages="""1-68""",
        year="1990",
...
entry(
    ...
    reference=Article(
        ...
        title="Rate of recombination of radicals. III. Rate of recombination of ethyl radicals",
        journal="J. Chem. Phys.",
        volume="26",
        pages="""1020-1028""",
        year="1957",
...
entry(
    ...
    reference=Article(
        ...
        title="Thermal decomposition of 1,2 butadiene",
        journal="Int. J. Chem. Kinet.",
        volume="20",
        pages="""731""",
        year="1988",
...
entry(
    ...
    reference=Article(
        ...
        title="The high temperature pyrolysis of 1,3-butadiene: Heat of formation and rate of dissociation of vinyl radical",
        journal="Int. J. Chem. Kinet.",
        volume="17",
        pages="""225-253""",
        year="1985",
...
entry(
    ...
    reference=Article(
        ...
        title="The high temperature pyrolysis of 1,3-butadiene II: Pulsed laser flash absorption rate constants, and consideration of possible molecular dissociation pathways",
        journal="Int. J. Chem. Kinet.",
        volume="20",
        pages="""787""",
        year="1988",
...
entry(
    ...
    reference=Article(
        ...
        title="Formation of H and D atoms in pyrolysis of 1,3-butadiene and 1,3 butadiene-1,1,4,4,-d4 behind shock waves",
        journal="Int. J. Chem. Kinet.",
        volume="20",
        pages="""153""",
        year="1988",
...
entry(
    ...
    reference=Article(
        ...
        title="Radical steps in diethyl ether decomposition",
        journal="Int. J. Chem. Kinet.",
        volume="18",
        pages="""829""",
        year="1986",
...
entry(
    ...
    reference=Article(
        ...
        title="No. 18. - Etude analytique et cinetique de la pyrolyse de l'ether ethylique vers 500 \xb0C et a faible avancement",
        journal="J. Chim. Phys.",
        volume="75",
        pages="""132""",
        year="1978",
...
entry(
    ...
    reference=Article(
        ...
        title="A Dietil-Eter Termikus Bomlasa, IV. Az Acetaldehid Hatasa a Bomlasra, [The Thermal Decomposition of Diethyl Ether, IV. The Effect of Acetaldehyde]",
...
entry(
    ...
    reference=Article(
        authors=["Seres, I.", "Huhn, P."],
        title="A dietil-eter termikus bomlasa, III.",
        journal="Magy. Kem. Foly.",
        volume="81",
        pages="""120-123""",
        year="1975",
...
entry(
    ...
    reference=Article(
        ...
        title="Kinetics and mechanisms of the pyrolysis of diethyl ether. I. The uninhibited reaction",
        journal="Proc. R. Soc. London",
        volume="278",
        pages="""505-516""",
        year="1964",
...
entry(
    ...
    reference=Article(
        authors=[
            "Sahetchian, K.A.",
            "Rigny, R.",
            "Tardieu de Maleissye, J.",
            "Batt, L.",
            "Anwar Khan, M.",
            "Mathews, S.",
        ],
        title="The pyrolysis of organic hydroperoxides (ROOH)",
        journal="Symp. Int. Combust. Proc.",
        volume="24",
        pages="""637-643""",
        year="1992",
...
entry(
    ...
    reference=Article(
        ...
        title="Kinetics of primary processes in the pyrolysis of cyclopentanes and cyclohexanes",
        journal="J. Phys. Chem.",
        volume="90",
        pages="""419""",
        year="1986",
...
entry(
    ...
    reference=Article(
        authors=["Tsang, W."],
        title="Thermal Decomposition of Cyclopentane and Related Compounds",
        journal="Int. J. Chem. Kinet.",
        volume="10",
        pages="""599""",
        year="1978",
...
entry(
    ...
    reference=Article(
        ...
        title="Infrared photodecomposition of ethyl vinyl ether. A chemical probe of multiphoton dynamics",
        journal="J. Am. Chem. Soc.",
        volume="99",
        pages="""8063-8064""",
        year="1977",
...
entry(
    ...
    reference=Article(
        ...
        title="Kinetics of the thermal decomposition of vinyl ethyl ether",
        journal="J. Am. Chem. Soc.",
        volume="74",
        pages="""1039-1041""",
        year="1952",
...
entry(
    ...
    reference=Article(
        ...
        title="Kinetics of Decomposition and Interconversion of 3-Methylbut-1-yne and 3-Methylbuta-1,2-diene. Resonance Stabilization Energies of Propargylic Radicals",
        journal="J. Phys. Chem.",
        volume="85",
        pages="""3130""",
        year="1981",
...
entry(
    ...
    reference=Article(
        authors=["Trenwith, A.B."],
        title="Dissociation of 3-Hydroxybut-1-ene and the Resonance Energy of the Hydroxyallyl Radical",
        journal="J. Chem. Soc. Faraday Trans. 1",
        volume="69",
        pages="""1737""",
        year="1973",
...
entry(
    ...
    reference=Article(
        authors=["Nguyen, T.T.", "King, K.D."],
        title="Very Low-Pressure Pyrolysis (VLPP ) of Pentynes. III. Pent-2-yne. Heat of Formation and Resonance Stabilization Energy of the 3-Methylpropargyl Radical",
        journal="Int. J. Chem. Kinet.",
        volume="14",
        pages="""613""",
        year="1982",
...
entry(
    ...
    reference=Article(
        ...
        title="Further experiments on pyrolysis of 2,2-dimethylpropane behind shock waves",
        journal="Int. J. Chem. Kinet.",
        volume="20",
        pages="""165""",
        year="1988",
...
entry(
    ...
    reference=Article(
        ...
        title="Formation of hydrogen atoms in pyrolysis of 2,2-dimethylpropane behind shock waves",
        journal="J. Phys. Chem.",
        volume="87",
        pages="""3732""",
        year="1983",
...
entry(
    ...
    reference=Article(
        ...
        title="Very-Low-Pressure Pyrolysis (VLPP) of Group IV(A) Tetramethyls: Neopentane and Tetramethyltin",
        journal="Int. J. Chem. Kinet.",
        volume="11",
        pages="""529""",
        year="1979",
...
entry(
    ...
    reference=Article(
        ...
        title="Non Quasi-Stationary State Pyrolysis. Kinetic Parameters of Neopentane Pyrolysis Mechanism",
        journal="React. Kinet. Catal. Lett.",
        volume="9",
        pages="""171""",
        year="1978",
...
entry(
    ...
    reference=Article(
        ...
        title="Chain Initiation of Neopentane Pyrolysis and a Suggested Reconciliation of the Thermochemically Calculated and Measured Rate Constants for the Recombination of t-Butyl Radicals",
        journal="J. Chem. Soc. Faraday Trans. 1",
        volume="72",
        pages="""85""",
        year="1976",
...
entry(
    ...
    reference=Article(
        ...
        title="Single-pulse Shock Tube Studies of Hydrocarbon Pyrolysis. Part 5. Pyrolysis of Neopentane",
        journal="J. Chem. Soc. Faraday Trans. 1",
        volume="72",
        pages="""8""",
        year="1976",
...
entry(
    ...
    reference=Article(
        authors=["Pacey, P.D."],
        title="The Reaction of Methyl Radicals with Neopentane",
        journal="Can. J. Chem.",
        volume="51",
        pages="""2415""",
        year="1973",
...
entry(
    ...
    reference=Article(
        ...
        title="The Pyrolysis of Neopentane at Small Extents of Reaction",
        journal="Int. J. Chem. Kinet.",
        volume="3",
        pages="""197""",
        year="1971",
...
entry(
    ...
    reference=Article(
        ...
        title="Homogeneous gas-phase pyrolyses using a wall-less reactor. I. Neopentane",
        journal="J. Am. Chem. Soc.",
        volume="91",
        pages="""2215-2219""",
        year="1969",
...
entry(
    ...
    reference=Article(
        ...
        title="The self-inhibited pyrolysis of neopentane at small extents of reaction",
        journal="Proc. R. Soc. London A",
        volume="310",
        pages="""525""",
        year="1969",
...
entry(
    ...
    reference=Article(
        authors=["Tsang, W."],
        title="Thermal decomposition of hexamethylethane, 2,2,3-trimethylbutane, and neopentane in a single-pulse shock tube",
        journal="J. Chem. Phys.",
        volume="44",
        pages="""4283-4295""",
        year="1966",
...
entry(
    ...
    reference=Article(
        ...
        title="Modelling of the homogeneously catalyzed and uncatalyzed pyrolysis of neopentane: thermochemistry of the neopentyl radical",
        journal="Int. J. Chem. Kinet.",
        volume="25",
        pages="""931-955""",
        year="1993",
...
entry(
    ...
    reference=Article(
        authors=["Pratt, G.L.", "Rogers, D."],
        title="Wall-less Studies. Part 5. - Neopentane Pyrolysis",
        journal="J. Chem. Soc. Faraday Trans. 1",
        volume="77",
        pages="""2751""",
        year="1981",
...
entry(
    ...
    reference=Article(
        ...
        title="Kinetics of the Cyclopentadiene Decay and the Recombination of Cyclopentadienyl Radicals with H-Atoms: Enthalpy of Formation of the Cyclopentadienyl Radical",
        journal="Int. J. Chem. Kinet.",
        volume="33",
        pages="""821-833""",
        year="2001",
...
entry(
    ...
    reference=Article(
        ...
        title="Detailed kinetics of cyclopentadiene decomposition studied in a shock tube",
        journal="Int. J. Chem. Kinet.",
        volume="29",
        pages="""505-514""",
        year="1997",
...
entry(
    ...
    reference=Article(
        ...
        title="Quantum chemical/vRRKM study on the thermal decomposition of cyclopentadiene",
        journal="Inter. J. Chem. Kinet.",
        volume="36",
        pages="""139-151""",
        year="2004",
...
entry(
    ...
    reference=Article(
        authors=["Trenwith, A.B.", "Wrigley, S.P."],
        title="Dissociation of 2-Methylbut-1-ene and the Resonance Energy of the 2-Methyl allyl Radical",
        journal="J. Chem. Soc. Faraday Trans. 1",
        volume="73",
        pages="""817""",
        year="1977",
...
entry(
    ...
    reference=Article(
        ...
        title="Arrhenius Parameters for the Photocleavage of Butan-2-one Triplets",
        journal="J. Photochem.",
        volume="5",
        pages="""65""",
        year="1975",
...
entry(
    ...
    reference=Article(
        ...
        title="Direct determination of the equilibrium constant and thermodynamic parameters for the reaction C3H5 + O2 = C3H5O2",
        journal="J. Chem. Soc. Faraday Trans. 2",
        volume="78",
        pages="""1323""",
        year="1982",
...
entry(
    ...
    reference=Article(
        ...
        title="Kinetic studies of the oxidation of dimethyl ether and its chain reaction with Cl2",
        journal="J. Phys. Chem. A",
        volume="101",
        pages="""5155-5167""",
        year="1997",
...
entry(
    ...
    reference=Article(
        ...
        title="Atoms Regeneration from Hydroperoxyl Radicals in the Reaction between Fluorine and Hydrogen Inhibited with Oxygen",
        journal="Inter. J. Chem. Kinet.",
        volume="37",
        pages="""98-109""",
        year="2005",
...
entry(
    ...
    reference=Article(
        ...
        title="Gas-phase thermolysis of tert-butyl hydroperoxide in a nitrogen atmosphere. The effect of added toluene",
...
entry(
    ...
    reference=Article(
        ...
        title="Very low pressure pyrolysis. III. t-Butyl hydroperoxide in fused silica and stainless steel reactors",
        journal="J. Phys. Chem.",
        volume="72",
        pages="""1182-1186""",
        year="1968",
...
entry(
    ...
    reference=Article(
        ...
        title="Decomposition of 2,3-dimethylbutane in the presence of oxygen. Part 1.-Thermochemistry of the reaction (CH3)2CHCH(CH3)2 \u2192\x92 2i-C3H7",
        journal="J. Chem. Soc. Faraday Trans. 1",
        volume="80",
        pages="""2827""",
        year="1984",
...
entry(
    ...
    reference=Article(
        authors=["Tsang, W."],
        title="Thermal decomposition of 2,3-dimethylbutane in a single-pulse shock tube",
        journal="J. Chem. Phys.",
        volume="43",
        pages="""352-359""",
        year="1965",
...
entry(
    ...
    reference=Article(
        ...
        title="Very low-pressure pyrolysis (VLPP) of methyl- and ethynyl- cyclopentanes and cyclohexanes",
        journal="Int. J. Chem. Kinet.",
        volume="21",
        pages="""251-266""",
        year="1989",
...
entry(
    ...
    reference=Article(
        ...
        title="The UV spectrum of acetyl and the kinetics of the chain reaction between acetaldehyde and chlorine",
        journal="Chem. Phys. Lett.",
        volume="253",
        pages="""333-339""",
        year="1996",
...
entry(
    ...
    reference=Article(
        ...
        title="Thermal decomposition of dialkyl peroxides and heats of formation of the ethoxyl and isopropoxyl radicals",
        journal="Trans. Faraday Soc.",
        volume="63",
        pages="""2504-2509""",
        year="1967",
...
entry(
    ...
    reference=Article(
        ...
        title="Kinetics of the decomposition of diethyl peroxide",
        journal="J. Chem. Phys.",
        volume="20",
        pages="""574-577""",
        year="1952",
...
entry(
    ...
    reference=Article(
        ...
        title="The decomposition and ignition of peroxides. I. Diethylperoxide",
        journal="Proc. R. Soc. London A",
        volume="168",
        pages="""1-18""",
        year="1938",
...
entry(
    ...
    reference=Article(
        authors=["King, K.D."],
        title="Kinetics of Competitive Pathways in the Thermal Unimolecular Decomposition of Hex-1-yne",
        journal="Int. J. Chem. Kinet.",
        volume="13",
        pages="""273""",
        year="1981",
...
entry(
    ...
    reference=Article(
        authors=["Tsang, W."],
        title="Thermal Stability of Intermediate Sized Acetylenic Compounds and the Heats of Formation of Propargyl Radicals",
        journal="Int. J. Chem. Kinet.",
        volume="10",
        pages="""687""",
        year="1978",
...
entry(
    ...
    reference=Article(
        authors=["King, K.D."],
        title="Very Low-Pressure Pyrolysis (VLPP) of 3,3-Dimethylbut-1-yne (tert-Butyl Acetylene). The Heat of Formation and Stabilization Energy of the Dimethylpropargyl Radical",
        journal="Int. J. Chem. Kinet.",
        volume="9",
        pages="""907""",
        year="1977",
...
entry(
    ...
    reference=Article(
        authors=[
            "Dilger, H.",
            "Stolmar, M.",
            "Tregenna-Piggott, P.L.W.",
            "Roduner, E.",
        ],
        title="Gas phase addition kinetics of the tert-butyl radical to oxygen",
        journal="Ber. Bunsenges. Phys. Chem.",
        volume="101",
        pages="""956-960""",
        year="1997",
...
entry(
    ...
    reference=Article(
        ...
        title="Analysis of Tertiary Butyl Radical + O2, Isobutene + HO2, Isobutene + OH, and Isobutene-OH Adducts + O2: A Detailed Tertiary Butyl Oxidation Mechanism",
        journal="J. Phys. Chem. A",
        volume="103",
        pages="""9731-9769""",
        year="1999",
...
entry(
    ...
    reference=Article(
        ...
        title="Flash Photolysis Studies of Free-Radical Reactions: C3H5 + C3H5 (293-691 K) and C3H5 + NO (295-400 K)",
        journal="J. Phys. Chem.",
        volume="86",
        pages="""3812-3819""",
        year="1982",
...
entry(
    ...
    reference=Article(
        ...
        title='Equilibrium constant for allyl radical recombination. Direct measurement of "allyl resonance energy"',
        journal="J. Am. Chem. Soc.",
        pages="""2136""",
        year="1969",
...
entry(
    ...
    reference=Article(
        ...
        title="Rates of reaction of allyl radicals: A reassessment",
        journal="Int. J. Chem. Kinet.",
        volume="4",
        pages="""273""",
        year="1972",
...
entry(
    ...
    reference=Article(
        ...
        title="Die bildungsenthalpie des allyl- und methallyl-radikals",
        journal="Chem. Ber.",
        volume="124",
        pages="""1453-1460""",
        year="1991",
...
entry(
    ...
    reference=Article(
        ...
        title="A Kinetic Study on the Formation of Aromatics During Pyrolysis of Petroleum Hydrocarbons",
...
entry(
    ...
    reference=Article(
        ...
        title="Kinetics of the Cope Rearrangement of 1,1-Dideuteriohexa-1,5-Diene",
        journal="Tetrahedron",
        volume="27",
        pages="""5299""",
        year="1971",
...
entry(
    ...
    reference=Article(
        ...
        title="Kinetic studies on allyl radicals. Part 1.-Toluene-carrier pyrolysis of 4-phenyl-but-l-ene and hexa-1, 5-diene and the heat of formation of the allyl radical",
        journal="Trans. Faraday Soc.",
        volume="63",
        pages="""124""",
        year="1967",
...
entry(
    ...
    reference=Article(
        ...
        title="Free radicals by mass spectrometry. XXXV. The heat of formation of allyl radical from biallyl pyrolysis",
        journal="Can. J. Chem.",
        volume="44",
        pages="""2211-2217""",
        year="1966",
...
entry(
    ...
    reference=Article(
        ...
        title="The pyrolysis of diallyl (1,5-hexadiene)",
        journal="Can. J. Chem.",
        volume="38",
        pages="""827-834""",
        year="1960",
...
entry(
    ...
    reference=Article(
        authors=["Taniewski, M."],
        title="Kinetics and mechanism of the thermal decomposition of 4-methylpent-1-ene",
        journal="J. Chem. Soc.",
        pages="""7436""",
        year="1965",
...
entry(
    ...
    reference=Article(
        authors=["King, K.D."],
        title="Very Low-Pressure Pyrolysis (VLPP) of Hex-1-ene. Kinetics of the Retro-ene Decomposition of a Mono-Olefin",
        journal="Int. J. Chem. Kinet.",
        volume="11",
        pages="""1071""",
        year="1979",
...
entry(
    ...
    reference=Article(
        authors=["Tsang, W."],
        title="Thermal Stability of Cyclohexane and 1-Hexene",
        journal="Int. J. Chem. Kinet.",
        volume="10",
        pages="""1119""",
        year="1978",
...
entry(
    ...
    reference=Article(
        ...
        title="Experimental and modeling study of 1-hexene oxidation behind reflected shock waves",
        journal="Proc. Combust. Inst.",
        volume="30",
        pages="""1137-1145""",
        year="2005",
...
entry(
    ...
    reference=Article(
        ...
        title="Mutual Reaction of Isopropyl Radicals",
        journal="J. Chem. Soc. Faraday Trans. 1",
        volume="74",
        pages="""3016""",
        year="1978",
...
entry(
    ...
    reference=Article(
        ...
        title="Collaborative shock tube studies of benzene pyrolysis",
        journal="Symp. Int. Combust. Proc.",
        volume="20",
        pages="""89""",
        year="1985",
...
entry(
    ...
    reference=Article(
        ...
        title="CO formation in early stage high temperature benzene oxidation under fuel lean conditions: Kinetics of the initiation reaction, C6H6 \u2192\x92 C6H5 \u2192\x92 H",
        journal="Symp. Int. Combust. Proc.",
        volume="20",
        pages="""623""",
        year="1985",
...
entry(
    ...
    reference=Article(
        ...
        title="A shock-tube study of the high-pressure thermal decomposition of benzene",
...
entry(
    ...
    reference=Article(
        authors=["Rao, V.S.", "Skinner, G.B."],
        title="Formation of H and D atoms in pyrolysis of benzene-d6, chlorobenzene, bromobenzene, and iodobenzene behind shock waves",
        journal="J. Phys. Chem.",
        volume="92",
        pages="""2442""",
        year="1988",
...
entry(
    ...
    reference=Article(
        ...
        title="High temperature oxidation of benzene",
        journal="Proc. Int. Symp. Shock Tubes Waves",
        volume="8",
        pages="""1-12""",
        year="1971",
...
entry(
    ...
    reference=Article(
        authors=["Tsang, W."],
        title="Rate and mechanism of thermal decomposition of 4-methyl-1-pentyne in a single-pulse shock tube",
        journal="Int. J. Chem. Kinet.",
        volume="2",
        pages="""23""",
        year="1970",
...
entry(
    ...
    reference=Article(
        ...
        title="Kinetics of the thermal unimolecular decomposition of hex-1-ene-3-yne. Heat of formation and resonance stabilization energy of the 3-ethenylpropargyl radical",
        journal="Int. J. Chem. Kinet.",
        volume="24",
        pages="""781-790""",
        year="1992",
...
entry(
    ...
    reference=Article(
        ...
        title="Thermochemistry of the methoxymethyl radical",
        journal="Can. J. Chem.",
        volume="45",
        pages="""2785-2793""",
        year="1967",
...
entry(
    ...
    reference=Article(
        ...
        title="Very Low-Pressure Pyrolysis (VLPP) of Pentynes. II. 4-Methylpent-2-yne and 4,4-Dimethyl-pent-2-yne. Heats of Formation and Resonance Stabilization Energies of Methyl-Substituted Propargyl Radicals",
        journal="Int. J. Chem. Kinet.",
        volume="13",
        pages="""255""",
        year="1981",
...
entry(
    ...
    reference=Article(
        ...
        title="The pyrolysis of biacetyl and the third-body effect on the combination of methyl radicals",
        journal="J. Phys. Chem.",
        volume="73",
        pages="""177""",
        year="1969",
...
entry(
    ...
    reference=Article(
        ...
        title="The Thermal Decomposition of Biacetyl",
        journal="Int. J. Chem. Kinet.",
        volume="5",
        pages="""271""",
        year="1973",
...
entry(
    ...
    reference=Article(
        ...
        title="Der Thermische Zerfall von Diacetyl. II. Mitteilung: Untersuchungen bei hohen Temperaturen",
...
entry(
    ...
    reference=Article(
        authors=["Trenwith, A.B."],
        title="Dissociation of 1,3-Hexadiene and the Resonance Energy of the Pentadienyl Radical",
        journal="J. Chem. Soc. Faraday Trans. 1",
        volume="76",
        pages="""266""",
        year="1980",
...
entry(
    ...
    reference=Article(
        authors=["Trenwith, A.B."],
        title="Dissociation of 3-Methylpenta-1,4-diene and the Resonance Energy of the Pentadienyl Radical",
        journal="J. Chem. Soc. Faraday Trans. 1",
        volume="78",
        pages="""3131""",
        year="1982",
...
entry(
    ...
    reference=Article(
        ...
        title="Forming benzene in flames by chemically activated isomerization",
        journal="J. Phys. Chem.",
        volume="93",
        pages="""8171-8180""",
        year="1989",
...
entry(
    ...
    reference=Article(
        ...
        title="Homogeneous pyrolysis of acetylacetone at high temperatures in shock waves",
        journal="Int. J. Chem. Kinet.",
        volume="20",
        pages="""491-504""",
        year="1990",
...
entry(
    ...
    reference=Article(
        ...
        title="Single-pulse shock tube studies of the decomposition of ethoxy compounds",
        journal="J. Phys. Chem. A",
        volume="101",
        pages="""5494-5499""",
        year="1997",
...
entry(
    ...
    reference=Article(
        authors=["Tsang, W."],
        title="Comparative rate single-pulse shock tube studies on the thermal decomposition of cyclohexene, 2,2,3-trimethylbutane, isopropyl bromide, and ethylcyclobutane",
        journal="Int. J. Chem. Kinet.",
        volume="2",
        pages="""311""",
        year="1970",
...
entry(
    ...
    reference=Article(
        authors=["Tsang, W."],
        title="Thermal decomposition of 3,4-dimethylpentene-1,2,3,3-trimethylpentane, 3,3-dimethylpentane, and isobutylbenzene in a single pulse shock tube",
        journal="Int. J. Chem. Kinet.",
        volume="1",
        pages="""245""",
        year="1969",
...
entry(
    ...
    reference=Article(
        authors=["Tsang, W."],
        title="Single pulse shock tube study on the thermal stability of ketones",
        journal="Int. J. Chem. Kinet.",
        volume="16",
        pages="""1543""",
        year="1984",
...
entry(
    ...
    reference=Article(
        ...
        title="Thermische und durch Methylradikale initiierte Spaltung von Pentandion-(2,3) bei geringen Umsaetzen",
...
entry(
    ...
    reference=Article(
        authors=["Tsang, W."],
        title="Thermal Decomposition of 1,1,2,2-Tetramethylcyclopropane in a Single-Pulse Shock Tube",
        journal="Int. J. Chem. Kinet.",
        volume="5",
        pages="""651""",
        year="1973",
...
entry(
    ...
    reference=Article(
        ...
        title="Kinetics and Thermochemistry for the Gas-Phase Keto-Enol Tautomerism of Phenol &lt;-&gt; 2,4-Cyclohexadienone",
        journal="J. Phys. Chem. A",
        volume="107",
        pages="""3696-3703""",
        year="2003",
...
entry(
    ...
    reference=Article(
        ...
        title="The gas phase pyrolysis of phenol",
        journal="Int. J. Chem. Kinet.",
        volume="21",
        pages="""547-560""",
        year="1989",
...
entry(
    ...
    reference=Article(
        ...
        title="Experimental and theoretical studies of the reaction of the phenyl radical with methane",
        journal="J. Phys. Chem. A",
        volume="103",
        pages="""3636-3645""",
        year="1999",
...
entry(
    ...
    reference=Article(
        ...
        title="Thermal reactions of 2,3-dihydrobenzofuran: Experimental results and computer modeling",
        journal="Proc. Combust. Inst.",
        volume="28",
        pages="""1733-1739""",
        year="2000",
...
entry(
    ...
    reference=Article(
        ...
        title="High-temperature pyrolysis of toluene",
        journal="J. Phys. Chem.",
        volume="91",
        pages="""2148""",
        year="1987",
...
entry(
    ...
    reference=Article(
        ...
        title="Conversion of C5 into C6 cyclic species through the formation of C7 intermediates",
        journal="J. Phys. Chem. A",
        volume="111",
        pages="""3959-3969""",
        year="2007",
...
entry(
    ...
    reference=Article(
        ...
        title="High pressure pyrolysis of toluene. 1. Experiments and modeling of toluene decomposition",
        journal="J. Phys. Chem. A",
        volume="110",
        pages="""9388-9399""",
        year="2006",
...
entry(
    ...
    reference=Article(
        ...
        title="Thermochemical and kinetic analysis on the reactions of neopentyl and hydroperoxy-neopentyl radicals with oxygen: Part I.  OH and initial stable HC product formation",
        journal="J. Phys. Chem. A",
        volume="108",
        pages="""1694-1711""",
        year="2004",
...
entry(
    ...
    reference=Article(
        authors=["Back, M.H."],
        title="Comment on the thermal decomposition of anisole and the heat of formation of the phenoxy radical",
        journal="J. Phys. Chem.",
        volume="93",
        pages="""6880-6881""",
        year="1989",
...
entry(
    ...
    reference=Article(
        ...
        title="Kinetic study of the thermolysis of anisole in a hydrogen atmosphere",
        journal="J. Phys. Chem.",
        volume="97",
        pages="""7914-7925""",
        year="1993",
...
entry(
    ...
    reference=Article(
        ...
        title="The thermal decomposition of hydroxy- and methoxy-substituted anisoles",
        journal="J. Am. Chem. Soc.",
        volume="111",
        pages="""1423-1429""",
        year="1989",
...
entry(
    ...
    reference=Article(
        ...
        title="Kinetics of the thermal decomposition of methoxybenzene (anisole)",
        journal="J. Phys. Chem.",
        volume="93",
        pages="""664-670""",
        year="1989",
...
entry(
    ...
    reference=Article(
        ...
        title="Gas phase pyrolysis of coal-related aromatic compounds in a coiled tube flow reactor. 1. Benzene and derivatives",
        journal="Fuel",
        volume="67",
        pages="""327-333""",
        year="1988",
...
entry(
    ...
    reference=Article(
        ...
        title="Thermal decomposition of methyl phenyl ether in shock waves: The kinetics of phenoxy radical reactions",
        journal="J. Phys. Chem.",
        volume="90",
        pages="""425""",
        year="1986",
...
entry(
    ...
    reference=Article(
        ...
        title="A kinetic determination of the dissociation energy of the C-O bond in anisole",
        journal="Can. J. Chem.",
        volume="53",
        pages="""3330""",
        year="1975",
...
entry(
    ...
    reference=Article(
        ...
        title="Kinetics of pyrolysis of octane in argon-hydrogen mixtures",
        journal="Combust. Flame",
        volume="50",
        pages="""29""",
        year="1983",
...
entry(
    ...
    reference=Article(
        authors=["Tsang, W."],
        title="Thermal Decomposition of 3,4-Dimethylhexane, 2,2,3-Trimethylpentane, tert-Butylcyclohexane, and Related Hydrocarbons",
        journal="J. Phys. Chem.",
        volume="76",
        pages="""143""",
        year="1972",
...
entry(
    ...
    reference=Article(
        ...
        title="The Decomposition of 2,2,3,3-Tetramethylbutane in KCl- and B2O3-coateed Vessels in the Presence of Oxygen",
        journal="J. Chem. Soc. Faraday Trans. 1",
        volume="78",
        pages="""1165""",
        year="1982",
...
entry(
    ...
    reference=Article(
        ...
        title="Thermal Decomposition of Hexamethylethane in a Flow System",
        journal="Int. J. Chem. Kinet.",
        volume="11",
        pages="""867""",
        year="1979",
...
entry(
    ...
    reference=Article(
        ...
        title="Gas-Phase Pyrolysis of 2,2,3,3-Tetramethylbutane using a Wall-less Reactor",
        journal="Int. J. Chem. Kinet.",
        volume="10",
        pages="""1245""",
        year="1978",
...
entry(
    ...
    reference=Article(
        ...
        title="Variational analysis of the phenyl + O2 and phenoxy plus O reactions",
        journal="J. Phys. Chem. A",
        volume="112",
        pages="""3566-3575""",
        year="2008",
...
entry(
    ...
    reference=Article(
        ...
        title="Kinetics and mechanism of the thermal decomposition of unsaturated aldehydes: Benzaldehyde, 2-butenal, and 2-furaldehyde",
        journal="J. Phys. Chem.",
        volume="90",
        pages="""434""",
        year="1986",
...
entry(
    ...
    reference=Article(
        ...
        title="Pyrolysis of 1,7-octadiene and the kinetic and thermodynamic stability of allyl and 4-pentenyl radicals",
        journal="J. Phys. Chem.",
        volume="96",
        pages="""8378-8384""",
        year="1992",
...
entry(
    ...
    reference=Article(
        ...
        title="Kinetics of disproportionation-combination reactions between the n-propoxyl radical and nitric oxide, and of the pyrolysis of the O-O bond in di-n-propyl peroxide in the gas phase",
...
entry(
    ...
    reference=Article(
        authors=["Harris, E.J."],
        title="The decomposition of alkyl peroxides: dipropyl peroxide, ethyl hydrogen peroxide and propyl hydrogen peroxide",
        journal="Proc. R. Soc. London A",
        volume="173",
        pages="""126-146""",
        year="1939",
...
entry(
    ...
    reference=Article(
        ...
        title="Reactions of isopropoxyl radicals",
        journal="J. Chem. Soc. Faraday Trans.",
        volume="64",
        pages="""1296""",
        year="1968",
...
entry(
    ...
    reference=Article(
        ...
        title="The kinetics of disproportionation-combination reactions between the isopropoxyl radical and nitric oxide, and of the pyrolysis of the O-O bond in di-isopropyl peroxide",
        journal="J. Chem. Soc. A",
        pages="""894-897""",
        year="1967",
...
entry(
    ...
    reference=Article(
        authors=["Tsang, W."],
        title="Pyrolysis of 2,4-Dimethylhexene-1 and the Stability of Isobutenyl Radicals",
        journal="Int. J. Chem. Kinet.",
        volume="5",
        pages="""929""",
        year="1973",
...
entry(
    ...
    reference=Article(
        ...
        title="Kinetics of the C6H5 + O2 reaction at low temperatures",
        journal="J. Am. Chem. Soc.",
        volume="116",
        pages="""9571-9576""",
        year="1994",
...
entry(
    ...
    reference=Article(
        ...
        title="The very low-pressure pyrolysis of phenyl ethyl ether, phenyl allyl ether, and benzyl methyl ether and the enthalpy of formation of the phenoxy radical",
        journal="Int. J. Chem. Kinet.",
        volume="9",
        pages="""161""",
        year="1977",
...
entry(
    ...
    reference=Article(
        ...
        title="Kinetics of dibutylether pyrolysis at high pressure: Experimental study",
...
entry(
    ...
    reference=Article(
        ...
        title="Atmospheric photochemical oxidation of benzene: benzene + OH and the benzene-OH adduct (hydroxyl-2,4-cyclohexadienyl) + O2",
        journal="J. Phys. Chem.",
        volume="100",
        pages="""6543-6554""",
        year="1996",
...
entry(
    ...
    reference=Article(
        ...
        title="C-C and C-H bond splits of laser-excited aromatic molecules. 1. Specific and thermally averaged rate constants",
        journal="J. Phys. Chem.",
        volume="94",
        pages="""6305-6316""",
        year="1990",
...
entry(
    ...
    reference=Article(
        ...
        title="Very-low-pressure pyrolysis of ethylbenzene, isopropylbenzene, and tert-butylbenzene",
        journal="Int. J. Chem. Kinet.",
        volume="13",
        pages="""445""",
        year="1981",
...
entry(
    ...
    reference=Article(
        ...
        title="An investigation of the pyrolyses of cumene, t-butyl-benzene and p-cymene, and the relevant bond dissociation energies",
        journal="J. Chem. Phys.",
        volume="20",
        pages="""844-847""",
        year="1952",
...
entry(
    ...
    reference=Article(
        ...
        title="Pyrolysis of ethyl-, n-propyl-, and n-butyl-benzene and the heats of formation of the benzyl and n-propyl radicals",
        journal="J. Chem. Soc.",
        pages="""3873""",
        year="1963",
...
entry(
    ...
    reference=Article(
        ...
        title="Determinacion Directa de  Parametros de Activacion de Reacciones Unimoleculares por Cromatografia Gaseosa",
...
entry(
    ...
    reference=Article(
        ...
        title="Thermal reaction of (CH3)2C=C(CH3)2 in the presence of di-tert-butyl peroxide; reactions of the radicals .CH3, (CH3)3C.C(CH3)2 and (CH3)2 C=C(CH3).CH2",
        journal="J. Chim. Phys.",
        volume="93",
        pages="""253-273""",
        year="1996",
...
entry(
    ...
    reference=Article(
        ...
        title="Thermal decomposition of di-t-butyl peroxide in the presence of (CH3)2C=CH2: reactions of CH3, (CH3)2CCH2CH3, and (CH3)2CCH2C(CH3)2CH2CH3 radicals",
        journal="Int. J. Chem. Kinet.",
        volume="26",
        pages="""227-246""",
        year="1994",
...
entry(
    ...
    reference=Article(
        authors=["Sway, M.I."],
        title="Kinetics of abstraction reactions of tert-butoxyl radicals with cyclohexane and methyl-substituted cyclohexanes in the gas phase",
        journal="J. Chem. Soc. Faraday Trans.",
        volume="87",
        pages="""2157-2159""",
        year="1991",
...
entry(
    ...
    reference=Article(
        ...
        title="Decomposition of the t-Butoxy radical. I. Studies over the temperature range 402-443 K",
        journal="Int. J. Chem. Kinet.",
        volume="19",
        pages="""391""",
        year="1987",
...
entry(
    ...
    reference=Article(
        authors=["Batt, L.", "Robinson, G.N."],
        title="Decomposition of the t-butoxy radical",
...
entry(
    ...
    reference=Article(
        ...
        title="Reactions of Oxygenated Radicals in the Gas Phase. Part 8. Reactions of Alkoxyl Radicals with Aldehydes and Ketones",
...
entry(
    ...
    reference=Article(
        ...
        title="Pyrolysis of trifluoroacetaldehyde, initiated by di-tertiary-butyl peroxide decomposition",
        journal="Can. J. Chem.",
        volume="57",
        pages="""2201""",
        year="1979",
...
entry(
    ...
    reference=Article(
        authors=["Lewis, D.K."],
        title="Di-tert-butyl peroxide decomposition behind shock waves",
        journal="Can. J. Chem.",
        volume="54",
        pages="""581-585""",
        year="1976",
...
entry(
    ...
    reference=Article(
        ...
        title="Very Low-Pressure Pyrolysis. VIII. The Decomposition of Di-t-Amyl Peroxide",
        journal="Int. J. Chem. Kinet.",
        volume="5",
        pages="""55""",
        year="1973",
...
entry(
    ...
    reference=Article(
        ...
        title="Kinetics and Pressure-Dependence of the t-Butoxyl Radical Decomposition",
        journal="J. Chem. Soc. A",
        pages="""2296""",
        year="1971",
...
entry(
    ...
    reference=Article(
        ...
        title="A microchemical study of gas-phase kinetics for three irreversible reactions",
        journal="J. Phys. Chem.",
        volume="74",
        pages="""2455""",
        year="1970",
...
entry(
    ...
    reference=Article(
        ...
        title="Thermal decomposition of di-tert-buyl peroxide at high pressure",
        journal="Can. J. Chem.",
        volume="46",
        pages="""2721""",
        year="1968",
...
entry(
    ...
    reference=Article(
        ...
        title="Reactions of methoxyl, ethoxyl, and t-butoxyl with nitric oxide and with nitrogen dioxide",
        journal="J. Chem. Soc.",
        pages="""6965""",
        year="1965",
...
entry(
    ...
    reference=Article(
        ...
        title="Pyrolysis of di-tertiary butyl peroxide: temperature gradients and chain contribution to the rate",
        journal="J. Chem. Phys.",
        volume="36",
        pages="""895""",
        year="1962",
...
entry(
    ...
    reference=Article(
        ...
        title="A stirred-flow reactor for investigating the kinetics of gaseous reactions: application to the decomposition of di-t-butyl peroxide",
        journal="Aust. J. Chem.",
        volume="14",
        pages="""534-544""",
        year="1961",
...
entry(
    ...
    reference=Article(
        ...
        title="The reaction of methyl radicals with formaldehyde",
        journal="Can. J. Chem.",
        volume="37",
        pages="""1462""",
        year="1959",
...
entry(
    ...
    reference=Article(
        ...
        title="The thermal dissociation of tertiary butyl peroxide in presence of nitric oxide",
        journal="Proc. R. Soc. London A",
        volume="239",
        pages="""154-164""",
        year="1957",
...
entry(
    ...
    reference=Article(
        ...
        title="The reactions of methyl radicals with acetone, diethyl ketone, and di-tert.-butyl peroxide",
        journal="J. Chem. Soc.",
        pages="""1425""",
        year="1954",
...
entry(
    ...
    reference=Article(
        ...
        title="Free radicals by mass spectrometry. I. The measurement of methyl radical concentrations",
        journal="J. Chem. Phys.",
        volume="20",
        pages="""907-914""",
        year="1952",
...
entry(
    ...
    reference=Article(
        ...
        title="The reactions of methyl radicals with acetone",
        journal="J. Am. Chem. Soc.",
        volume="74",
        pages="""6005""",
        year="1952",
...
entry(
    ...
    reference=Article(
        ...
        title="Decomposition of di-t-butyl peroxide and kinetics of the gas phase reaction of t-butoxy radicals in the presence of ethylenimine",
        journal="J. Chem. Phys.",
        volume="20",
        pages="""25""",
        year="1952",
...
entry(
    ...
    reference=Article(
        ...
        title="Kinetics of the thermal decomposition of di-t-butyl peroxide",
        journal="J. Chem. Phys.",
        volume="19",
        pages="""698""",
        year="1951",
...
entry(
    ...
    reference=Article(
        ...
        title="Decompositions of Di-t-alkyl peroxides. I. Kinetics",
        journal="J. Am. Chem. Soc.",
        volume="70",
        pages="""88-94""",
        year="1948",
...
entry(
    ...
    reference=Article(
        authors=["Robaugh, D.A.", "Stein, S.E."],
        title="Stabilities of highly conjugated radicals from bond homolysis rates",
        journal="J. Am. Chem. Soc.",
        volume="108",
        pages="""3224-3229""",
        year="1986",
...
entry(
    ...
    reference=Article(
        ...
        title="O-O bond dissociation energies in propionyl and butyryl peroxides",
        journal="J. Chem. Phys.",
        volume="23",
        pages="""909-913""",
        year="1955",
...
entry(
    ...
    reference=Article(
        ...
        title="Homogeneous decomposition of dialkylperoxides in oxygen",
        journal="J. Chem. Soc. Faraday Trans. 2",
        volume="83",
        pages="""2035""",
        year="1987",
...
entry(
    ...
    reference=Article(
        ...
        title="The kinetics of disproportionation-combination reactions between the s-butoxy-radical and nitric oxide, and of the pyrolysis of the O-O bond in di-s-butyl peroxide in the gas phase",
...
entry(
    ...
    reference=Article(
        authors=["Walker, J.A.", "Tsang, W."],
        title="Single-pulse shock tube studies on the thermal decomposition of n-butyl phenyl ether, n-pentylbenzene, and phenotole and the heat of formation of phenoxy and benzyl radicals",
        journal="J. Phys. Chem.",
        volume="94",
        pages="""3324""",
        year="1990",
...
entry(
    ...
    reference=Article(
        ...
        title="Kinetics for the recombination of phenyl radicals",
        journal="J. Phys. Chem. A",
        volume="101",
        pages="""14-18""",
        year="1997",
...
entry(
    ...
    reference=Article(
        ...
        title="Aliphatic C-H bond scission processes in diphenylmethane and 2-benzyl- and 4-benzylpyridine. The head of formation of the diphenylmethyl and \u03b1-phenylethyl radical in the gas phase",
        journal="J. Phys. Chem.",
        volume="88",
        pages="""5031""",
        year="1984",
...
entry(
    ...
    reference=Article(
        ...
        title="Carbon-oxygen bond strength in diphenyl ether and phenyl vinyl ether: an experimental and computational study",
        journal="J. Phys. Chem. A",
        volume="101",
        pages="""5404-5411""",
        year="1997",
...
entry(
    ...
    reference=Article(
        ...
        title="Bildungsenthalpie und Stabilisierungsenergie des Pentamethylcyclopentadienyl-Radikals",
        journal="Liebigs Ann.",
        pages="""1119-1122""",
        year="1995",
