...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        uncertainty=RateUncertainty(
            mu=0.24606408429282084,
            var=11.431364239445765,
            Tref=1000.0,
            N=6,
            correlation="Root",
        ),
...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        Tmax=(1500, "K"),
        uncertainty=RateUncertainty(
            mu=-0.04346154203493252,
            var=5.777042437712499,
            Tref=1000.0,
            N=5,
            correlation="Root_1COCSCdCdd->Cd",
        ),
        comment="""BM rule fitted to 2 training reactions at node Root_1COCSCdCdd->Cd
...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        uncertainty=RateUncertainty(
            ...
            Tref=1000.0,
            N=1,
            correlation="Root_N-1COCSCdCdd->Cd",
        ),
        comment="""BM rule fitted to 2 training reactions at node Root_N-1COCSCdCdd->Cd
...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        Tmax=(1500, "K"),
        uncertainty=RateUncertainty(
            mu=-0.013070562052782878,
            var=13.242392200388787,
            Tref=1000.0,
            N=3,
            correlation="Root_1COCSCdCdd->Cd_3COCSCdCdd->CO",
        ),
        comment="""BM rule fitted to 2 training reactions at node Root_1COCSCdCdd->Cd_3COCSCdCdd->CO
...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        Tmax=(1500, "K"),
        uncertainty=RateUncertainty(
            mu=-0.010964617442947782,
            var=1.2507574696173305,
            Tref=1000.0,
            N=2,
            correlation="Root_1COCSCdCdd->Cd_N-3COCSCdCdd->CO",
        ),
        comment="""BM rule fitted to 2 training reactions at node Root_1COCSCdCdd->Cd_N-3COCSCdCdd->CO
...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        uncertainty=RateUncertainty(
            ...
            Tref=1000.0,
            N=1,
            correlation="Root_1COCSCdCdd->Cd_N-3COCSCdCdd->CO_3CSCd->Cd",
        ),
        comment="""BM rule fitted to 2 training reactions at node Root_1COCSCdCdd->Cd_N-3COCSCdCdd->CO_3CSCd->Cd
    Total Standard Deviation in ln(k): 11.540182761524994""",
    ),
    rank=11,
...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        uncertainty=RateUncertainty(
            ...
            Tref=1000.0,
            N=1,
            correlation="Root_1COCSCdCdd->Cd_N-3COCSCdCdd->CO_N-3CSCd->Cd",
        ),
        comment="""BM rule fitted to 2 training reactions at node Root_1COCSCdCdd->Cd_N-3COCSCdCdd->CO_N-3CSCd->Cd
    Total Standard Deviation in ln(k): 11.540182761524994""",
    ),
    rank=11,
