...
entry(
    ...
    label="C7H9-5 <=> C7H9-6",
    degeneracy=1.0,
    kinetics=Arrhenius(A=(1.33e08, "s^-1"), n=1.36, Ea=(37.6, "kcal/mol"), T0=(1, "K")),
    rank=5,
    shortDesc="""Training reaction from kinetics library: vinylCPD_H""",
    longDesc="""
...
entry(
    ...
    degeneracy=1.0,
    kinetics=Arrhenius(
        A=(4.745e09, "s^-1"), n=1.06, Ea=(49.6, "kcal/mol"), T0=(1, "K")
    ),
    rank=5,
    shortDesc="""Training reaction from kinetics library: vinylCPD_H""",
    longDesc="""
...
entry(
    ...
    degeneracy=1.0,
    kinetics=Arrhenius(
        A=(8.889e11, "s^-1"), n=0.232, Ea=(29.338, "kcal/mol"), T0=(1, "K")
    ),
    reference=Article(
        authors=[
            "I. V. Tokmakov",
...
entry(
    ...
    degeneracy=1.0,
    kinetics=Arrhenius(
        A=(8.66e11, "s^-1"), n=0.438, Ea=(22.58, "kcal/mol"), T0=(1, "K")
    ),
    reference=Article(
...
entry(
    ...
    degeneracy=2.0,
    kinetics=Arrhenius(
        A=(7.13e12, "s^-1"), n=0.254, Ea=(68.75, "kcal/mol"), T0=(1, "K")
    ),
    reference=Article(
        authors=["Gabriel da Silva", "Adam J. Trevittb"],
        title="Chemically activated reactions on the C7H5 energy surface: propargyl+diacetylene, i-C5H3+acetylene, and n-C5H3+acetylene",
