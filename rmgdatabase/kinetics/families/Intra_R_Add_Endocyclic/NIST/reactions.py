...
entry(
    ...
    reference=Article(
        ...
        title="Reactions of cyclopropyl radicals in the methyl-initiated decomposition of cyclopropanecarbaldehyde",
...
entry(
    ...
    reference=Article(
        ...
        title="Reactions of cyclic akyl radicals. Part 2.-Photolysis of cyclopropane carboxaldehyde",
