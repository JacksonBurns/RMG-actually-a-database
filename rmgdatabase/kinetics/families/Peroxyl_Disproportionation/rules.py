...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        uncertainty=RateUncertainty(
            mu=0.07089946866729961,
            var=0.46390042815407184,
            Tref=1000.0,
            N=8,
            data_mean=0.0,
            correlation="Root",
...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        Tmax=(1500, "K"),
        uncertainty=RateUncertainty(
            mu=0.11014933828574046,
            var=0.6936015787958725,
            Tref=1000.0,
            N=5,
            data_mean=0.0,
            correlation="Root_Ext-5R-R",
        ),
        comment="""BM rule fitted to 5 training reactions at node Root_Ext-5R-R
...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        Tmax=(1500, "K"),
        uncertainty=RateUncertainty(
            mu=-2.155088700701577,
            var=3.6678857531903013,
            Tref=1000.0,
            N=2,
            data_mean=0.0,
            correlation="Root_Ext-3R-R",
        ),
        comment="""BM rule fitted to 2 training reactions at node Root_Ext-3R-R
...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        Tmax=(1500, "K"),
        uncertainty=RateUncertainty(
            mu=1.1175239280999607,
            var=6.252228011041329,
            Tref=1000.0,
            N=4,
            data_mean=0.0,
            correlation="Root_Ext-5R-R_7R!H->C",
        ),
        comment="""BM rule fitted to 4 training reactions at node Root_Ext-5R-R_7R!H->C
...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        uncertainty=RateUncertainty(
            ...
            N=1,
            data_mean=0.0,
            correlation="Root_Ext-5R-R_N-7R!H->C",
        ),
        comment="""BM rule fitted to 1 training reactions at node Root_Ext-5R-R_N-7R!H->C
...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        uncertainty=RateUncertainty(
            ...
            N=1,
            data_mean=0.0,
            correlation="Root_Ext-3R-R_5R->C",
        ),
        comment="""BM rule fitted to 1 training reactions at node Root_Ext-3R-R_5R->C
    Total Standard Deviation in ln(k): 11.540182761524994""",
    ),
    rank=11,
...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        uncertainty=RateUncertainty(
            ...
            N=1,
            data_mean=0.0,
            correlation="Root_Ext-3R-R_N-5R->C",
        ),
        comment="""BM rule fitted to 1 training reactions at node Root_Ext-3R-R_N-5R->C
    Total Standard Deviation in ln(k): 11.540182761524994""",
    ),
    rank=11,
...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        Tmax=(1500, "K"),
        uncertainty=RateUncertainty(
            mu=0.8243065462140909,
            var=3.014120957818995,
            Tref=1000.0,
            N=2,
            data_mean=0.0,
            correlation="Root_Ext-5R-R_7R!H->C_7C-inRing",
        ),
        comment="""BM rule fitted to 2 training reactions at node Root_Ext-5R-R_7R!H->C_7C-inRing
...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        Tmax=(1500, "K"),
        uncertainty=RateUncertainty(
            mu=-0.1238172880969069,
            var=0.2143724373616906,
            Tref=1000.0,
            N=2,
            data_mean=0.0,
            correlation="Root_Ext-5R-R_7R!H->C_N-7C-inRing",
        ),
        comment="""BM rule fitted to 2 training reactions at node Root_Ext-5R-R_7R!H->C_N-7C-inRing
...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        uncertainty=RateUncertainty(
            ...
            N=1,
            data_mean=0.0,
            correlation="Root_Ext-5R-R_7R!H->C_7C-inRing_Ext-7C-R_Ext-8R!H-R_Ext-8R!H-R",
        ),
        comment="""BM rule fitted to 1 training reactions at node Root_Ext-5R-R_7R!H->C_7C-inRing_Ext-7C-R_Ext-8R!H-R_Ext-8R!H-R
    Total Standard Deviation in ln(k): 11.540182761524994""",
    ),
    rank=11,
...
entry(
    ...
    kinetics=ArrheniusBM(
        ...
        uncertainty=RateUncertainty(
            ...
            N=1,
            data_mean=0.0,
            correlation="Root_Ext-5R-R_7R!H->C_N-7C-inRing_Ext-5R-R",
        ),
        comment="""BM rule fitted to 1 training reactions at node Root_Ext-5R-R_7R!H->C_N-7C-inRing_Ext-5R-R
    Total Standard Deviation in ln(k): 11.540182761524994""",
    ),
    rank=11,
