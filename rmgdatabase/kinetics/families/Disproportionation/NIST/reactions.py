...
entry(
    ...
    reference=Article(
        ...
        title="Direct ab initio dynamics study on the rate constants and kinetics isotope effects of CH3O + H -&gt; CH2O + H2 reaction",
        journal="J. Chem. Phys.",
        volume="121",
        pages="""9474-9480""",
        year="2004",
...
entry(
    ...
    reference=Article(
        ...
        title="Temperature dependence for the absolute rate constant for the reaction CH2OH + O2 \u2192\x92 HO2 + H2CO from 215 to 300 K",
        journal="J. Phys. Chem.",
        volume="92",
        pages="""4030""",
        year="1988",
...
entry(
    ...
    reference=Article(
        ...
        title="Non-arrhenius behavior of the reaction of hydroxymethyl radicals with molecular oxygen",
        journal="J. Phys. Chem.",
        volume="92",
        pages="""4028""",
        year="1988",
...
entry(
    ...
    reference=Article(
        ...
        title="Experimental Investigation of Methanol Oxidation in Flames: Mechanism and Rate Constants of Elementary Steps",
...
entry(
    ...
    reference=Article(
        ...
        title="Lean premixed laminar methanol flames: A computational study",
        journal="J. Phys. Chem.",
        volume="91",
        pages="""4160""",
        year="1987",
...
entry(
    ...
    reference=Article(
        ...
        title="The disproportionation and combination of ethyl radicals: The photolysis of mercury diethyl",
...
entry(
    ...
    reference=Article(
        ...
        title="Summary of Evaluated Kinetic and Photochemical Data for Atmospheric Chemistry",
...
entry(
    ...
    reference=Article(
        authors=["Atkinson, R."],
        title="Atmospheric reactions of alkoxy and \u03b2-hydroxyalkoxy radicals",
...
entry(
    ...
    reference=Article(
        ...
        title="Chemical Kinetic and Photochemical Data for Use in Stratospheric Modeling: Evaluation No. 11 of the NASA Panel for Data Evaluation",
...
entry(
    ...
    reference=Article(
        ...
        title="Evaluated Kinetic and Photochemical Data for Atmospheric Chemistry. Supplement IV, IUPAC Subcommittee on Gas Kinetic Data Evaluation for Atmospheric Chemistry",
        journal="J. Phys. Chem. Ref. Data",
        volume="21",
        pages="""1125-1568""",
        year="1992",
...
entry(
    ...
    reference=Article(
        ...
        title="Evaluated Kinetic and Photochemical Data for Atmospheric Chemistry: Supplement III",
        journal="J. Phys. Chem. Ref. Data",
        volume="18",
        pages="""881-1097""",
        year="1989",
...
entry(
    ...
    reference=Article(
        ...
        title="Determination of the rate constant of the reaction of methoxyl radicals with molecular oxygen",
        journal="Kinet. Catal.",
        volume="30",
        pages="""483-488""",
        year="1989",
...
entry(
    ...
    reference=Article(
        authors=["Zellner, R."],
        title="Recent advances in free radical kinetics of oxygenated hydrocarbon radicals",
        journal="J. Chim. Phys.",
        volume="84",
        pages="""403-407""",
        year="1987",
...
entry(
    ...
    reference=Article(
        ...
        title="Removal rate constant measurements for CH3O by O2 over the 298-973 K range",
        journal="J. Phys. Chem.",
        volume="91",
        pages="""4653""",
        year="1987",
...
entry(
    ...
    reference=Article(
        ...
        title="Laser photolysis - LIF kinetic studies of the reactions of CH3O and CH2CHO with O2 between 300 and 500 K",
...
entry(
    ...
    reference=Article(
        ...
        title="Kinetic of the Reactions of Methoxy and Ethoxy Radicals with Oxygen",
        journal="J. Phys. Chem.",
        volume="86",
        pages="""66""",
        year="1982",
...
entry(
    ...
    reference=Article(
        ...
        title="Photolysis of Methyl Nitrite: Kinetics of the Reaction of the Methoxy Radical with O2",
        journal="J. Photochem.",
        volume="13",
        pages="""149""",
        year="1980",
...
entry(
    ...
    reference=Article(
        ...
        title="Reaction of Methoxy Radicals with Oxygen. I. Using Dimethyl Peroxide as a Thermal Source of Methoxy Radicals",
        journal="Int. J. Chem. Kinet.",
        volume="11",
        pages="""1045""",
        year="1979",
...
entry(
    ...
    reference=Article(
        ...
        title="Study of the ethane oxidation reaction by the kinetic tracer method",
        journal="Int. J. Chem. Kinet.",
        volume="12",
        pages="""315""",
        year="1980",
...
entry(
    ...
    reference=Article(
        ...
        title="Kinetics of the reaction: 2C2H4 \u2192\x92 C2H5 + C2H3. Heat of formation of the vinyl radical",
        journal="Int. J. Chem. Kinet.",
        volume="15",
        pages="""83-104""",
        year="1983",
...
entry(
    ...
    reference=Article(
        authors=["Ayranci, G.", "Back, M.H."],
        title="Kinetics of the Bimolecular Initiation Process in the Thermal Reactions of Ethylene",
        journal="Int. J. Chem. Kinet.",
        volume="13",
        pages="""897""",
        year="1981",
...
entry(
    ...
    reference=Article(
        authors=["Back, M.H."],
        title="Mechanism of the bimolecular reactions of ethylene and propylene",
        journal="Int. J. Chem. Kinet.",
        volume="2",
        pages="""409-418""",
        year="1970",
...
entry(
    ...
    reference=Article(
        ...
        title="Arrhenius Parameters for the reaction C2H5 + O2 \u2192\x92 C2H4 + HO2",
...
entry(
    ...
    reference=Article(
        ...
        title="Reactions of Ethyl Radicals with Oxygen over the Temperature Range 400-540oC",
...
entry(
    ...
    reference=Article(
        ...
        title="Shock-tube studies of the ignition and combustion of ethane and slightly rich methane mixtures with oxygen",
        journal="Symp. Int. Combust. Proc.",
        volume="13",
        pages="""757""",
        year="1971",
...
entry(
    ...
    reference=Article(
        ...
        title="Kinetic parameters of the reaction C2H6 + C3H4 \u2192\x92 C2H5 + C3H5",
        journal="Kinet. Catal.",
        volume="26",
        pages="""1068""",
        year="1985",
...
entry(
    ...
    reference=Article(
        ...
        title="Arrhenius parameters for the reaction i-C3H7 + O2 \u2192\x92 C3H6 + HO2",
        journal="J. Chem. Soc. Faraday Trans. 2",
        volume="84",
        pages="""401""",
        year="1988",
...
entry(
    ...
    reference=Article(
        ...
        title="Kinetics and HO2 product yield of the reaction C2H5O + O2 between 295 and 411 K",
        journal="Ber. Bunsenges. Phys. Chem.",
        volume="94",
        pages="""639-645""",
        year="1990",
...
entry(
    ...
    reference=Article(
        ...
        title="Reactions of alkoxy radicals with O2. I. C2H5O radicals",
        journal="Int. J. Chem. Kinet.",
        volume="17",
        pages="""455""",
        year="1985",
...
entry(
    ...
    reference=Article(
        ...
        title="An Experimental and Analytical Investigation of High Temperature Ignition of Ethanol",
...
entry(
    ...
    reference=Article(
        ...
        title="Reaction of t-Butyl Radicals with Hydrogen and with Oxygen",
        journal="J. Chem. Soc. Faraday Trans. 1",
        volume="75",
        pages="""1458""",
        year="1979",
...
entry(
    ...
    reference=Article(
        ...
        title="The Kinetics of the Reaction 2C3H6 \u2192\x92 C3H5 + C3H7",
        journal="Can. J. Chem.",
        volume="51",
        pages="""2934""",
        year="1973",
...
entry(
    ...
    reference=Article(
        ...
        title="Kinetics of the reactions of isopropoxy radicals with NO, NO2, and O2",
        journal="Chem. Phys.",
        volume="99",
        pages="""323""",
        year="1985",
...
entry(
    ...
    reference=Article(
        authors=["Baker, R.R.", "Baldwin, R.R.", "Walker, R.W."],
        title="Addition of i-Butane to Slowly Reacting Mixtures of Hydrogen and Oxygen at 480o C",
        journal="J. Chem. Soc. Faraday Trans. 1",
        volume="74",
        pages="""2229""",
        year="1978",
...
entry(
    ...
    reference=Article(
        authors=["Zabarnick, S.", "Heicklen, J."],
        title="The reactions of alkoxy radicals with O2. II. n-C3H7O radicals",
        journal="Int. J. Chem. Kinet.",
        volume="17",
        pages="""477""",
        year="1985",
...
entry(
    ...
    reference=Article(
        ...
        title="The reactions of alkoxyl radicals with O2. IV. n-C4H9O radicals",
...
entry(
    ...
    reference=Article(
        authors=["Zabarnick, S.", "Heicklen, J."],
        title="Reactions of alkoxy radicals with O2. III. i-C4H9O radicals",
        journal="Int. J. Chem. Kinet.",
        volume="17",
        pages="""503""",
        year="1985",
