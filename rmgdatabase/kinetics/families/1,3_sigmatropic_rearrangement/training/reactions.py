...
entry(
    ...
    kinetics=Arrhenius(
        ...
        Tmin=(300, "K"),
        Tmax=(2000, "K"),
        comment="""Fitted to 50 data points; dA = *|/ 1.17679, dn = +|- 0.0216006, dEa = +|- 0.111384 kJ/mol""",
    ),
    rank=4,
...
entry(
    ...
    kinetics=Arrhenius(
        ...
        Tmin=(300, "K"),
        Tmax=(2000, "K"),
        comment="""Fitted to 50 data points; dA = *|/ 1.44696, dn = +|- 0.0490241, dEa = +|- 0.252794 kJ/mol""",
    ),
    rank=4,
    shortDesc="""CCSD(T)-F12a/cc-pVDZ-F12//wB97X-D3/def2-TZVP""",
    longDesc="""
...
entry(
    ...
    kinetics=Arrhenius(
        ...
        Tmin=(300, "K"),
        Tmax=(2000, "K"),
        comment="""Fitted to 50 data points; dA = *|/ 1.07354, dn = +|- 0.00941532, dEa = +|- 0.0485503 kJ/mol""",
    ),
    rank=4,
    shortDesc="""CCSD(T)-F12a/cc-pVDZ-F12//wB97X-D3/def2-TZVP""",
    longDesc="""
...
entry(
    ...
    kinetics=Arrhenius(
        ...
        Tmin=(300, "K"),
        Tmax=(2000, "K"),
        comment="""Fitted to 50 data points; dA = *|/ 1.43847, dn = +|- 0.0482433, dEa = +|- 0.248768 kJ/mol""",
    ),
    rank=4,
    shortDesc="""CCSD(T)-F12a/cc-pVDZ-F12//wB97X-D3/def2-TZVP""",
    longDesc="""
...
entry(
    ...
    kinetics=Arrhenius(
        ...
        Tmin=(300, "K"),
        Tmax=(2000, "K"),
        comment="""Fitted to 50 data points; dA = *|/ 1.3651, dn = +|- 0.0412969, dEa = +|- 0.212948 kJ/mol""",
    ),
    rank=4,
    shortDesc="""CCSD(T)-F12a/cc-pVDZ-F12//wB97X-D3/def2-TZVP""",
    longDesc="""
...
entry(
    ...
    kinetics=Arrhenius(
        ...
        Tmin=(300, "K"),
        Tmax=(2000, "K"),
        comment="""Fitted to 50 data points; dA = *|/ 1.29772, dn = +|- 0.0345798, dEa = +|- 0.178312 kJ/mol""",
    ),
    rank=4,
    shortDesc="""CCSD(T)-F12a/cc-pVDZ-F12//wB97X-D3/def2-TZVP""",
    longDesc="""
...
entry(
    ...
    kinetics=Arrhenius(
        ...
        Tmin=(300, "K"),
        Tmax=(2000, "K"),
        comment="""Fitted to 50 data points; dA = *|/ 1.35846, dn = +|- 0.0406495, dEa = +|- 0.20961 kJ/mol""",
    ),
    rank=4,
    shortDesc="""CCSD(T)-F12a/cc-pVDZ-F12//wB97X-D3/def2-TZVP""",
    longDesc="""
...
entry(
    ...
    kinetics=Arrhenius(
        ...
        Tmin=(300, "K"),
        Tmax=(2000, "K"),
        comment="""Fitted to 50 data points; dA = *|/ 1.36962, dn = +|- 0.0417358, dEa = +|- 0.215211 kJ/mol""",
    ),
    rank=4,
    shortDesc="""CCSD(T)-F12a/cc-pVDZ-F12//wB97X-D3/def2-TZVP""",
    longDesc="""
...
entry(
    ...
    kinetics=Arrhenius(
        ...
        Tmin=(300, "K"),
        Tmax=(2000, "K"),
        comment="""Fitted to 50 data points; dA = *|/ 1.24984, dn = +|- 0.0295922, dEa = +|- 0.152593 kJ/mol""",
    ),
    rank=4,
    shortDesc="""CCSD(T)-F12a/cc-pVDZ-F12//wB97X-D3/def2-TZVP""",
    longDesc="""
