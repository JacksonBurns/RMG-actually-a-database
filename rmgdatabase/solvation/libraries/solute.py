...
entry(
    ...
    label="N2",
    molecule="N#N",
    solute=SoluteData(S=0.0, B=0.00, E=0.00, L=-0.978, A=0.00, V=0.2222),
    shortDesc="""""",
    longDesc="""
...
entry(
    ...
    label="O2",
    molecule="[O][O]",
    solute=SoluteData(S=0.0, B=0.00, E=0.00, L=-0.723, A=0.00, V=0.1830),
    shortDesc="""""",
    longDesc="""
Michael H. Abraham,a Andreas M. Zissimos, a and William E. Acree, Jr.
Phys. Chem. Chem. Phys., 2001,3, 3732-3736
...
entry(
    ...
    molecule="OCCCCl",
    solute=SoluteData(S=0.71, B=0.50, E=0.407, L=2.651, A=0.40, V=0.7124),
    shortDesc="""""",
    longDesc="""
From in-house database received from Prof. Abraham
""",
