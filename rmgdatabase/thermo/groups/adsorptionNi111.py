...
shortDesc = "Surface adsorption Ni(111), Goldsmith 2016"
longDesc = """
...
""",
    ...
    shortDesc="""Anything adsorbed by any chemical bond. BAD DATA! REMOVE!""",
    longDesc="""
   R
...
""",
    ...
    shortDesc="""Anything physisorbed by a van der Waals bond""",
    longDesc="""
   R
   :  <---(van der Waals bond)
********
...
""",
    thermo=None,
    shortDesc="""Carbon chemisorbed by any bond""",
    longDesc="""
   C
   x
***********
...
""",
    thermo=None,
    shortDesc="""Oxygen chemisorbed by any bond""",
    longDesc="""
   O
   x
***********
...
""",
    ...
    shortDesc="""C-R triple-bonded on nickel""",
...
""",
    ...
    shortDesc="""CR2 doubled-bonded on nickel""",
    longDesc="""Estimated via CFG-TiC
  R-C-R
   ||
***********
...
""",
    ...
    shortDesc="""CR3 single-bonded on nickle""",
    longDesc="""Estimated via CFG-TiC
   R
   |
 R-C-R
...
""",
    thermo=None,
    shortDesc="""CR4 physisorbed on nickel""",
    longDesc="""
 R2-C-R2
    :
***********
...
""",
    thermo=None,
    shortDesc="""R2O physisorbed on nickel""",
    longDesc="""
  R-O-R
    :
***********
...
""",
    ...
    shortDesc="""RCR di-sigma adsorbed on nickel""",
    longDesc="""Estimated via CFG-TiC
R--C--R
   || |
***********
...
""",
    ...
    shortDesc="""COR adsorbed on nickel by a triple bond: SUBSET OF C*R!""",
    longDesc="""Estimated via CFG-TiC
 RO-C
   |||
***********
...
""",
    ...
    shortDesc="""CR2-R di-sigma adsorbed on nickel""",
    longDesc="""Estimated via CFG-TiC
R2--C--R
    |  |
***********
...
""",
    ...
    shortDesc="""CROR double-bonded on nickel: SUBSET OF C=*R2""",
    longDesc="""Estimated via CFG-TiC
  R-C-OR
   ||
***********
...
""",
    ...
    shortDesc="""CR3O adsorbed on nickel""",
    longDesc="""Estimated via CFG-TiC
   CR3
   |
   O
...
""",
    ...
    shortDesc="""CR2OR adsorbed on nickel: SUBSET OF C*R3""",
    longDesc="""Estimated via CFG-TiC
   R
   |
 R-C-OR
...
""",
    thermo=None,
    shortDesc="""CR3OR physisorbed on nickel: SUBSET OF O*R2""",
    longDesc="""
   CR3
   |
   O-R
...
""",
    ...
    shortDesc="""HOCO adsorbed on nickel: SUBSET OF RCR*""",
    longDesc="""Estimated via CFG-TiC
RO--C--R
    || |
***********
