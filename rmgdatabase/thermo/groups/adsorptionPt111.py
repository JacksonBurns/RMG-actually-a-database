...
shortDesc = "Surface adsorption Pt(111), Blondal 2018"
longDesc = """
...
""",
    thermo="C-*R3",
    longDesc="""Thermo is currently for C-*R3.  Maybe should average all the children instead?""",
)
...
""",
    thermo="N-*R2",
    longDesc="""Thermo is currently for N-*R2.  Maybe should average all the children instead?""",
)
...
""",
    thermo="O-*R",
    longDesc="""Thermo is currently for O-*R.  Maybe should average all the children instead?""",
)
...
""",
    thermo="C-*R2C-*R2",
    longDesc="""Thermo is currently for C-*R2C-*R2.  Maybe should average all the children instead?""",
)
...
""",
    thermo="C=*RN-*R",
    longDesc="""Thermo is currently for C=*RN-*R.  Maybe should average all the children instead?""",
)
...
""",
    thermo="N-*RN-*R",
    longDesc="""Thermo is currently for N-*RN-*R.  Maybe should average all the children instead?""",
)
...
""",
    ...
    shortDesc="""Came from HN-N-h bidentate, single- and double-bonded on Pt(111)""",
    longDesc="""Calculated by Katrin Blondal at Brown University using statistical mechanics (files: compute_NASA_for_Pt-adsorbates.ipynb and compute_NASA_for_Pt-gas_phase.ipynb). Based on DFT calculations by Jelena Jelic at KIT.
...
""",
    ...
    shortDesc="""Came from CH-CH vdW-bonded on Pt(111)""",
    longDesc="""Calculated by Katrin Blondal at Brown University using statistical mechanics (files: compute_NASA_for_Pt-adsorbates.ipynb and compute_NASA_for_Pt-gas_phase.ipynb). Based on DFT calculations by Jelena Jelic at KIT.
...
""",
    ...
    shortDesc="""Came from H2CN-h bidentate, single- and double-bonded on Pt(111)""",
    longDesc="""Calculated by Katrin Blondal at Brown University using statistical mechanics (files: compute_NASA_for_Pt-adsorbates.ipynb and compute_NASA_for_Pt-gas_phase.ipynb). Based on DFT calculations by Jelena Jelic at KIT.
...
""",
    ...
    shortDesc="""Came from H2CNH-h bidentate, twice single-bonded on Pt(111)""",
    longDesc="""Calculated by Katrin Blondal at Brown University using statistical mechanics (files: compute_NASA_for_Pt-adsorbates.ipynb and compute_NASA_for_Pt-gas_phase.ipynb). Based on DFT calculations by Jelena Jelic at KIT.
...
""",
    ...
    shortDesc="""Came from H2CO-h bidentate, twice single-bonded on Pt(111)""",
    longDesc="""Calculated by Katrin Blondal at Brown University using statistical mechanics (files: compute_NASA_for_Pt-adsorbates.ipynb and compute_NASA_for_Pt-gas_phase.ipynb).
