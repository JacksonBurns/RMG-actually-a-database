...
name = "CHON"
shortDesc = "Yaws' Critical Property Data for C and N compounds"
longDesc = """
...
""",
    thermo=ThermoData(
        ...
        Cpdata=(
            [10.725, 13.097, 15.339, 17.343, 20.559, 22.921, 26.561],
            "cal/(mol*K)",
        ),
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [16.191, 19.972, 23.511, 26.602, 31.451, 35.069, 40.681],
            "cal/(mol*K)",
        ),
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [19.012, 23.615, 27.746, 31.243, 36.537, 40.363, 46.056],
            "cal/(mol*K)",
        ),
        H298=(-24.377, "kcal/mol"),
        S298=(75.711, "cal/(mol*K)"),
    ),
    shortDesc="""nitroethane""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [20.464, 24.989, 29.228, 32.747, 37.917, 41.996, 48.225],
            "cal/(mol*K)",
        ),
        H298=(-50.235, "kcal/mol"),
        S298=(76.647, "cal/(mol*K)"),
    ),
    shortDesc="""monoethanolamine""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [19.915, 24.443, 28.635, 32.276, 37.932, 41.917, 46.828],
            "cal/(mol*K)",
        ),
        H298=(-40.629, "kcal/mol"),
        S298=(71.805, "cal/(mol*K)"),
    ),
    shortDesc="""acrylamide""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [20.302, 24.676, 28.586, 31.869, 36.768, 40.193, 44.902],
            "cal/(mol*K)",
        ),
        H298=(-23.493, "kcal/mol"),
        S298=(79.18, "cal/(mol*K)"),
    ),
    shortDesc="""hydracrylonitrile""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [22.006, 26.061, 29.693, 32.928, 38.403, 42.625, 47.619],
            "cal/(mol*K)",
        ),
        H298=(-15.271, "kcal/mol"),
        S298=(97.617, "cal/(mol*K)"),
    ),
    shortDesc="""lactonitrile""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [23.032, 28.049, 33.079, 37.542, 44.287, 48.737, 55.086],
            "cal/(mol*K)",
        ),
        H298=(-45.815, "kcal/mol"),
        S298=(78.034, "cal/(mol*K)"),
    ),
    shortDesc="""N,N-dimethylformamide""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [18.262, 23.422, 28.393, 32.802, 39.881, 45.227, 51.992],
            "cal/(mol*K)",
        ),
        H298=(-57.359, "kcal/mol"),
        S298=(76.666, "cal/(mol*K)"),
    ),
    shortDesc="""N-methylacetamide""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [25.664, 31.433, 36.984, 41.718, 48.769, 54.049, 62.066],
            "cal/(mol*K)",
        ),
        H298=(-52.818, "kcal/mol"),
        S298=(87.854, "cal/(mol*K)"),
    ),
    shortDesc="""3-amino-1-propanol""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [24.797, 30.989, 36.931, 41.915, 49.197, 54.741, 62.861],
            "cal/(mol*K)",
        ),
        H298=(-52.419, "kcal/mol"),
        S298=(85.742, "cal/(mol*K)"),
    ),
    shortDesc="""2-amino-1-propanol, ()""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [25.006, 31.235, 36.497, 40.482, 45.867, 50.238, 56.124],
            "cal/(mol*K)",
        ),
        H298=(-56.643, "kcal/mol"),
        S298=(91.358, "cal/(mol*K)"),
    ),
    shortDesc="""methyl cyanoacetate""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [27.373, 33.012, 37.993, 42.175, 48.522, 53.112, 59.335],
            "cal/(mol*K)",
        ),
        H298=(-31.786, "kcal/mol"),
        S298=(80.414, "cal/(mol*K)"),
    ),
    shortDesc="""acetone cyanohydrin""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [25.673, 31.504, 36.815, 41.338, 48.204, 53.061, 59.277],
            "cal/(mol*K)",
        ),
        H298=(-18.88, "kcal/mol"),
        S298=(87.092, "cal/(mol*K)"),
    ),
    shortDesc="""3-methoxypropionitrile""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [21.217, 28.291, 34.962, 40.489, 48.401, 54.097, 60.399],
            "cal/(mol*K)",
        ),
        H298=(-47.117, "kcal/mol"),
        S298=(72.088, "cal/(mol*K)"),
    ),
    shortDesc="""2-pyrrolidone""",
    longDesc="""
...
""",
    ...
    shortDesc="""N,N-dimethylacetamide""",
    longDesc="""
...
""",
    ...
    shortDesc="""1-nitro-2-methylpropane""",
    longDesc="""
...
""",
    ...
    shortDesc="""2-nitro-2-methylpropane""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [30.213, 38.076, 45.611, 51.866, 60.761, 67.377, 77.371],
            "cal/(mol*K)",
        ),
        H298=(-48.276, "kcal/mol"),
        S298=(91.919, "cal/(mol*K)"),
    ),
    shortDesc="""dimethylethanolamine""",
    longDesc="""
...
""",
    ...
    shortDesc="""2-amino-2-methyl-1-propanol""",
    longDesc="""
...
""",
    ...
    shortDesc="""2-(ethylamino)ethanol""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [33.757, 41.744, 48.961, 55.023, 64.211, 71.016, 79.336],
            "cal/(mol*K)",
        ),
        H298=(-87.234, "kcal/mol"),
        S298=(106.493, "cal/(mol*K)"),
    ),
    shortDesc="""2-aminoethoxyethanol""",
    longDesc="""
...
""",
    ...
    shortDesc="""2-amino-2-methyl-1,3-propanediol""",
    longDesc="""
...
""",
    ...
    shortDesc="""3-methylamino-1,2-propanediol""",
    longDesc="""
...
""",
    ...
    shortDesc="""N-aminoethyl ethanolamine""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [30.194, 37.848, 44.596, 49.943, 57.211, 62.321, 69.623],
            "cal/(mol*K)",
        ),
        H298=(-75.557, "kcal/mol"),
        S298=(98.813, "cal/(mol*K)"),
    ),
    shortDesc="""ethyl cyanoacetate""",
    longDesc="""
...
""",
    ...
    shortDesc="""N-methyl-2-pyrrolidone""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [26.405, 33.066, 38.472, 42.497, 48.434, 54.344, 62.039],
            "cal/(mol*K)",
        ),
        H298=(-30.351, "kcal/mol"),
        S298=(91.432, "cal/(mol*K)"),
    ),
    shortDesc="""isobutyl isocyanate""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [44.194, 55.344, 64.391, 71.128, 81.064, 90.955, 103.835],
            "cal/(mol*K)",
        ),
        H298=(-30.353, "kcal/mol"),
        S298=(91.422, "cal/(mol*K)"),
    ),
    shortDesc="""2-isocyanato-2-methylpropane""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [30.394, 38.782, 46.901, 53.623, 62.993, 69.508, 78.562],
            "cal/(mol*K)",
        ),
        H298=(-67.874, "kcal/mol"),
        S298=(89.763, "cal/(mol*K)"),
    ),
    shortDesc="""tert-butylformamide""",
    longDesc="""
...
""",
    ...
    shortDesc="""1-nitro-2-methylbutane""",
    longDesc="""
...
""",
    ...
    shortDesc="""1-nitro-3-methylbutane""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [35.705, 45.088, 53.602, 60.588, 70.574, 77.672, 88.174],
            "cal/(mol*K)",
        ),
        H298=(-41.847, "kcal/mol"),
        S298=(119.167, "cal/(mol*K)"),
    ),
    shortDesc="""2-nitro-2-methylbutane""",
    longDesc="""
...
""",
    ...
    shortDesc="""2-nitro-3-methylbutane""",
    longDesc="""
...
""",
    ...
    shortDesc="""1-nitro-2,2-dimethylpropane""",
    longDesc="""
...
""",
    ...
    shortDesc="""methyl diethanolamine""",
    longDesc="""
...
""",
    ...
    shortDesc="""2-amino-2-ethyl-1,3-propanediol""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [28.583, 36.015, 42.765, 48.244, 55.602, 60.182, 67.234],
            "cal/(mol*K)",
        ),
        H298=(16.158, "kcal/mol"),
        S298=(85.763, "cal/(mol*K)"),
    ),
    shortDesc="""nitrobenzene""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [35.334, 42.781, 49.204, 54.504, 62.297, 67.672, 75.583],
            "cal/(mol*K)",
        ),
        H298=(13.984, "kcal/mol"),
        S298=(91.327, "cal/(mol*K)"),
    ),
    shortDesc="""m-nitroaniline""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [36.661, 44.199, 50.979, 56.772, 65.568, 71.597, 79.985],
            "cal/(mol*K)",
        ),
        H298=(4.878, "kcal/mol"),
        S298=(100.368, "cal/(mol*K)"),
    ),
    shortDesc="""bis(cyanoethyl) ether""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [33.076, 43.448, 52.959, 60.785, 71.917, 80.103, 93.961],
            "cal/(mol*K)",
        ),
        H298=(-58.84, "kcal/mol"),
        S298=(87.054, "cal/(mol*K)"),
    ),
    shortDesc="""epsiloN-caprolactam""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [32.928, 42.828, 52.065, 59.906, 71.539, 80.024, 93.868],
            "cal/(mol*K)",
        ),
        H298=(-46.364, "kcal/mol"),
        S298=(90.252, "cal/(mol*K)"),
    ),
    shortDesc="""cyclohexanone oxime""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [41.268, 51.407, 60.771, 68.767, 80.925, 89.652, 101.773],
            "cal/(mol*K)",
        ),
        H298=(-42.523, "kcal/mol"),
        S298=(112.313, "cal/(mol*K)"),
    ),
    shortDesc="""1-nitrohexane""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [41.218, 51.428, 60.87, 68.923, 81.104, 89.781, 101.919],
            "cal/(mol*K)",
        ),
        H298=(-43.785, "kcal/mol"),
        S298=(110.037, "cal/(mol*K)"),
    ),
    shortDesc="""2-nitrohexane""",
    longDesc="""
...
""",
    ...
    shortDesc="""1-nitro-2-methylpentane""",
    longDesc="""
...
""",
    ...
    shortDesc="""1-nitro-3-methylpentane""",
    longDesc="""
...
""",
    ...
    shortDesc="""1-nitro-4-methyl pentane""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [41.203, 52.008, 61.843, 69.956, 81.656, 90.003, 102.171],
            "cal/(mol*K)",
        ),
        H298=(-44.614, "kcal/mol"),
        S298=(103.022, "cal/(mol*K)"),
    ),
    shortDesc="""2-nitro-2-methylpentane""",
    longDesc="""
...
""",
    ...
    shortDesc="""2-nitro-3-methylpentane""",
    longDesc="""
...
""",
    ...
    shortDesc="""2-nitro-4-methylpentane""",
    longDesc="""
...
""",
    ...
    shortDesc="""3-nitro-2-methylpentane""",
    longDesc="""
...
""",
    ...
    shortDesc="""3-nitro-3-methylpentane""",
    longDesc="""
...
""",
    ...
    shortDesc="""1-nitro-2,2-dimethylbutane""",
    longDesc="""
...
""",
    ...
    shortDesc="""1-nitro-2,3-dimethylbutane""",
    longDesc="""
...
""",
    ...
    shortDesc="""1-nitro-3,3-dimethylbutane""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [41.153, 52.03, 61.942, 70.112, 81.835, 90.131, 102.317],
            "cal/(mol*K)",
        ),
        H298=(-45.876, "kcal/mol"),
        S298=(100.746, "cal/(mol*K)"),
    ),
    shortDesc="""2-nitro-2,3-dimethylbutane""",
    longDesc="""
...
""",
    ...
    shortDesc="""2-nitro-3,3-dimethylbutane""",
    longDesc="""
...
""",
    ...
    shortDesc="""1-nitro-2-ethylbutane""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [47.577, 58.453, 68.234, 76.436, 88.756, 97.674, 109.118],
            "cal/(mol*K)",
        ),
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [45.157, 56.428, 67.029, 75.658, 87.682, 96.788, 111.32],
            "cal/(mol*K)",
        ),
        H298=(-108.505, "kcal/mol"),
        S298=(122.798, "cal/(mol*K)"),
    ),
    shortDesc="""diisopropanolamine""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [47.355, 59.118, 69.941, 79.004, 91.932, 100.304, 112.056],
            "cal/(mol*K)",
        ),
        H298=(-134.336, "kcal/mol"),
        S298=(128.756, "cal/(mol*K)"),
    ),
    shortDesc="""triethanolamine""",
    longDesc="""
