...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [11.907, 13.296, 14.418, 15.293, 16.484, 17.210, 18.224],
            "cal/(mol*K)",
        ),
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [24.735, 28.138, 30.686, 32.652, 35.457, 37.330, 39.985],
            "cal/(mol*K)",
        ),
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [38.167, 42.155, 44.960, 47.005, 49.701, 51.321, 53.316],
            "cal/(mol*K)",
        ),
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [33.416, 37.606, 40.792, 43.253, 46.702, 48.914, 51.842],
            "cal/(mol*K)",
        ),
        H298=(-6.900, "kcal/mol"),
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [33.355, 37.552, 40.741, 43.204, 46.660, 48.879, 51.823],
            "cal/(mol*K)",
        ),
        H298=(-5.818, "kcal/mol"),
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [32.659, 36.796, 40.030, 42.574, 46.192, 48.535, 51.647],
            "cal/(mol*K)",
        ),
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [32.837, 36.982, 40.212, 42.744, 46.332, 48.646, 51.703],
            "cal/(mol*K)",
        ),
        H298=(-8.758, "kcal/mol"),
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [29.148, 33.230, 36.160, 38.345, 41.360, 43.317, 46.044],
            "cal/(mol*K)",
        ),
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [34.381, 38.923, 42.375, 45.109, 49.149, 51.939, 55.980],
            "cal/(mol*K)",
        ),
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [33.630, 38.464, 42.240, 45.229, 49.554, 52.436, 56.425],
            "cal/(mol*K)",
        ),
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [30.008, 34.775, 38.707, 41.947, 46.832, 50.216, 55.080],
            "cal/(mol*K)",
        ),
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [22.731, 26.651, 29.819, 32.388, 36.213, 38.844, 42.624],
            "cal/(mol*K)",
        ),
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [23.729, 27.813, 30.918, 33.325, 36.797, 39.189, 42.773],
            "cal/(mol*K)",
        ),
        H298=(-7.364, "kcal/mol"),
