...
name = "CHN"
shortDesc = "Yaws' Critical Property Data for C, H and N compounds"
longDesc = """
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [12.004, 14.388, 16.745, 18.878, 22.359, 25.069, 29.484],
            "cal/(mol*K)",
        ),
        H298=(-5.376, "kcal/mol"),
        S298=(58.097, "cal/(mol*K)"),
    ),
    shortDesc="""methylamine""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [17.705, 21.461, 24.847, 27.755, 32.349, 35.827, 40.001],
            "cal/(mol*K)",
        ),
        H298=(12.31, "kcal/mol"),
        S298=(68.213, "cal/(mol*K)"),
    ),
    shortDesc="""propionitrile""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [20.905, 25.181, 29.354, 32.999, 38.647, 42.967, 49.356],
            "cal/(mol*K)",
        ),
        H298=(13.912, "kcal/mol"),
        S298=(74.754, "cal/(mol*K)"),
    ),
    shortDesc="""allylamine""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [18.131, 23.952, 29.296, 33.625, 39.704, 44.217, 50.181],
            "cal/(mol*K)",
        ),
        H298=(21.226, "kcal/mol"),
        S298=(68.823, "cal/(mol*K)"),
    ),
    shortDesc="""propyleneimine""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [21.896, 27.632, 32.988, 37.658, 45.002, 50.559, 59.273],
            "cal/(mol*K)",
        ),
        H298=(-16.752, "kcal/mol"),
        S298=(77.769, "cal/(mol*K)"),
    ),
    shortDesc="""propylamine""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [27.501, 33.461, 39.521, 44.925, 53.297, 59.443, 68.265],
            "cal/(mol*K)",
        ),
        H298=(-12.827, "kcal/mol"),
        S298=(86.211, "cal/(mol*K)"),
    ),
    shortDesc="""1,3-propanediamine""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [21.882, 25.991, 29.745, 33.026, 38.221, 41.968, 47.078],
            "cal/(mol*K)",
        ),
        H298=(23.431, "kcal/mol"),
        S298=(53.574, "cal/(mol*K)"),
    ),
    shortDesc="""methacrylonitrile""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [20.844, 24.948, 28.709, 31.977, 37.111, 40.838, 45.811],
            "cal/(mol*K)",
        ),
        H298=(37.716, "kcal/mol"),
        S298=(72.629, "cal/(mol*K)"),
    ),
    shortDesc="""vinylacetonitrile""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [20.119, 24.291, 28.109, 31.442, 36.718, 40.641, 46.606],
            "cal/(mol*K)",
        ),
        H298=(33.837, "kcal/mol"),
        S298=(75.511, "cal/(mol*K)"),
    ),
    shortDesc="""2-butenenitrile""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [28.681, 38.019, 46.529, 53.227, 61.535, 66.474, 75.644],
            "cal/(mol*K)",
        ),
        H298=(5.333, "kcal/mol"),
        S298=(77.009, "cal/(mol*K)"),
    ),
    shortDesc="""piperazine""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [29.051, 35.149, 41.224, 46.816, 56.031, 62.846, 72.535],
            "cal/(mol*K)",
        ),
        H298=(-21.986, "kcal/mol"),
        S298=(87.123, "cal/(mol*K)"),
    ),
    shortDesc="""butylamine""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [27.894, 34.862, 41.554, 47.288, 55.927, 62.392, 72.012],
            "cal/(mol*K)",
        ),
        H298=(-23.551, "kcal/mol"),
        S298=(84.198, "cal/(mol*K)"),
    ),
    shortDesc="""isobutylamine""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [29.039, 36.161, 42.424, 47.802, 56.329, 62.782, 72.992],
            "cal/(mol*K)",
        ),
        H298=(-28.845, "kcal/mol"),
        S298=(78.386, "cal/(mol*K)"),
    ),
    shortDesc="""tert-butylamine""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [27.586, 34.649, 41.426, 47.273, 56.155, 62.759, 72.696],
            "cal/(mol*K)",
        ),
        H298=(-15.771, "kcal/mol"),
        S298=(89.377, "cal/(mol*K)"),
    ),
    shortDesc="""methyl-propylamine""",
    longDesc="""
...
""",
    ...
    shortDesc="""methylisopropylamine""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [27.537, 34.884, 41.842, 47.739, 56.515, 63.031, 72.338],
            "cal/(mol*K)",
        ),
        H298=(-11.947, "kcal/mol"),
        S298=(85.056, "cal/(mol*K)"),
    ),
    shortDesc="""dimethylethylamine""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [29.248, 35.622, 41.593, 46.796, 54.949, 61.006, 69.908],
            "cal/(mol*K)",
        ),
        H298=(2.741, "kcal/mol"),
        S298=(87.499, "cal/(mol*K)"),
    ),
    shortDesc="""valeronitrile""",
    longDesc="""
...
""",
    ...
    shortDesc="""2-methylbutanenitrile""",
    longDesc="""
...
""",
    ...
    shortDesc="""3-methylbutanenitrile""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [29.893, 36.811, 43.038, 48.224, 55.932, 61.687, 70.507],
            "cal/(mol*K)",
        ),
        H298=(-0.595, "kcal/mol"),
        S298=(79.146, "cal/(mol*K)"),
    ),
    shortDesc="""2,2-dimethylpropanenitrile""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [30.291, 39.783, 48.601, 55.631, 64.638, 70.074, 75.825],
            "cal/(mol*K)",
        ),
        H298=(-11.685, "kcal/mol"),
        S298=(80.558, "cal/(mol*K)"),
    ),
    shortDesc="""piperidine""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [26.373, 34.279, 42.579, 50.435, 62.979, 70.663, 79.303],
            "cal/(mol*K)",
        ),
        H298=(-1.937, "kcal/mol"),
        S298=(78.781, "cal/(mol*K)"),
    ),
    shortDesc="""2-methylpyrrolidine""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [24.855, 32.307, 40.129, 47.533, 59.355, 66.597, 74.739],
            "cal/(mol*K)",
        ),
        H298=(-1.937, "kcal/mol"),
        S298=(78.782, "cal/(mol*K)"),
    ),
    shortDesc="""3-methylpyrrolidine""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [33.626, 41.798, 49.687, 56.527, 67.032, 74.939, 86.493],
            "cal/(mol*K)",
        ),
        H298=(-26.933, "kcal/mol"),
        S298=(96.559, "cal/(mol*K)"),
    ),
    shortDesc="""pentylamine""",
    longDesc="""
...
""",
    ...
    shortDesc="""1,1-dimethylpropylamine""",
    longDesc="""
...
""",
    ...
    shortDesc="""1,2-dimethylpropylamine""",
    longDesc="""
...
""",
    ...
    shortDesc="""2,2-dimethylpropylamine""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [33.083, 41.551, 49.666, 56.655, 67.237, 75.089, 86.979],
            "cal/(mol*K)",
        ),
        H298=(-20.742, "kcal/mol"),
        S298=(98.555, "cal/(mol*K)"),
    ),
    shortDesc="""methyl-butylamine""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [33.033, 41.572, 49.765, 56.811, 67.416, 75.218, 87.128],
            "cal/(mol*K)",
        ),
        H298=(-22.344, "kcal/mol"),
        S298=(95.14, "cal/(mol*K)"),
    ),
    shortDesc="""methylisobutylamine""",
    longDesc="""
...
""",
    ...
    shortDesc="""methyl-sec-butylamine""",
    longDesc="""
...
""",
    ...
    shortDesc="""methyl-tert-butylamine""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [33.034, 41.789, 50.082, 57.118, 67.597, 75.361, 86.489],
            "cal/(mol*K)",
        ),
        H298=(-18.28, "kcal/mol"),
        S298=(89.665, "cal/(mol*K)"),
    ),
    shortDesc="""methyldiethylamine""",
    longDesc="""
...
""",
    ...
    shortDesc="""dimethyl-propylamine""",
    longDesc="""
...
""",
    ...
    shortDesc="""dimethylisopropylamine""",
    longDesc="""
...
""",
    ...
    shortDesc="""trans-1,4-dicyano-2-butene""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [33.472, 41.351, 48.212, 53.702, 61.442, 67.168, 76.227],
            "cal/(mol*K)",
        ),
        H298=(35.733, "kcal/mol"),
        S298=(95.726, "cal/(mol*K)"),
    ),
    shortDesc="""adiponitrile""",
    longDesc="""
...
""",
    ...
    shortDesc="""methylglutaronitrile""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [32.227, 40.716, 48.253, 54.234, 62.198, 67.609, 76.726],
            "cal/(mol*K)",
        ),
        H298=(21.799, "kcal/mol"),
        S298=(86.115, "cal/(mol*K)"),
    ),
    shortDesc="""m-phenylenediamine""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [29.646, 38.426, 46.342, 52.629, 61.019, 66.867, 75.884],
            "cal/(mol*K)",
        ),
        H298=(48.64, "kcal/mol"),
        S298=(84.008, "cal/(mol*K)"),
    ),
    shortDesc="""phenylhydrazine""",
    longDesc="""
...
""",
    ...
    shortDesc="""2-methylpentanenitrile""",
    longDesc="""
...
""",
    ...
    shortDesc="""2-ethylbutanenitrile""",
    longDesc="""
...
""",
    ...
    shortDesc="""3-methylpentanenitrile""",
    longDesc="""
...
""",
    ...
    shortDesc="""4-methylpentanenitrile""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [34.343, 42.858, 50.685, 57.154, 66.482, 73.332, 84.033],
            "cal/(mol*K)",
        ),
        H298=(-4.947, "kcal/mol"),
        S298=(95.147, "cal/(mol*K)"),
    ),
    shortDesc="""2,2-dimethylbutanenitrile""",
    longDesc="""
...
""",
    ...
    shortDesc="""2,3-dimethylbutanenitrile""",
    longDesc="""
...
""",
    ...
    shortDesc="""3,3-dimethylbutanenitrile""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [40.184, 48.722, 57.278, 65.18, 78.179, 87.679, 101.198],
            "cal/(mol*K)",
        ),
        H298=(-31.856, "kcal/mol"),
        S298=(105.913, "cal/(mol*K)"),
    ),
    shortDesc="""hexylamine""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [39.459, 49.149, 58.461, 66.452, 78.457, 87.329, 100.793],
            "cal/(mol*K)",
        ),
        H298=(-34.365, "kcal/mol"),
        S298=(99.06, "cal/(mol*K)"),
    ),
    shortDesc="""2-aminohexane""",
    longDesc="""
...
""",
    ...
    shortDesc="""1-amino-2-methylpentane""",
    longDesc="""
...
""",
    ...
    shortDesc="""1-amino-3-methylpentane""",
    longDesc="""
...
""",
    ...
    shortDesc="""1-amino-4-methylpentane""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [39.444, 49.729, 59.433, 67.485, 79.009, 87.551, 101.049],
            "cal/(mol*K)",
        ),
        H298=(-37.544, "kcal/mol"),
        S298=(84.165, "cal/(mol*K)"),
    ),
    shortDesc="""2-amino-2-methylpentane""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [39.408, 49.171, 58.56, 66.609, 78.637, 87.457, 100.941],
            "cal/(mol*K)",
        ),
        H298=(-34.771, "kcal/mol"),
        S298=(99.653, "cal/(mol*K)"),
    ),
    shortDesc="""2-amino-3-methylpentane""",
    longDesc="""
...
""",
    ...
    shortDesc="""2-amino-4-methylpentane""",
    longDesc="""
...
""",
    ...
    shortDesc="""3-amino-2-methylpentane""",
    longDesc="""
...
""",
    ...
    shortDesc="""3-amino-3-methylpentane""",
    longDesc="""
...
""",
    ...
    shortDesc="""1-amino-2,2-dimethylbutane""",
    longDesc="""
...
""",
    ...
    shortDesc="""1-amino-2,3-dimethylbutane""",
    longDesc="""
...
""",
    ...
    shortDesc="""1-amino-3,3-dimethylbutane""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [39.394, 49.751, 59.533, 67.641, 79.189, 87.679, 101.198],
            "cal/(mol*K)",
        ),
        H298=(-37.353, "kcal/mol"),
        S298=(86.763, "cal/(mol*K)"),
    ),
    shortDesc="""2-amino-2,3-dimethylbutane""",
    longDesc="""
...
""",
    ...
    shortDesc="""2-amino-3,3-dimethyl butane""",
    longDesc="""
...
""",
    ...
    shortDesc="""1-amino-2-ethylbutane""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [38.53, 48.475, 58.006, 66.194, 78.498, 87.548, 101.411],
            "cal/(mol*K)",
        ),
        H298=(-28.27, "kcal/mol"),
        S298=(101.112, "cal/(mol*K)"),
    ),
    shortDesc="""methyl-1-methylbutylamine""",
    longDesc="""
...
""",
    ...
    shortDesc="""methyl-2-methylbutylamine""",
    longDesc="""
...
""",
    ...
    shortDesc="""methyl-3-methylbutylamine""",
    longDesc="""
...
""",
    ...
    shortDesc="""methyl-1,1-dimethylpropylamine""",
    longDesc="""
...
""",
    ...
    shortDesc="""methyl-1,2-dimethylpropylamine""",
    longDesc="""
...
""",
    ...
    shortDesc="""methyl-2,2-dimethylpropylamine""",
    longDesc="""
...
""",
    ...
    shortDesc="""ethyl-sec-butylamine""",
    longDesc="""
...
""",
    ...
    shortDesc="""ethyl-tert-butylamine""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [37.798, 48.194, 57.99, 66.177, 78.226, 87.489, 101.342],
            "cal/(mol*K)",
        ),
        H298=(-27.721, "kcal/mol"),
        S298=(102.788, "cal/(mol*K)"),
    ),
    shortDesc="""di-propylamine""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [38.154, 48.772, 58.789, 67.126, 79.164, 88.158, 102.117],
            "cal/(mol*K)",
        ),
        H298=(-33.17, "kcal/mol"),
        S298=(107.678, "cal/(mol*K)"),
    ),
    shortDesc="""diisopropylamine""",
    longDesc="""
...
""",
    ...
    shortDesc="""propylisopropylamine""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [38.531, 48.694, 58.323, 66.497, 78.679, 87.692, 100.64],
            "cal/(mol*K)",
        ),
        H298=(-23.251, "kcal/mol"),
        S298=(98.844, "cal/(mol*K)"),
    ),
    shortDesc="""methylethylpropylamine""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [38.481, 48.716, 58.422, 66.653, 78.859, 87.821, 100.788],
            "cal/(mol*K)",
        ),
        H298=(-26.311, "kcal/mol"),
        S298=(90.539, "cal/(mol*K)"),
    ),
    shortDesc="""methylethylisopropylamine""",
    longDesc="""
...
""",
    ...
    shortDesc="""dimethyl-sec-butylamine""",
    longDesc="""
...
""",
    ...
    shortDesc="""dimethylisobutylamine""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [38.466, 49.296, 59.395, 67.686, 79.411, 88.043, 101.043],
            "cal/(mol*K)",
        ),
        H298=(-25.211, "kcal/mol"),
        S298=(89.994, "cal/(mol*K)"),
    ),
    shortDesc="""dimethyl-tert-butylamine""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [39.931, 48.795, 57.545, 65.572, 78.698, 88.168, 101.186],
            "cal/(mol*K)",
        ),
        H298=(-22.152, "kcal/mol"),
        S298=(96.454, "cal/(mol*K)"),
    ),
    shortDesc="""triethylamine""",
    longDesc="""
...
""",
    ...
    shortDesc="""N-aminoethyl piperazine""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [44.227, 54.679, 64.382, 72.81, 85.814, 95.104, 108.828],
            "cal/(mol*K)",
        ),
        H298=(-23.617, "kcal/mol"),
        S298=(113.611, "cal/(mol*K)"),
    ),
    shortDesc="""hexamethylenediamine""",
    longDesc="""
...
""",
    ...
    shortDesc="""N,N-diethyl-1,2-ethanediamine""",
    longDesc="""
...
""",
    ...
    shortDesc="""N,N,N',N'-tetramethyl-1,2-ethanediamine""",
    longDesc="""
...
""",
    ...
    shortDesc="""N-butylethylenediamine""",
    longDesc="""
...
""",
    ...
    shortDesc="""1,5-diamino-2-methylpentane""",
    longDesc="""
...
""",
    ...
    shortDesc="""N-isopropyl-1,3-propanediamine""",
    longDesc="""
...
""",
    ...
    shortDesc="""N-propyl-1,3-propanediamine""",
    longDesc="""
...
""",
    ...
    shortDesc="""N,N,N'-trimethyl-1,3-propanediamine""",
    longDesc="""
...
""",
    ...
    shortDesc="""2-methyl-2,4-pentanediamine""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [51.283, 64.415, 76.341, 86.296, 101.166, 112.306, 127.451],
            "cal/(mol*K)",
        ),
        H298=(0.806, "kcal/mol"),
        S298=(135.076, "cal/(mol*K)"),
    ),
    shortDesc="""triethylene tetramine""",
    longDesc="""
...
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=(
            [17.4185, 20.6221, 23.6417, 26.2968, 30.6212, 33.9675, 39.4489],
            "cal/(mol*K)",
        ),
        H298=(28.75, "kcal/mol"),
        S298=(70.02, "cal/(mol*K)"),
    ),
    shortDesc="""1-Aminoeth-1-yl radical, C[CH]N""",
    longDesc="""
